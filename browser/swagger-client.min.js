...
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject")},JQueryHttpClient=function(){this.type="JQueryHttpClient"},SuperagentHttpClient=function(){this.type="SuperagentHttpClient"},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),r.opts=t||{};var n=!1;if("undefined"!=typeof window&&"undefined"!=typeof window.jQuery&&(n=!0),"options"===e.method.toLowerCase()&&"SuperagentHttpClient"===r.type&&(log("forcing jQuery as OPTIONS are not supported by SuperAgent"),e.useJQuery=!0),this.isInternetExplorer()&&(e.useJQuery===!1||!n))throw new Error("Unsupported configuration! JQuery is required but not available");if((e&&e.useJQuery===!0||this.isInternetExplorer()&&n)&&(r=new JQueryHttpClient(t)),"get"!==e.method.toLowerCase()&&e.headers.Accept){var o=e.headers.Accept.toLowerCase();(/^image\//.test(o)||/application\/pdf/.test(o))&&(e.dataType="binary")}var s=e.on.response,a=e.on.error,i=function(e){return t&&t.requestInterceptor&&(e=t.requestInterceptor.apply(e)),e},u=function(e){return t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),s(e)},p=function(e){t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),a(e)};return e.on.error=function(e){p(e)},e.on.response=function(e){u(e)},_.isObject(e)&&_.isObject(e.body)&&e.body.type&&"formData"===e.body.type&&t.useJQuery&&(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]),e=i(e)||e,e.beforeSend?e.beforeSend(function(t){r.execute(t||e)}):r.execute(e),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(t.indexOf("msie")!==-1){var r=parseInt(t.split("msie")[1]);r<=8&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=this.jQuery||"undefined"!=typeof window&&window.jQuery,r=e.on,n=e;if("undefined"==typeof t||t===!1)throw new Error("Unsupported configuration! JQuery is required but not available");e.type=e.method,e.cache=e.jqueryAjaxCache,e.data=e.body,delete e.jqueryAjaxCache,delete e.useJQuery,delete e.body;var o;return t.ajaxTransport("+binary",function(e,t,r){if(window.FormData&&(e.dataType&&"binary"==e.dataType||e.data&&(window.ArrayBuffer&&e.data instanceof ArrayBuffer||window.Blob&&e.data instanceof Blob)))return{send:function(t,r){var n=new XMLHttpRequest,o=e.url,s=e.type,a=e.async||!0,i=e.responseType||"blob",u=e.data||null,p=e.username||null,d=e.password||null;n.addEventListener("load",function(){var t={};t[e.dataType]=n.response,r(n.status,n.statusText,t,n.getAllResponseHeaders())}),n.open(s,o,a,p,d);for(var l in t)n.setRequestHeader(l,t[l]);n.responseType=i,n.send(u)},abort:function(){}}}),e.success=function(e){o=e},e.complete=function(e){for(var t={},s=e.getAllResponseHeaders().split("\n"),a=0;a<s.length;a++){var i=s[a].trim();if(0!==i.length){var u=i.indexOf(":");if(u!==-1){var p=i.substring(0,u).trim(),d=i.substring(u+1).trim();t[p]=d}else t[i]=null}}var l={url:n.url,method:n.method,status:e.status,statusText:e.statusText,data:"binary"===n.dataType?o:e.responseText,headers:t};try{var y=e.responseJSON||jsyaml.safeLoad(e.responseText);l.obj="string"==typeof y?{}:y}catch(e){helpers.log("unable to parse JSON/YAML content")}if(l.obj=l.obj||null,e.status>=200&&e.status<300)r.response(l);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(l);r.error(l)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r=e.headers||{},n=request[t](e.url);if(e.enableCookies&&n.withCredentials(),e.body)if(_.isObject(e.body)){var o=e.headers["Content-Type"]||"";if(0===o.indexOf("multipart/form-data"))if(delete r["Content-Type"],"[object FormData]"==={}.toString.apply(e.body))for(var s=e.body.keys();;){var a=s.next();if(a.done)break;var i=a.value,u=e.body.get(i);console.log({}.toString.apply(u)),"[object File]"==={}.toString.apply(u)?n.attach(i,u):n.field(i,u)}else{var p;for(var p in e.body){var u=e.body[p];n.field(p,u)}}else _.isObject(e.body)&&(e.body=JSON.stringify(e.body),n.send(e.body))}else n.send(e.body);var d;for(d in r)n.set(d,r[d]);"function"==typeof n.buffer&&n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var n,o={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(o.errObj=t,o.status=r?r.status:500,o.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{o.obj=JSON.parse(o.statusText)}catch(e){o.obj=null}n=e.on.error}else if(r&&e.on&&e.on.response){var s;if(r.body&&Object.keys(r.body).length>0)s=r.body;else try{s=jsyaml.safeLoad(r.text),s="string"==typeof s?null:s}catch(e){helpers.log("cannot parse JSON/YAML content")}o.obj="object"==typeof s?s:null,o.status=r.status,o.statusText=r.text,n=e.on.response}o.data=o.statusText,n&&n(o)})};
