...
"use strict";var auth=require("./auth"),helpers=require("./helpers"),Model=require("./types/model"),Operation=require("./types/operation"),OperationGroup=require("./types/operationGroup"),Resolver=require("./resolver"),SwaggerHttp=require("./http"),SwaggerClient=module.exports=function(t,e){return this.authorizationScheme=null,this.authorizations=null,this.basePath=null,this.debug=!1,this.info=null,this.isBuilt=!1,this.isValid=!1,this.modelsArray=[],this.resourceCount=0,this.url=null,this.useJQuery=!1,"undefined"!=typeof t?this.initialize(t,e):void 0};SwaggerClient.prototype.initialize=function(t,e){this.models={},this.sampleModels={},e=e||{},"string"==typeof t?this.url=t:"object"==typeof t&&(e=t,this.url=e.url),this.swaggerRequstHeaders=e.swaggerRequstHeaders||"application/json;charset=utf-8,*/*",this.defaultSuccessCallback=e.defaultSuccessCallback||null,this.defaultErrorCallback=e.defaultErrorCallback||null,"function"==typeof e.success&&(this.success=e.success),e.useJQuery&&(this.useJQuery=e.useJQuery),this.clientAuthorizations=e.authorizations?e.authorizations:new auth.SwaggerAuthorizations,this.supportedSubmitMethods=e.supportedSubmitMethods||[],this.failure=e.failure||function(){},this.progress=e.progress||function(){},this.spec=e.spec,this.options=e,"function"==typeof e.success&&(this.ready=!0,this.build())},SwaggerClient.prototype.build=function(t){if(this.isBuilt)return this;var e=this;this.progress("fetching resource list: "+this.url);var s={useJQuery:this.useJQuery,url:this.url,method:"get",headers:{accept:this.swaggerRequstHeaders},on:{error:function(t){return e.fail("http"!==e.url.substring(0,4)?"Please specify the protocol for "+e.url:0===t.status?"Can't read from server.  It may not have the appropriate access-control-origin settings.":404===t.status?"Can't read swagger JSON from "+e.url:t.status+" : "+t.statusText+" "+e.url)},response:function(t){var s=t.obj||JSON.parse(t.data);return e.swaggerVersion=s.swaggerVersion,s.swagger&&2===parseInt(s.swagger)?(e.swaggerVersion=s.swagger,(new Resolver).resolve(s,e.buildFromSpec,e),e.isValid=!0,void 0):"1.2"===e.swaggerVersion?e.buildFrom1_2Spec(s):e.buildFrom1_1Spec(s)}}};if(this.spec)setTimeout(function(){(new Resolver).resolve(e.spec,e.buildFromSpec,e)},10);else{if(this.clientAuthorizations.apply(s),t)return s;(new SwaggerHttp).execute(s)}return this},SwaggerClient.prototype.buildFromSpec=function(t){if(this.isBuilt)return this;this.apis={},this.apisArray=[],this.basePath=t.basePath||"",this.consumes=t.consumes,this.host=t.host||"",this.info=t.info||{},this.produces=t.produces,this.schemes=t.schemes||[],this.securityDefinitions=t.securityDefinitions,this.title=t.title||"",this.authSchemes=t.securityDefinitions;var e,s={};if(Array.isArray(t.tags))for(s={},e=0;e<t.tags.length;e++){var i=t.tags[e];s[i.name]=i}var r;"string"==typeof this.url&&(r=this.parseUri(this.url)),this.scheme="undefined"==typeof this.schemes||0===this.schemes.length?r.scheme||"http":this.schemes[0],("undefined"==typeof this.host||""===this.host)&&(this.host=r.host,r.port&&(this.host=this.host+":"+r.port)),this.definitions=t.definitions;var o;for(o in this.definitions){var a=new Model(o,this.definitions[o],this.models);a&&(this.models[o]=a)}var h;for(h in t.paths)if("object"==typeof t.paths[h]){var n;for(n in t.paths[h])if(-1!==["delete","get","head","options","patch","post","put"].indexOf(n)){var u=t.paths[h][n],p=u.tags;"undefined"==typeof p&&(u.tags=["default"],p=u.tags);var l=this.idFromOp(h,n,u),c=new Operation(this,u.scheme,l,n,h,u,this.definitions,this.models,this.clientAuthorizations);if(p.length>0){var f;for(f=0;f<p.length;f++){var g=this.tagFromLabel(p[f]),d=this[g];if("undefined"==typeof this.apis[g]&&(this.apis[g]={}),"undefined"==typeof d){this[g]=[],d=this[g],d.operations={},d.label=g,d.apis=[];var y=s[g];"object"==typeof y&&(d.description=y.description,d.externalDocs=y.externalDocs),this[g].help=this.help.bind(d),this.apisArray.push(new OperationGroup(g,d.description,d.externalDocs,c))}"function"!=typeof this.apis[g].help&&(this.apis[g].help=this.help.bind(d)),this.apis[g][l]=c.execute.bind(c),this.apis[g][l].help=c.help.bind(c),this.apis[g][l].asCurl=c.asCurl.bind(c),d[l]=c.execute.bind(c),d[l].help=c.help.bind(c),d[l].asCurl=c.asCurl.bind(c),d.apis.push(c),d.operations[l]=c;var m,b;for(m=0;m<this.apisArray.length;m++)this.apisArray[m].tag===g&&(b=this.apisArray[m]);b&&b.operationsArray.push(c)}}else helpers.log("no group to bind to")}}return this.isBuilt=!0,this.success&&(this.isValid=!0,this.isBuilt=!0,this.success()),this},SwaggerClient.prototype.parseUri=function(t){var e=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,s=e.exec(t);return{scheme:s[4].replace(":",""),host:s[11],port:s[12],path:s[15]}},SwaggerClient.prototype.help=function(t){var e,s='operations for the "'+this.label+'" tag';for(e=0;e<this.apis.length;e++){var i=this.apis[e];s+="\n  * "+i.nickname+": "+i.operation.summary}return t?s:(helpers.log(s),s)},SwaggerClient.prototype.tagFromLabel=function(t){return t},SwaggerClient.prototype.idFromOp=function(t,e,s){var i=s.operationId||t.substring(1)+"_"+e;return i.replace(/[\.,-\/#!$%\^&\*;:{}=\-_`~()\+\s]/g,"_")},SwaggerClient.prototype.fail=function(t){throw this.failure(t),t};


},{"./auth":2,"./helpers":5,"./http":6,"./resolver":7,"./types/model":9,"./types/operation":10,"./types/operationGroup":11}],5:[function(require,module,exports){
"use strict";module.exports.__bind=function(e,t){return function(){return e.apply(t,arguments)}};var log=module.exports.log=function(){log.history=log.history||[],log.history.push(arguments),console&&console.log(Array.prototype.slice.call(arguments)[0])};module.exports.fail=function(e){log(e)},module.exports.optionHtml=function(e,t){return'<tr><td class="optionName">'+e+":</td><td>"+t+"</td></tr>"},module.exports.typeFromJsonSchema=function(e,t){var n;return"integer"===e&&"int32"===t?n="integer":"integer"===e&&"int64"===t?n="long":"integer"===e&&"undefined"==typeof t?n="long":"string"===e&&"date-time"===t?n="date-time":"string"===e&&"date"===t?n="date":"number"===e&&"float"===t?n="float":"number"===e&&"double"===t?n="double":"number"===e&&"undefined"==typeof t?n="double":"boolean"===e?n="boolean":"string"===e&&(n="string"),n};var simpleRef=module.exports.simpleRef=function(e){return"undefined"==typeof e?null:0===e.indexOf("#/definitions/")?e.substring("#/definitions/".length):e},getStringSignature=module.exports.getStringSignature=function(e,t){var n="";return"undefined"!=typeof e.$ref?n+=simpleRef(e.$ref):"undefined"==typeof e.type?n+="object":"array"===e.type?t?n+=getStringSignature(e.items||e.$ref||{}):(n+="Array[",n+=getStringSignature(e.items||e.$ref||{}),n+="]"):n+="integer"===e.type&&"int32"===e.format?"integer":"integer"===e.type&&"int64"===e.format?"long":"integer"===e.type&&"undefined"==typeof e.format?"long":"string"===e.type&&"date-time"===e.format?"date-time":"string"===e.type&&"date"===e.format?"date":"string"===e.type&&"undefined"==typeof e.format?"string":"number"===e.type&&"float"===e.format?"float":"number"===e.type&&"double"===e.format?"double":"number"===e.type&&"undefined"==typeof e.format?"double":"boolean"===e.type?"boolean":e.$ref?simpleRef(e.$ref):e.type,n};


},{}],6:[function(require,module,exports){
"use strict";var helpers=require("./helpers"),jQuery=require("jquery"),request=require("superagent"),JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){return this.useJQuery=e&&"boolean"==typeof e.useJQuery?e.useJQuery:this.isIE8(),e&&"object"==typeof e.body&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),this.useJQuery?new JQueryHttpClient(t).execute(e):new SuperagentHttpClient(t).execute(e)},SwaggerHttp.prototype.isIE8=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=e.on,r=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var s={},o=e.getAllResponseHeaders().split("\n"),n=0;n<o.length;n++){var u=o[n].trim();if(0!==u.length){var a=u.indexOf(":");if(-1!==a){var i=u.substring(0,a).trim(),p=u.substring(a+1).trim();s[i]=p}else s[u]=null}}var d={url:r.url,method:r.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:s},y=s["content-type"]||s["Content-Type"]||null;if(y&&(0===y.indexOf("application/json")||y.indexOf("+json")>0))try{d.obj=e.responseJSON||JSON.parse(d.data)||{}}catch(l){helpers.log("unable to parse JSON content")}if(e.status>=200&&e.status<300)t.response(d);else{if(!(0===e.status||e.status>=400&&e.status<599))return t.response(d);t.error(d)}},jQuery.support.cors=!0,jQuery.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},o=request[t](e.url);for(r in s)o.set(r,s[r]);e.body&&o.send(e.body),o.end(function(t,r){var o,n={url:e.url,method:e.method,headers:s};!t&&r.error&&(t=r.error),t&&e.on&&e.on.error?(n.obj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,n.data=n.statusText,o=e.on.error):r&&e.on&&e.on.response&&(n.obj="undefined"!=typeof r.body?r.body:r.text,n.status=r.status,n.statusText=r.text,n.data=n.statusText,o=e.on.response),o&&o(n)})};


},{"./helpers":5,"jquery":18,"superagent":19}],7:[function(require,module,exports){
