...
},{"_process":16,"lodash-compat/lang/isPlainObject":132}],5:[function(require,module,exports){
"use strict";function isParseable(e){return"string"!=typeof e?!1:(e=e.trim().toLowerCase(),e.match(/[+\/]ya?ml$/)?!0:e.match(/[+\/]json$/)?!0:!1)}var helpers=require("./helpers"),jQuery=require("jquery"),request=require("superagent"),jsyaml=require("js-yaml"),JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),(e&&e.useJQuery===!0||this.isInternetExplorer())&&(r=new JQueryHttpClient(t));var s=e.on.response,n=function(e){t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),s(e)};e.on.response=function(e){n(e)},e&&"object"==typeof e.body&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),r.execute(e)},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=e.on,r=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var s={},n=e.getAllResponseHeaders().split("\n"),o=0;o<n.length;o++){var a=n[o].trim();if(0!==a.length){var u=a.indexOf(":");if(-1!==u){var p=a.substring(0,u).trim(),i=a.substring(u+1).trim();s[p]=i}else s[a]=null}}var l={url:r.url,method:r.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:s},d=s["content-type"]||s["Content-Type"]||null;if(d&&(0===d.indexOf("application/json")||d.indexOf("+json")>0))try{l.obj=e.responseJSON||JSON.parse(l.data)||{}}catch(y){helpers.log("unable to parse JSON content")}if(l.obj=l.obj||null,e.status>=200&&e.status<300)t.response(l);else{if(!(0===e.status||e.status>=400&&e.status<599))return t.response(l);t.error(l)}},jQuery.support.cors=!0,jQuery.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");{var r,s=e.headers||{},n=request[t](e.url);s.accept||s.Accept}for(r in s)n.set(r,s[r]);e.body&&n.send(e.body),n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var s,n={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error)n.obj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,s=e.on.error;else if(r&&e.on&&e.on.response){var o;if(r.body&&Object.keys(r.body).length>0)o=r.body;else{var a=r.headers["content-type"]||r.headers["Content-Type"];if(r.text&&isParseable(a))try{o=jsyaml.safeLoad(r.text)}catch(u){helpers.log("Cannot parse JSON/YAML content")}}n.obj=o||null,n.status=r.status,n.statusText=r.text,s=e.on.response}n.data=n.statusText,s&&s(n)})};


},{"./helpers":4,"jquery":19,"js-yaml":20,"superagent":143}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,t,o,i){var r,s,n=t,l=o,f=i;"function"==typeof t&&(n=null,l=t,f=o);var a=n;this.scope=f||this,this.iteration=this.iteration||0;var p,h,v,c,u=0,y={},d={},g=[];for(p in e.definitions){var b=e.definitions[p];for(c in b.properties)v=b.properties[c],this.resolveTo(n,v,g,"/definitions")}for(p in e.paths){var k,O,j;h=e.paths[p];for(k in h)if("$ref"===k)r="/paths"+p,this.resolveInline(n,e,h,g,d,r);else{O=h[k];var m=O.parameters;for(s in m){var x=m[s];r="/paths"+p+"/"+k+"/parameters","body"===x["in"]&&x.schema&&this.resolveTo(n,x.schema,g,r),x.$ref&&this.resolveInline(n,e,x,g,d,x.$ref)}for(j in O.responses){var R=O.responses[j];r=r="/paths"+p+"/"+k+"/responses/"+j,"object"==typeof R&&R.$ref&&this.resolveInline(n,e,R,g,d,r),R.schema&&R.schema.$ref&&this.resolveTo(n,R.schema,g,r)}}}var $=0,A=[],I=g;for(s=0;s<I.length;s++){var T=I[s];if(n===T.root)if("ref"===T.resolveAs){var w,H=((T.root||"")+"/"+T.key).split("/"),S=[],q="";if(T.key.indexOf("../")>=0){for(var z=0;z<H.length;z++)".."===H[z]?S=S.slice(0,S.length-1):S.push(H[z]);for(w=0;w<S.length;w++)w>0&&(q+="/"),q+=S[w];T.root=q,A.push(T)}else{var J=T.key.split("#");if(2===J.length){(0===J[0].indexOf("http://")||0===J[0].indexOf("https://"))&&(T.root=J[0]),r=J[1].split("/");var N,Q=e;for(w=0;w<r.length;w++){var B=r[w];if(""!==B){if(Q=Q[B],"undefined"==typeof Q){N=null;break}N=Q}}null===N&&A.push(T)}}}else"inline"===T.resolveAs&&A.push(T);else A.push(T)}$=A.length;var C=0;for(C=0;C<A.length;C++){var D=A[C],E=this;if(null===D.root)E.resolveItem(e,a,g,y,d,D),u+=1,u===$&&this.finish(e,n,g,y,d,l);else{var F={useJQuery:!1,url:D.root,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){u+=1,d[D.key]=null,u===$&&E.finish(e,a,g,y,d,l)},response:function(t){var o=t.obj;if(null===o||0===Object.keys(o).length)try{o=JSON.parse(t.data)}catch(i){o={}}E.resolveItem(o,a,g,y,d,D),u+=1,u===$&&E.finish(e,a,g,y,d,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(F),(new SwaggerHttp).execute(F)}}0===Object.keys(A).length&&l.call(this.scope,e,d)},Resolver.prototype.resolveItem=function(e,t,o,i,r,s){for(var n=s.location,l=e,f=n.split("/"),a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?i[h]={name:v,obj:l,key:s.key,root:s.root}:r[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,t,o,i,r,s){var n;for(n in o){var l=o[n],f=l.key,a=i[f];if(a)if(e.definitions=e.definitions||{},"ref"===l.resolveAs)e.definitions[a.name]=a.obj,l.obj.$ref="#/definitions/"+a.name;else if("inline"===l.resolveAs){var p=l.obj;delete p.$ref;for(f in a.obj){var h=this.retainRoot(a.obj[f],l.root);p[f]=h}}}2===this.iteration?s.call(this.scope,e,r):(this.iteration+=1,this.resolve(e,t,s,this.scope))},Resolver.prototype.retainRoot=function(e,t){for(var o in e){var i=e[o];"$ref"===o&&"string"==typeof i?0!==i.indexOf("http://")&&0!==i.indexOf("https://")&&(0!==i.indexOf("#")&&(i="#"+i),i=(t||"")+i,e[o]=i):"object"==typeof i&&this.retainRoot(i,t)}return e},Resolver.prototype.countRefs=function(e,t){t=t||0;for(var o in e){var i=e[o];"$ref"===o&&"string"==typeof i?t+=1:"object"==typeof i&&(t+=this.countRefs(i))}return t},Resolver.prototype.resolveInline=function(e,t,o,i,r,s){var n=o.$ref,l=o.$ref,f=!1;if(l){if(0===l.indexOf("../")){var a=l.split("../"),p=e.split("/");l="";for(var h=0;h<a.length;h++)""===a[h]?p=p.slice(0,p.length-1):l+=a[h];e="";for(var h=0;h<p.length-1;h++)h>0&&(e+="/"),e+=p[h];f=!0}if(l.indexOf("#")>=0)if(0===l.indexOf("/")){var v=l.split("#"),a=e.split("//"),c=a[1].split("/");e=a[0]+"//"+c[0]+v[0],s=v[1]}else{var v=l.split("#");if(""!==v[0]){var p=e.split("/");if(p=p.slice(0,p.length-1),!f){e="";for(var u=0;u<p.length;u++)u>0&&(e+="/"),e+=p[u]}e+="/"+l.split("#")[0]}s=v[1]}0===l.indexOf("http")?(l.indexOf("#")>=0?(e=l.split("#")[0],s=l.split("#")[1]):(e=l,s=""),i.push({obj:o,resolveAs:"inline",root:e,key:n,location:s})):0===l.indexOf("#")?(s=l.split("#")[1],i.push({obj:o,resolveAs:"inline",root:e,key:n,location:s})):i.push({obj:o,resolveAs:"inline",root:e,key:n,location:s})}else"array"===o.type&&this.resolveTo(e,o.items,i,s)},Resolver.prototype.resolveTo=function(e,t,o,i){var r=t.$ref;if(r)r.indexOf("#")>=0&&(i=r.split("#")[1]),o.push({obj:t,resolveAs:"ref",root:e,key:r,location:i});else if("array"===t.type){var s=t.items;this.resolveTo(e,s,o,i)}};
...
},{"../helpers":4,"lodash-compat/array/indexOf":51,"lodash-compat/collection/forEach":54,"lodash-compat/collection/map":55,"lodash-compat/lang/cloneDeep":126,"lodash-compat/lang/isArray":128,"lodash-compat/lang/isPlainObject":132,"lodash-compat/lang/isString":133,"lodash-compat/lang/isUndefined":135,"lodash-compat/object/keys":136}],9:[function(require,module,exports){
...
},{"../internal/baseIndexOf":74,"../internal/binaryIndex":86}],52:[function(require,module,exports){
...
},{"../internal/LazyWrapper":59,"../internal/LodashWrapper":60,"../internal/baseLodash":79,"../internal/isObjectLike":114,"../internal/wrapperClone":125,"../lang/isArray":128}],53:[function(require,module,exports){
...
},{"../internal/baseEach":68,"../internal/createFind":96}],54:[function(require,module,exports){
...
},{"../internal/arrayEach":62,"../internal/baseEach":68,"../internal/createForEach":97}],55:[function(require,module,exports){
...
},{"../internal/arrayMap":63,"../internal/baseCallback":64,"../internal/baseMap":80,"../lang/isArray":128}],56:[function(require,module,exports){
...
},{"../lang/isNative":130}],57:[function(require,module,exports){
...
},{"../internal/createWrapper":100,"../internal/replaceHolders":120,"./restParam":58}],58:[function(require,module,exports){
...
},{"./baseCreate":67,"./baseLodash":79}],60:[function(require,module,exports){
...
},{"./baseCreate":67,"./baseLodash":79}],61:[function(require,module,exports){
...
},{"../utility/identity":141,"./baseMatches":81,"./baseMatchesProperty":82,"./baseProperty":83,"./bindCallback":88}],65:[function(require,module,exports){
...
},{"../lang/isArray":128,"../lang/isObject":131,"../object/keys":136,"./arrayCopy":61,"./arrayEach":62,"./baseCopy":66,"./baseForOwn":73,"./initCloneArray":107,"./initCloneByTag":108,"./initCloneObject":109,"./isHostObject":110}],66:[function(require,module,exports){
...
},{"../lang/isObject":131}],68:[function(require,module,exports){
...
},{"../object/keysIn":137,"./baseFor":71}],73:[function(require,module,exports){
...
},{"../object/keys":136,"./baseFor":71}],74:[function(require,module,exports){
...
},{"./indexOfNaN":106}],75:[function(require,module,exports){
...
},{"../lang/isArray":128,"../lang/isTypedArray":134,"./equalArrays":101,"./equalByTag":102,"./equalObjects":103,"./isHostObject":110}],77:[function(require,module,exports){
...
},{"./baseEach":68}],81:[function(require,module,exports){
...
},{"../object/keys":136,"../utility/constant":140,"./baseIsMatch":78,"./isStrictComparable":115,"./toObject":124}],82:[function(require,module,exports){
...
},{"./baseIsEqual":75,"./isStrictComparable":115,"./toObject":124}],83:[function(require,module,exports){
...
},{"../utility/identity":141,"./metaMap":117}],85:[function(require,module,exports){
...
},{"../utility/identity":141,"./binaryIndexBy":87}],87:[function(require,module,exports){
...
},{"../utility/identity":141}],89:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":130,"../utility/constant":140}],90:[function(require,module,exports){
...
},{"./isLength":113,"./toObject":124}],93:[function(require,module,exports){
...
},{"./toObject":124}],94:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":95}],95:[function(require,module,exports){
...
},{"../lang/isObject":131,"./baseCreate":67}],96:[function(require,module,exports){
...
},{"../lang/isArray":128,"./baseCallback":64,"./baseFind":69,"./baseFindIndex":70}],97:[function(require,module,exports){
...
},{"../lang/isArray":128,"./bindCallback":88}],98:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":61,"./composeArgs":90,"./composeArgsRight":91,"./createCtorWrapper":95,"./isLaziable":112,"./reorder":119,"./replaceHolders":120,"./setData":121}],99:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":95}],100:[function(require,module,exports){
...
},{"./baseSetData":84,"./createBindWrapper":94,"./createHybridWrapper":98,"./createPartialWrapper":99,"./getData":104,"./mergeData":116,"./setData":121}],101:[function(require,module,exports){
...
},{"../object/keys":136}],104:[function(require,module,exports){
...
},{"../utility/noop":142,"./metaMap":117}],105:[function(require,module,exports){
...
},{"../support":139,"../utility/constant":140,"./baseProperty":83,"./realNames":118}],106:[function(require,module,exports){
...
},{"./bufferClone":89}],109:[function(require,module,exports){
...
},{"../chain/lodash":52,"./LazyWrapper":59,"./getFuncName":105}],113:[function(require,module,exports){
...
},{"../lang/isObject":131}],116:[function(require,module,exports){
...
},{"./arrayCopy":61,"./composeArgs":90,"./composeArgsRight":91,"./replaceHolders":120}],117:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":130}],118:[function(require,module,exports){
...
},{"./arrayCopy":61,"./isIndex":111}],120:[function(require,module,exports){
...
},{"../date/now":56,"./baseSetData":84}],122:[function(require,module,exports){
...
},{"../lang/isArguments":127,"../support":139,"./baseForIn":72,"./isHostObject":110,"./isObjectLike":114}],123:[function(require,module,exports){
...
},{"../lang/isArguments":127,"../lang/isArray":128,"../lang/isString":133,"../object/keysIn":137,"../support":139,"./isIndex":111,"./isLength":113}],124:[function(require,module,exports){
...
},{"../lang/isObject":131,"../lang/isString":133,"../support":139}],125:[function(require,module,exports){
...
},{"./LazyWrapper":59,"./LodashWrapper":60,"./arrayCopy":61}],126:[function(require,module,exports){
...
},{"../internal/baseClone":65,"../internal/bindCallback":88}],127:[function(require,module,exports){
...
},{"../internal/isLength":113,"../internal/isObjectLike":114,"../support":139}],128:[function(require,module,exports){
...
},{"../internal/isLength":113,"../internal/isObjectLike":114,"./isNative":130}],129:[function(require,module,exports){
(function (global){
...
},{"../internal/baseIsFunction":77,"./isNative":130}],130:[function(require,module,exports){
...
},{"../internal/isHostObject":110,"../internal/isObjectLike":114,"../string/escapeRegExp":138}],131:[function(require,module,exports){
...
},{"../internal/shimIsPlainObject":122,"../support":139,"./isArguments":127,"./isNative":130}],133:[function(require,module,exports){
...
},{"../internal/isObjectLike":114}],134:[function(require,module,exports){
...
},{"../internal/isLength":113,"../internal/shimKeys":123,"../lang/isNative":130,"../lang/isObject":131,"../support":139}],137:[function(require,module,exports){
...
},{"../internal/arrayEach":62,"../internal/isIndex":111,"../internal/isLength":113,"../lang/isArguments":127,"../lang/isArray":128,"../lang/isFunction":129,"../lang/isObject":131,"../lang/isString":133,"../support":139}],138:[function(require,module,exports){
...
},{"../internal/baseToString":85}],139:[function(require,module,exports){
(function (global){
