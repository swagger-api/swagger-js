...
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,t,o,r){var i,s,n=t,l=o,f=r;"function"==typeof t&&(n=null,l=t,f=o);var a=n;this.scope=f||this,this.iteration=this.iteration||0;var p,h,v,c,u=0,y={},d={},g=[];for(p in e.definitions){var b=e.definitions[p];for(c in b.properties)v=b.properties[c],this.resolveTo(n,v,g,"/definitions")}for(p in e.paths){var O,k,x;h=e.paths[p];for(O in h)if("$ref"===O){var j=h[O];i=j.indexOf("#")>0?j.split("#")[1]:0===j.indexOf("http://")||0===j.indexOf("https://")?"":"/paths"+p,this.resolveInline(n,e,h,g,d,i)}else{k=h[O];var m=k.parameters;for(s in m){var R=m[s];i="/paths"+p+"/"+O+"/parameters","body"===R["in"]&&R.schema&&this.resolveTo(n,R.schema,g,i),R.$ref&&this.resolveInline(n,e,R,g,d,R.$ref)}for(x in k.responses){var A=k.responses[x];i=i="/paths"+p+"/"+O+"/responses/"+x,"object"==typeof A&&A.$ref&&this.resolveInline(n,e,A,g,d,i),A.schema&&A.schema.$ref&&this.resolveTo(n,A.schema,g,i)}}}var $=0,I=[],T=g;for(s=0;s<T.length;s++){var w=T[s];if(n===w.root)if("ref"===w.resolveAs){var H,S=((w.root||"")+"/"+w.key).split("/"),q=[],z="";if(w.key.indexOf("../")>=0){for(var J=0;J<S.length;J++)".."===S[J]?q=q.slice(0,q.length-1):q.push(S[J]);for(H=0;H<q.length;H++)H>0&&(z+="/"),z+=q[H];w.root=z,I.push(w)}else{var N=w.key.split("#");if(2===N.length){(0===N[0].indexOf("http://")||0===N[0].indexOf("https://"))&&(w.root=N[0]),i=N[1].split("/");var Q,B=e;for(H=0;H<i.length;H++){var C=i[H];if(""!==C){if(B=B[C],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&I.push(w)}}}else"inline"===w.resolveAs&&I.push(w);else I.push(w)}$=I.length;var D=0;for(D=0;D<I.length;D++){var E=I[D],F=this;if(null===E.root)F.resolveItem(e,a,g,y,d,E),u+=1,u===$&&this.finish(e,n,g,y,d,l);else{var G={useJQuery:!1,url:E.root,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){u+=1,d[E.key]=null,u===$&&F.finish(e,a,g,y,d,l)},response:function(t){var o=t.obj;if(null===o||0===Object.keys(o).length)try{o=JSON.parse(t.data)}catch(r){o={}}F.resolveItem(o,a,g,y,d,E),u+=1,u===$&&F.finish(e,a,g,y,d,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(G),(new SwaggerHttp).execute(G)}}0===Object.keys(I).length&&l.call(this.scope,e,d)},Resolver.prototype.resolveItem=function(e,t,o,r,i,s){for(var n=s.location,l=e,f=n.split("/"),a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?r[h]={name:v,obj:l,key:s.key,root:s.root}:i[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,t,o,r,i,s){var n;for(n in o){var l=o[n],f=l.key,a=r[f];if(a)if(e.definitions=e.definitions||{},"ref"===l.resolveAs)e.definitions[a.name]=a.obj,l.obj.$ref="#/definitions/"+a.name;else if("inline"===l.resolveAs){var p=l.obj;delete p.$ref;for(f in a.obj){var h=this.retainRoot(a.obj[f]);p[f]=h}}}2===this.iteration?s.call(this.scope,e,i):(this.iteration+=1,this.resolve(e,t,s,this.scope))},Resolver.prototype.retainRoot=function(e,t){for(var o in e){var r=e[o];"$ref"===o&&"string"==typeof r?0!==r.indexOf("http://")&&0!==r.indexOf("https://")&&(0!==r.indexOf("#")&&(r="#"+r),r=(t||"")+r,e[o]=r):"object"==typeof r&&this.retainRoot(r,t)}return e},Resolver.prototype.countRefs=function(e,t){t=t||0;for(var o in e){var r=e[o];"$ref"===o&&"string"==typeof r?t+=1:"object"==typeof r&&(t+=this.countRefs(r))}return t},Resolver.prototype.resolveInline=function(e,t,o,r,i,s){var n=o.$ref;n?(n.indexOf("#")>=0&&(s=n.split("#")[1]),0===n.indexOf("http")?(n.indexOf("#")>=0?(e=n.split("#")[0],s=n.split("#")[1]):e=n,r.push({obj:o,resolveAs:"inline",root:e,key:n,location:s})):r.push(0===n.indexOf("#")?{obj:o,resolveAs:"inline",root:e,key:n,location:s}:{obj:o,resolveAs:"inline",root:e,key:n,location:s})):"array"===o.type&&this.resolveTo(e,o.items,r,s)},Resolver.prototype.resolveTo=function(e,t,o,r){var i=t.$ref;if(i)i.indexOf("#")>=0&&(r=i.split("#")[1]),o.push({obj:t,resolveAs:"ref",root:e,key:i,location:r});else if("array"===t.type){var s=t.items;this.resolveTo(e,s,o,r)}};
