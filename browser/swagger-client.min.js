...
"use strict";var _={forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined"),keys:require("lodash-compat/object/keys"),map:require("lodash-compat/collection/map")},helpers=require("../helpers"),applyParameterMacro=function(e,i){return e.api&&e.api.parameterMacro?e.api.parameterMacro(e,i):i.defaultValue},applyModelPropertyMacro=function(e,i){return e.api&&e.api.modelPropertyMacro?e.api.modelPropertyMacro(e,i):i["default"]},Model=module.exports=function(e,i,t){return this.definition=i||{},this.isArray="array"===i.type,this.models=t||{},this.name=i.title||e||"Inline Model",this},schemaToHTML=function(e,i,t){for(var n='<span class="strong">',r="</span>",s={},a=[],o=0,p=function(e,i,n){var r,a=i;return e.$ref?(a=e.title||helpers.simpleRef(e.$ref),r=t[a]):_.isUndefined(i)&&(a=e.title||"Inline Model "+ ++o,r=new Model(a,e,t)),n!==!0&&(s[a]=_.isUndefined(r)?{}:r.definition),a},m=function(e){var i='<span class="propType">',t=e.type||"object";return e.$ref?i+=p(e,helpers.simpleRef(e.$ref)):"object"===t?i+=_.isUndefined(e.properties)?"object":p(e):"array"===t?(i+="Array[",_.isArray(e.items)?i+=_.map(e.items,p).join(","):_.isPlainObject(e.items)?i+=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?p(e.items):e.items.type:p(e.items,helpers.simpleRef(e.items.$ref)):(helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),i+="object"),i+="]"):i+=e.type,i+="</span>"},l=function(e,i){var t="",n=e.type||"object",r="array"===n;switch(r&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e["default"])||(t+=helpers.optionHtml("Default",e["default"])),n){case"string":e.minLength&&(t+=helpers.optionHtml("Min. Length",e.minLength)),e.maxLength&&(t+=helpers.optionHtml("Max. Length",e.maxLength)),e.pattern&&(t+=helpers.optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(t+=helpers.optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(t+=helpers.optionHtml("Exclusive Min.","true")),e.maximum&&(t+=helpers.optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(t+=helpers.optionHtml("Exclusive Max.","true")),e.multipleOf&&(t+=helpers.optionHtml("Multiple Of",e.multipleOf))}if(r&&(e.minItems&&(t+=helpers.optionHtml("Min. Items",e.minItems)),e.maxItems&&(t+=helpers.optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(t+=helpers.optionHtml("Unique Items","true")),e.collectionFormat&&(t+=helpers.optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var s;s="number"===n||"integer"===n?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',t+=helpers.optionHtml("Enum",s)}return t.length>0&&(i='<span class="propWrap">'+i+'<table class="optionsWrapper"><tr><th colspan="2">'+n+"</th></tr>"+t+"</table></span>"),i},d=function(e,i){var s=e.type||"object",o="array"===e.type,d=n+i+" "+(o?"[":"{")+r;return i&&a.push(i),o?_.isArray(e.items)?d+="<div>"+_.map(e.items,function(e){var i=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],i)>-1?"object"===i&&_.isUndefined(e.properties)?"object":p(e):l(e,i):p(e,helpers.simpleRef(e.$ref))}).join(",</div><div>"):_.isPlainObject(e.items)?d+=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"<div>object</div>":"<div>"+p(e.items)+"</div>":"<div>"+l(e.items,e.items.type)+"</div>":"<div>"+p(e.items,helpers.simpleRef(e.items.$ref))+"</div>":(helpers.log("Array type's 'items' property is not an array or an object, cannot process"),d+="<div>object</div>"):e.$ref?d+="<div>"+p(e,i)+"</div>":"object"===s?(d+="<div>",_.isPlainObject(e.properties)&&(d+=_.map(e.properties,function(i,n){var r,s=_.indexOf(e.required||[],n)>-1,a='<span class="propName '+s+'">'+n+"</span> (";return _.isUndefined(i.$ref)||(r=t[helpers.simpleRef(i.$ref)],(_.isUndefined(r)||-1===_.indexOf([void 0,"array","object"],r.definition.type))&&(i=r.definition)),a+=m(i),s||(a+=', <span class="propOptKey">optional</span>'),a+=")",_.isUndefined(i.description)||(a+=": "+i.description),i["enum"]&&(a+=' = <span class="propVals">[\''+i["enum"].join("' or '")+"']</span>"),l(i,a)}).join(",</div><div>")),d+="</div>"):d="<div>"+l(e,s)+"</div>",d+n+(o?"]":"}")+r},c=d(i,e);_.keys(s).length>0;)_.forEach(s,function(e,i){var t=_.indexOf(a,i)>-1;delete s[i],t||(a.push(i),c+="<br />"+d(e,i))});return c},schemaToJSON=function(e,i,t){var n,r,s=e.type||"object",a=e.format;return e.example?r=e.example:_.isUndefined(e.items)&&_.isArray(e["enum"])&&(r=e["enum"][0]),_.isUndefined(r)&&(e.$ref?(n=i[helpers.simpleRef(e.$ref)],_.isUndefined(n)||(_.isUndefined(t[n.name])?(t[n.name]=n,r=schemaToJSON(n.definition,i,t),delete t[n.name]):r="array"===n.type?[]:{})):_.isUndefined(e["default"])?"string"===s?r="date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string":"integer"===s?r=0:"number"===s?r=0:"boolean"===s?r=!0:"object"===s?(r={},_.forEach(e.properties,function(e,n){r[n]=schemaToJSON(e,i,t)})):"array"===s&&(r=[],_.isArray(e.items)?_.forEach(e.items,function(e){r.push(schemaToJSON(e,i,t))}):_.isPlainObject(e.items)?r.push(schemaToJSON(e.items,i,t)):_.isUndefined(e.items)?r.push({}):helpers.log("Array type's 'items' property is not an array or an object, cannot process")):r=e["default"]),r};Model.prototype.createJSONSample=Model.prototype.getSampleValue=function(e){return e=e||{},e[this.name]=this,this.examples&&_.isPlainObject(this.examples)&&this.examples["application/json"]?(this.definition.example=this.examples["application/json"],_.isString(this.definition.example)&&(this.definition.example=JSON.parse(this.definition.example))):this.definition.example=this.examples,schemaToJSON(this.definition,this.models,e)},Model.prototype.getMockSignature=function(){return schemaToHTML(this.name,this.definition,this.models)};
