...
},{"./helpers":5,"jquery":19,"superagent":90}],7:[function(require,module,exports){
...
"use strict";var ArrayModel=require("./arrayModel"),helpers=require("../helpers"),Property=module.exports=function(e,t,i,s){this.models=s,this.schema=t,this.required=i,t.$ref?this.$ref=helpers.simpleRef(t.$ref):"array"===t.type&&t.items&&(t.items.$ref?this.$ref=helpers.simpleRef(t.items.$ref):t=t.items),this.name=e,this.description=t.description,this.obj=t,this.optional=!0,this.optional=!i,this["default"]=t["default"]||null,this.example=void 0!==t.example?t.example:null,this.collectionFormat=t.collectionFormat||null,this.maximum=t.maximum||null,this.exclusiveMaximum=t.exclusiveMaximum||null,this.minimum=t.minimum||null,this.exclusiveMinimum=t.exclusiveMinimum||null,this.maxLength=t.maxLength||null,this.minLength=t.minLength||null,this.pattern=t.pattern||null,this.maxItems=t.maxItems||null,this.minItems=t.minItems||null,this.uniqueItems=t.uniqueItems||null,this["enum"]=t["enum"]||null,this.multipleOf=t.multipleOf||null},Model=module.exports=function(e,t,i){if(this.models=i||{},this.name=e,this.definition=t||{},this.properties=[],"array"===t.type)return new ArrayModel(t,i);var s,r=t.required||[],n=t.properties;if(n)for(s in n){var l=!1,p=n[s];r.indexOf(s)>=0&&(l=!0),this.properties.push(new Property(s,p,l,this.models))}return this};Model.prototype.createJSONSample=function(e){var t,i={},s={};for(e=e||{},e[this.name]=this,t=0;t<this.properties.length;t++){var r=this.properties[t],n=r.getSampleValue(e,s);i[r.name]=n}return delete e[this.name],i},Model.prototype.getSampleValue=function(e){var t,i={},s={};for(t=0;t<this.properties.length;t++){var r=this.properties[t];i[r.name]=r.sampleValue(!1,e,s)}return i},Model.prototype.getMockSignature=function(e){var t,i,s=[];for(t=0;t<this.properties.length;t++)i=this.properties[t],s.push(i.toString());var r='<span class="strong">',n="</span>",l=r+this.name+" {"+n,p=r+"}"+n,h=l+"<div>"+s.join(",</div><div>")+"</div>"+p;for(e||(e={}),e[this.name]=this,t=0;t<this.properties.length;t++){i=this.properties[t];var a=i.$ref,o=this.models[a];o&&"undefined"==typeof e[o.name]&&(h+="<br>"+o.getMockSignature(e))}return h},Property.prototype.getSampleValue=function(e,t){return this.sampleValue(!1,e,t)},Property.prototype.isArray=function(){var e=this.schema;return"array"===e.type?!0:!1},Property.prototype.sampleValue=function(e,t,i){e=e||this.isArray(),t=t||{};var s,r=this,n=function(e){var s,n=helpers.simpleRef(e),p=r.models[n];return"undefined"!=typeof i[l]&&(s=i[l]),p&&"undefined"==typeof t[l]?(t[l]=this,s=p.getSampleValue(t,i),i[l]=s):s=i[l]||n,s},l=helpers.getStringSignature(this.obj,!0);return s=this.$ref?n(this.$ref):this.example?this.example:this["default"]?this["default"]:"date-time"===l?(new Date).toISOString():"date"===l?(new Date).toISOString().split("T")[0]:"string"===l?"string":"integer"===l?0:"long"===l?0:"float"===l?0:"double"===l?0:"boolean"===l?!0:this.schema.$ref?n(this.schema.$ref):this.schema.properties?new Model("InlineModel-"+new Date,this.schema,this.models).getSampleValue():{},t[l]=s,e?[s]:s},Property.prototype.toString=function(){var e,t=helpers.getStringSignature(this.obj),i='<span class="strong">',s="</span>",r=[];if("object"===t){for(var n in this.schema.properties)this.schema.properties.hasOwnProperty(n)&&(e=new Property(n,this.schema.properties[n],(this.schema.required||[]).indexOf(n)>-1,this.models),r.push(e.toString()));t=i+this.name+" {"+s+"<div>"+r.join(",</div><div>")+"</div>"+i+"}"+s}else""!==t?(t='<span class="propName '+this.required+'">'+this.name+'</span> (<span class="propType">'+t+"</span>",this.required||(t+=', <span class="propOptKey">optional</span>'),t+=")"):t=this.name+" ("+JSON.stringify(this.obj)+")";"undefined"!=typeof this.description&&(t+=": "+this.description),this["enum"]&&(t+=' = <span class="propVals">[\''+this["enum"].join("' or '")+"']</span>"),this.descr&&(t+=': <span class="propDesc">'+this.descr+"</span>");var l,p="",h="array"===this.schema.type;switch(l=h?this.schema.items?this.schema.items.type:"":this.schema.type,this["default"]&&(p+=helpers.optionHtml("Default",this["default"])),l){case"string":this.minLength&&(p+=helpers.optionHtml("Min. Length",this.minLength)),this.maxLength&&(p+=helpers.optionHtml("Max. Length",this.maxLength)),this.pattern&&(p+=helpers.optionHtml("Reg. Exp.",this.pattern));break;case"integer":case"number":this.minimum&&(p+=helpers.optionHtml("Min. Value",this.minimum)),this.exclusiveMinimum&&(p+=helpers.optionHtml("Exclusive Min.","true")),this.maximum&&(p+=helpers.optionHtml("Max. Value",this.maximum)),this.exclusiveMaximum&&(p+=helpers.optionHtml("Exclusive Max.","true")),this.multipleOf&&(p+=helpers.optionHtml("Multiple Of",this.multipleOf))}if(h&&(this.minItems&&(p+=helpers.optionHtml("Min. Items",this.minItems)),this.maxItems&&(p+=helpers.optionHtml("Max. Items",this.maxItems)),this.uniqueItems&&(p+=helpers.optionHtml("Unique Items","true")),this.collectionFormat&&(p+=helpers.optionHtml("Coll. Format",this.collectionFormat))),this["enum"]){var a;a="number"===l||"integer"===l?this["enum"].join(", "):'"'+this["enum"].join('", "')+'"',p+=helpers.optionHtml("Enum",a)}return p.length>0&&(t='<span class="propWrap">'+t+'<table class="optionsWrapper"><tr><th colspan="2">'+this.name+"</th></tr>"+p+"</table></span>"),t};


},{"../helpers":5,"./arrayModel":8}],10:[function(require,module,exports){
...
},{"../internal/baseIndexOf":35,"../internal/binaryIndex":46}],22:[function(require,module,exports){
...
},{"../array/findIndex":20,"../internal/baseCallback":28,"../internal/baseEach":30,"../internal/baseFind":31,"../lang/isArray":76}],23:[function(require,module,exports){
...
},{"../internal/arrayEach":27,"../internal/baseEach":30,"../internal/bindCallback":48,"../lang/isArray":76}],24:[function(require,module,exports){
...
},{"../lang/isNative":78}],25:[function(require,module,exports){
...
},{"../internal/baseSlice":44,"../internal/createWrapper":55,"../internal/replaceHolders":70}],26:[function(require,module,exports){
...
},{"../utility/identity":88,"./baseMatches":40,"./baseMatchesProperty":41,"./baseProperty":42,"./bindCallback":48,"./isBindable":61}],29:[function(require,module,exports){
(function (global){
...
},{"../lang/isObject":79}],30:[function(require,module,exports){
...
},{"./baseForOwn":34,"./isLength":64,"./toObject":74}],31:[function(require,module,exports){
...
},{"./toObject":74}],33:[function(require,module,exports){
...
},{"./indexOfNaN":60}],36:[function(require,module,exports){
...
},{"../lang/isArray":76,"../lang/isTypedArray":82,"./equalArrays":56,"./equalByTag":57,"./equalObjects":58,"./isHostObject":62}],38:[function(require,module,exports){
...
},{"./baseIsEqual":36}],40:[function(require,module,exports){
...
},{"../object/keys":84,"./baseIsMatch":39,"./isStrictComparable":66}],41:[function(require,module,exports){
...
},{"./baseIsEqual":36,"./isStrictComparable":66}],42:[function(require,module,exports){
...
},{"../utility/identity":88,"./metaMap":68}],44:[function(require,module,exports){
...
},{"../utility/identity":88,"./binaryIndexBy":47}],47:[function(require,module,exports){
...
},{"./createCtorWrapper":52}],52:[function(require,module,exports){
...
},{"../lang/isObject":79,"./baseCreate":29}],53:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":26,"./composeArgs":49,"./composeArgsRight":50,"./createCtorWrapper":52,"./reorder":69,"./replaceHolders":70}],54:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":52}],55:[function(require,module,exports){
...
},{"./baseSetData":43,"./createBindWrapper":51,"./createHybridWrapper":53,"./createPartialWrapper":54,"./getData":59,"./mergeData":67,"./setData":71}],56:[function(require,module,exports){
...
},{"../utility/noop":89,"./metaMap":68}],60:[function(require,module,exports){
...
},{"../lang/isNative":78,"../support":87,"./baseSetData":43}],62:[function(require,module,exports){
...
},{"../lang/isObject":79}],67:[function(require,module,exports){
...
},{"./arrayCopy":26,"./composeArgs":49,"./composeArgsRight":50,"./replaceHolders":70}],68:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":78}],69:[function(require,module,exports){
...
},{"./arrayCopy":26,"./isIndex":63}],70:[function(require,module,exports){
...
},{"../date/now":24,"./baseSetData":43}],72:[function(require,module,exports){
...
},{"../lang/isArguments":75,"../support":87,"./baseForIn":33,"./isHostObject":62,"./isObjectLike":65}],73:[function(require,module,exports){
...
},{"../lang/isArguments":75,"../lang/isArray":76,"../lang/isString":81,"../object/keysIn":85,"../support":87,"./isIndex":63,"./isLength":64}],74:[function(require,module,exports){
...
},{"../lang/isObject":79,"../lang/isString":81,"../support":87}],75:[function(require,module,exports){
...
},{"../internal/isLength":64,"../internal/isObjectLike":65,"../support":87}],76:[function(require,module,exports){
...
},{"../internal/isLength":64,"../internal/isObjectLike":65,"./isNative":78}],77:[function(require,module,exports){
(function (global){
...
},{"../internal/baseIsFunction":38,"./isNative":78}],78:[function(require,module,exports){
...
},{"../internal/isHostObject":62,"../internal/isObjectLike":65,"../string/escapeRegExp":86}],79:[function(require,module,exports){
...
},{"../internal/shimIsPlainObject":72,"../support":87,"./isArguments":75,"./isNative":78}],81:[function(require,module,exports){
...
},{"../internal/isObjectLike":65}],82:[function(require,module,exports){
...
},{"../internal/isLength":64,"../internal/isObjectLike":65}],83:[function(require,module,exports){
...
},{"../internal/isLength":64,"../internal/shimKeys":73,"../lang/isNative":78,"../lang/isObject":79,"../support":87}],85:[function(require,module,exports){
...
},{"../internal/arrayEach":27,"../internal/isIndex":63,"../internal/isLength":64,"../lang/isArguments":75,"../lang/isArray":76,"../lang/isFunction":77,"../lang/isObject":79,"../lang/isString":81,"../support":87}],86:[function(require,module,exports){
...
},{"../internal/baseToString":45}],87:[function(require,module,exports){
(function (global){
...
},{"./lang/isNative":78}],88:[function(require,module,exports){
...
},{"emitter":91,"reduce":92}],91:[function(require,module,exports){
