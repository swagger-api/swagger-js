...
"use strict";var auth=require("./lib/auth"),helpers=require("./lib/helpers"),SwaggerClient=require("./lib/client-compat"),deprecationWrapper=function(e,r){return helpers.log('This is deprecated, use "new SwaggerClient" instead.'),new SwaggerClient(e,r)};Array.prototype.indexOf||(Array.prototype.indexOf=function(e,r){for(var t=r||0,i=this.length;i>t;t++)if(this[t]===e)return t;return-1}),module.exports=SwaggerClient,SwaggerClient.ApiKeyAuthorization=auth.ApiKeyAuthorization,SwaggerClient.PasswordAuthorization=auth.PasswordAuthorization,SwaggerClient.CookieAuthorization=auth.CookieAuthorization,SwaggerClient.SwaggerApi=deprecationWrapper,SwaggerClient.SwaggerClient=deprecationWrapper;
},{"./lib/auth":2,"./lib/client-compat":3,"./lib/helpers":5}],2:[function(require,module,exports){
...
},{"btoa":18,"cookiejar":19}],3:[function(require,module,exports){
"use strict";var helpers=require("./helpers"),SwaggerClient=require("./client"),SwaggerHttp=require("./http");module.exports=SwaggerClient;var applyParameterMacro=function(e,t){return e.api.parameterMacro?e.api.parameterMacro(e,t):t.defaultValue},applyModelPropertyMacro=function(e,t){return e.api.modelPropertyMacro?e.api.modelPropertyMacro(e,t):t.defaultValue},SwaggerModelProperty=function(e,t,r){this.name=e,this.dataType=t.type||t.dataType||t.$ref,this.isCollection=this.dataType&&("array"===this.dataType.toLowerCase()||"list"===this.dataType.toLowerCase()||"set"===this.dataType.toLowerCase()),this.descr=t.description,this.required=t.required,this.defaultValue=applyModelPropertyMacro(r,t),t.items&&(t.items.type&&(this.refDataType=t.items.type),t.items.$ref&&(this.refDataType=t.items.$ref)),this.dataTypeWithRef=this.refDataType?this.dataType+"["+this.refDataType+"]":this.dataType,t.allowableValues&&(this.valueType=t.allowableValues.valueType,this.values=t.allowableValues.values,this.values&&(this.valuesString="'"+this.values.join("' or '")+"'")),t["enum"]&&(this.valueType="string",this.values=t["enum"],this.values&&(this.valueString="'"+this.values.join("' or '")+"'"))},SwaggerModel=function(e,t,r){this.api=r,this.name="undefined"!=typeof t.id?t.id:e,this.properties=[],this.sampleModels=r.sampleModels;var s;for(s in t.properties){if(t.required){var a;for(a in t.required)s===t.required[a]&&(t.properties[s].required=!0)}var i=new SwaggerModelProperty(s,t.properties[s],this);this.properties.push(i)}},SwaggerOperation=function(e,t,r,s,a,i,o,n,p,h,u,l,d,c){var f=this,g=[];if(this.clientAuthorizations=c,this.nickname=e||g.push("SwaggerOperations must have a nickname."),this.path=t||g.push("SwaggerOperation "+e+" is missing path."),this.method=r||g.push("SwaggerOperation "+e+" is missing method."),this.parameters=s?s:[],this.summary=a,this.notes=i,this.type=o,this.responseMessages=n||[],this.resource=p||g.push("Resource is required"),this.consumes=h,this.produces=u,this.authorizations="undefined"!=typeof l?l:p.authorizations,this.deprecated=d,this["do"]=helpers.__bind(this["do"],this),this.api=this.resource.api,"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}g.length>0&&(console.error("SwaggerOperation errors",g,arguments),this.resource.api.fail(g)),this.path=this.path.replace("{format}","json"),this.method=this.method.toLowerCase(),this.isGetMethod="get"===this.method;var m,y,v;for(this.resourceName=this.resource.name,"undefined"!=typeof this.type&&"void"===this.type?this.type=null:(this.responseClassSignature=this.getSignature(this.type,this.resource.models),this.responseSampleJSON=this.getSampleJSON(this.type,this.resource.models)),m=0;m<this.parameters.length;m++){var w=this.parameters[m];w.name=w.name||w.type||w.dataType,o=w.type||w.dataType,"array"===o&&(o="array["+(w.items.$ref?w.items.$ref:w.items.type)+"]"),w.type=o,o&&"boolean"===o.toLowerCase()&&(w.allowableValues={},w.allowableValues.values=["true","false"]),w.signature=this.getSignature(o,this.resource.models),w.sampleJSON=this.getSampleJSON(o,this.resource.models);var S=w["enum"];if("undefined"!=typeof S)for(w.isList=!0,w.allowableValues={},w.allowableValues.descriptiveValues=[],y=0;y<S.length;y++)v=S[y],w.allowableValues.descriptiveValues.push(w.defaultValue?{value:String(v),isDefault:v===w.defaultValue}:{value:String(v),isDefault:!1});else if(w.allowableValues&&("RANGE"===w.allowableValues.valueType?w.isRange=!0:w.isList=!0,w.allowableValues&&(w.allowableValues.descriptiveValues=[],w.allowableValues.values)))for(y=0;y<w.allowableValues.values.length;y++)v=w.allowableValues.values[y],w.allowableValues.descriptiveValues.push(null!==w.defaultValue?{value:String(v),isDefault:v===w.defaultValue}:{value:String(v),isDefault:!1});w.defaultValue=applyParameterMacro(this,w)}var b=this.resource.api.defaultSuccessCallback||null,T=this.resource.api.defaultErrorCallback||null;this.resource[this.nickname]=function(e,t,r,s){var a,i,o,n;return"function"==typeof e?(a={},i={},o=e,n=t):"object"==typeof e&&"function"==typeof t?(a=e,i={},o=t,n=r):(a=e,i=t,o=r,n=s),f["do"](a||{},i||{},o||b,n||T)},this.resource[this.nickname].help=function(e){return f.help(e)},this.resource[this.nickname].asCurl=function(e){return f.asCurl(e)}},SwaggerRequest=function(e,t,r,s,a,i,o,n){var p=this,h=[];if(this.useJQuery="undefined"!=typeof o.resource.useJQuery?o.resource.useJQuery:null,this.type=e||h.push("SwaggerRequest type is required (get/post/put/delete/patch/options)."),this.url=t||h.push("SwaggerRequest url is required."),this.params=r,this.opts=s,this.successCallback=a||h.push("SwaggerRequest successCallback is required."),this.errorCallback=i||h.push("SwaggerRequest error callback is required."),this.operation=o||h.push("SwaggerRequest operation is required."),this.execution=n,this.headers=r.headers||{},h.length>0)throw h;this.type=this.type.toUpperCase();var u=this.setHeaders(r,s,this.operation),l=r.body;if(u["Content-Type"]){var d,c,f,g={},m=this.operation.parameters;for(f=0;f<m.length;f++){var y=m[f];"form"===y.paramType&&(g[y.name]=y)}if(0===u["Content-Type"].indexOf("application/x-www-form-urlencoded")){var v="";for(d in g)c=this.params[d],"undefined"!=typeof c&&(""!==v&&(v+="&"),v+=encodeURIComponent(d)+"="+encodeURIComponent(c));l=v}else if(0===u["Content-Type"].indexOf("multipart/form-data")){var w="",S="----SwaggerFormBoundary"+Date.now();for(d in g)c=this.params[d],"undefined"!=typeof c&&(w+="--"+S+"\n",w+='Content-Disposition: form-data; name="'+d+'"',w+="\n\n",w+=c+"\n");w+="--"+S+"--\n",u["Content-Type"]="multipart/form-data; boundary="+S,l=w}}var b;if(!this.headers||!this.headers.mock){b={url:this.url,method:this.type,headers:u,body:l,useJQuery:this.useJQuery,on:{error:function(e){return p.errorCallback(e,p.opts.parent)},redirect:function(e){return p.successCallback(e,p.opts.parent)},307:function(e){return p.successCallback(e,p.opts.parent)},response:function(e){return p.successCallback(e,p.opts.parent)}}};var T=!1;if(this.operation.resource&&this.operation.resource.api&&this.operation.resource.api.clientAuthorizations&&(T=this.operation.resource.api.clientAuthorizations.apply(b,this.operation.authorizations)),s.mock)return b;T!==!1?(new SwaggerHttp).execute(b):b.canceled=!0}return b},SwaggerResource=function(e,t){var r=this;this.api=t,this.swaggerRequstHeaders=t.swaggerRequstHeaders,this.path="string"==typeof this.api.resourcePath?this.api.resourcePath:e.path,this.description=e.description,this.authorizations=e.authorizations||{};var s=this.path.split("/");if(this.name=s[s.length-1].replace(".{format}",""),this.basePath=this.api.basePath,this.operations={},this.operationsArray=[],this.modelsArray=[],this.models=t.models||{},this.rawModels={},this.useJQuery="undefined"!=typeof t.useJQuery?t.useJQuery:null,e.apis&&this.api.resourcePath)this.addApiDeclaration(e);else{"undefined"==typeof this.path&&this.api.fail("SwaggerResources must have a path."),this.url="http"===this.path.substring(0,4)?this.path.replace("{format}","json"):this.api.basePath+this.path.replace("{format}","json"),this.api.progress("fetching resource "+this.name+": "+this.url);var a={url:this.url,method:"GET",useJQuery:this.useJQuery,headers:{accept:this.swaggerRequstHeaders},on:{response:function(e){var t=e.obj||JSON.parse(e.data);return r.api.resourceCount+=1,r.addApiDeclaration(t)},error:function(e){return r.api.resourceCount+=1,r.api.fail("Unable to read api '"+r.name+"' from path "+r.url+" (server returned "+e.statusText+")")}}};t.clientAuthorizations.apply(a),(new SwaggerHttp).execute(a)}};SwaggerClient.prototype.buildFrom1_2Spec=function(e){null!==e.apiVersion&&(this.apiVersion=e.apiVersion),this.apis={},this.apisArray=[],this.authSchemes=e.authorizations,this.consumes=e.consumes,this.info=this.convertInfo(e.info),this.produces=e.produces;var t,r,s=!1;for(t=0;t<e.apis.length;t++){var a=e.apis[t];if(a.operations){var i;for(i=0;i<a.operations.length;i++)s=!0}}if(this.basePath=e.basePath?e.basePath:this.url.indexOf("?")>0?this.url.substring(0,this.url.lastIndexOf("?")):this.url,s){var o=e.resourcePath.replace(/\//g,"");this.resourcePath=e.resourcePath,r=new SwaggerResource(e,this),this.apis[o]=r,this.apisArray.push(r),this.finish()}else{var n;for(this.expectedResourceCount=e.apis.length,n=0;n<e.apis.length;n++){var p=e.apis[n];r=new SwaggerResource(p,this),this.apis[r.name]=r,this.apisArray.push(r)}}return this.isValid=!0,this},SwaggerClient.prototype.finish=function(){"function"==typeof this.success&&(this.isValid=!0,this.ready=!0,this.isBuilt=!0,this.selfReflect(),this.success())},SwaggerClient.prototype.buildFrom1_1Spec=function(e){helpers.log("This API is using a deprecated version of Swagger!  Please see http://github.com/wordnik/swagger-core/wiki for more info"),null!==e.apiVersion&&(this.apiVersion=e.apiVersion),this.apis={},this.apisArray=[],this.produces=e.produces,this.info=this.convertInfo(e.info);for(var t,r=!1,s=0;s<e.apis.length;s++){var a=e.apis[s];if(a.operations)for(var i=0;i<a.operations.length;i++){r=!0;break}}if(this.basePath=e.basePath?e.basePath:this.url.indexOf("?")>0?this.url.substring(0,this.url.lastIndexOf("?")):this.url,r){var o=e.resourcePath.replace(/\//g,"");this.resourcePath=e.resourcePath,t=new SwaggerResource(e,this),this.apis[o]=t,this.apisArray.push(t),this.finish()}else{this.expectedResourceCount=e.apis.length;for(var n=0;n<e.apis.length;n++)t=new SwaggerResource(e.apis[n],this),this.apis[t.name]=t,this.apisArray.push(t)}return this.isValid=!0,this},SwaggerClient.prototype.convertInfo=function(e){if("object"==typeof e){var t={};return t.title=e.title,t.description=e.description,t.termsOfService=e.termsOfServiceUrl,t.contact={},t.contact.name=e.contact,t.license={},t.license.name=e.license,t.license.url=e.licenseUrl,t}},SwaggerClient.prototype.selfReflect=function(){var e,t;if(null===this.apis)return!1;t=this.apis;for(e in t){var r=t[e];if(null===r.ready)return!1;this[e]=r,this[e].help=helpers.__bind(r.help,r)}this.setConsolidatedModels(),this.ready=!0},SwaggerClient.prototype.setConsolidatedModels=function(){var e,t,r,s,a,i,o,n;this.models={},i=this.apis;for(s in i){r=i[s];for(t in r.models)"undefined"==typeof this.models[t]&&(this.models[t]=r.models[t],this.modelsArray.push(r.models[t]))}for(o=this.modelsArray,n=[],a=0;a<o.length;a++)e=o[a],n.push(e.setReferencedModels(this.models));return n},SwaggerResource.prototype.help=function(e){var t,r='operations for the "'+this.name+'" tag';for(t=0;t<this.operationsArray.length;t++){var s=this.operationsArray[t];r+="\n  * "+s.nickname+": "+s.description}return e?r:(helpers.log(r),r)},SwaggerResource.prototype.getAbsoluteBasePath=function(e){var t=this.api.basePath,r=t.lastIndexOf(e),s=t.split("/"),a=s[0]+"//"+s[2];if(0===e.indexOf("http"))return e;if("/"===e)return a;if("/"===e.substring(0,1))return a+e;r=this.basePath.lastIndexOf("/");var i=this.basePath.substring(0,r);return"/"===i.substring(i.length-1)?i+e:i+"/"+e},SwaggerResource.prototype.addApiDeclaration=function(e){if("string"==typeof e.produces&&(this.produces=e.produces),"string"==typeof e.consumes&&(this.consumes=e.consumes),"string"==typeof e.basePath&&e.basePath.replace(/\s/g,"").length>0&&(this.basePath=0!==e.basePath.indexOf("http")?this.getAbsoluteBasePath(e.basePath):e.basePath),this.resourcePath=e.resourcePath,this.addModels(e.models),e.apis)for(var t=0;t<e.apis.length;t++){var r=e.apis[t];this.addOperations(r.path,r.operations,e.consumes,e.produces)}return this.api[this.name]=this,this.ready=!0,this.api.resourceCount===this.api.expectedResourceCount&&this.api.finish(),this},SwaggerResource.prototype.addModels=function(e){if("object"==typeof e){var t;for(t in e)if("undefined"==typeof this.models[t]){var r=new SwaggerModel(t,e[t],this.api);this.modelsArray.push(r),this.models[t]=r,this.rawModels[t]=e[t]}for(var s=[],a=0;a<this.modelsArray.length;a++){var i=this.modelsArray[a];s.push(i.setReferencedModels(this.models))}return s}},SwaggerResource.prototype.addOperations=function(e,t,r,s){if(t){for(var a=[],i=0;i<t.length;i++){var o=t[i];r=this.consumes,s=this.produces,r="undefined"!=typeof o.consumes?o.consumes:this.consumes,s="undefined"!=typeof o.produces?o.produces:this.produces;var n=o.type||o.responseClass;if("array"===n){var p=null;o.items&&(p=o.items.type||o.items.$ref),n="array["+p+"]"}var h=o.responseMessages,u=o.method;if(o.httpMethod&&(u=o.httpMethod),o.supportedContentTypes&&(r=o.supportedContentTypes),o.errorResponses){h=o.errorResponses;for(var l=0;l<h.length;l++){var d=h[l];d.message=d.reason,d.reason=null}}o.nickname=this.sanitize(o.nickname);var c=new SwaggerOperation(o.nickname,e,u,o.parameters,o.summary,o.notes,n,h,this,r,s,o.authorizations,o.deprecated,this.clientAuthorizations);this.operations[c.nickname]=c,a.push(this.operationsArray.push(c))}return a}},SwaggerResource.prototype.sanitize=function(e){var t=e.replace(/[\s!@#$%^&*()_+=\[{\]};:<>|.\/?,\\'""-]/g,"_");return t=t.replace(/((_){2,})/g,"_"),t=t.replace(/^(_)*/g,""),t=t.replace(/([_])*$/g,"")},SwaggerModel.prototype.setReferencedModels=function(e){for(var t=[],r=0;r<this.properties.length;r++){var s=this.properties[r],a=s.type||s.dataType;t.push(e[a]?s.refModel=e[a]:s.refDataType&&e[s.refDataType]?s.refModel=e[s.refDataType]:void 0)}return t},SwaggerModel.prototype.getMockSignature=function(e){var t,r,s=[];for(t=0;t<this.properties.length;t++)r=this.properties[t],s.push(r.toString());var a='<span class="strong">',i="</span>",o=a+this.name+" {"+i,n=a+"}"+i,p=o+"<div>"+s.join(",</div><div>")+"</div>"+n;for(e||(e=[]),e.push(this.name),t=0;t<this.properties.length;t++)r=this.properties[t],r.refModel&&-1===e.indexOf(r.refModel.name)&&(p+="<br>"+r.refModel.getMockSignature(e));return p},SwaggerModel.prototype.createJSONSample=function(e){if(this.sampleModels[this.name])return this.sampleModels[this.name];var t={};e=e||[],e.push(this.name);for(var r=0;r<this.properties.length;r++){var s=this.properties[r];t[s.name]=s.getSampleValue(e)}return e.pop(this.name),t},SwaggerModelProperty.prototype.getSampleValue=function(e){var t;return t=this.refModel&&-1===e.indexOf(this.refModel.name)?this.refModel.createJSONSample(e):this.toSampleValue(this.isCollection?this.refDataType:this.dataType),this.isCollection?[t]:t},SwaggerModelProperty.prototype.toSampleValue=function(e){var t;return t="undefined"!=typeof this.defaultValue&&this.defaultValue?this.defaultValue:"integer"===e?0:"boolean"===e?!1:"double"===e||"number"===e?0:"string"===e?"":e},SwaggerModelProperty.prototype.toString=function(){var e=this.required?"propReq":"propOpt",t='<span class="propName '+e+'">'+this.name+'</span> (<span class="propType">'+this.dataTypeWithRef+"</span>";return this.required||(t+=', <span class="propOptKey">optional</span>'),t+=")",this.values&&(t+=' = <span class="propVals">[\''+this.values.join("' or '")+"']</span>"),this.descr&&(t+=': <span class="propDesc">'+this.descr+"</span>"),t},SwaggerOperation.prototype.isListType=function(e){return e&&e.indexOf("[")>=0?e.substring(e.indexOf("[")+1,e.indexOf("]")):void 0},SwaggerOperation.prototype.getSignature=function(e,t){var r=this.isListType(e),s="undefined"!=typeof r&&t[r]||"undefined"!=typeof t[e]?!1:!0;return s?e:"undefined"!=typeof r?t[r].getMockSignature():t[e].getMockSignature()},SwaggerOperation.prototype.getSampleJSON=function(e,t){var r=this.isListType(e),s="undefined"!=typeof r&&t[r]||"undefined"!=typeof t[e]?!1:!0,a=s?void 0:r?t[r].createJSONSample():t[e].createJSONSample();if(a){if(a=r?[a]:a,"string"==typeof a)return a;if("object"==typeof a){var i=a;if(a instanceof Array&&a.length>0&&(i=a[0]),i.nodeName){var o=(new XMLSerializer).serializeToString(i);return this.formatXml(o)}return JSON.stringify(a,null,2)}return a}},SwaggerOperation.prototype["do"]=function(e,t,r,s){var a,i,o,n,p,h=[];"function"!=typeof s&&(s=function(e,t,r){return helpers.log(e,t,r)}),"function"!=typeof r&&(r=function(e){var t=null;return t=null!==e?e.data:"no data",helpers.log("default callback: "+t)}),o={},o.headers=[],e.headers&&(o.headers=e.headers,delete e.headers),t&&t.responseContentType&&(o.headers["Content-Type"]=t.responseContentType),t&&t.requestContentType&&(o.headers.Accept=t.requestContentType);for(var u=0;u<this.parameters.length;u++)if(i=this.parameters[u],"header"===i.paramType)"undefined"!=typeof e[i.name]&&(o.headers[i.name]=e[i.name]);else if("form"===i.paramType||"file"===i.paramType.toLowerCase())h.push(i);else if("body"===i.paramType&&"body"!==i.name&&"undefined"!=typeof e[i.name]){if(e.body)throw new Error("Saw two body params in an API listing; expecting a max of one.");e.body=e[i.name]}if("undefined"!=typeof e.body&&(o.body=e.body,delete e.body),h)for(a in h)p=h[a],e[p.name]&&(o[p.name]=e[p.name]);return n=new SwaggerRequest(this.method,this.urlify(e),o,t,r,s,this),t.mock?n:!0},SwaggerOperation.prototype.pathJson=function(){return this.path.replace("{format}","json")},SwaggerOperation.prototype.pathXml=function(){return this.path.replace("{format}","xml")},SwaggerOperation.prototype.encodePathParam=function(e){var t,r,s,a,i;if(e=e.toString(),-1===e.indexOf("/"))return encodeURIComponent(e);for(s=e.split("/"),t=[],a=0,i=s.length;i>a;a++)r=s[a],t.push(encodeURIComponent(r));return t.join("/")},SwaggerOperation.prototype.urlify=function(e){var t,r,s,a;a=this.resource.basePath.length>1&&"/"===this.resource.basePath.slice(-1)&&"/"===this.pathJson().charAt(0)?this.resource.basePath+this.pathJson().substring(1):this.resource.basePath+this.pathJson();var i=this.parameters;for(t=0;t<i.length;t++)if(s=i[t],"path"===s.paramType){if("undefined"==typeof e[s.name])throw""+s.name+" is a required path param.";var o=new RegExp("\\{\\s*?"+s.name+"[^\\{\\}\\/]*(?:\\{.*?\\}[^\\{\\}\\/]*)*\\}(?=(\\/?|$))","gi");a=a.replace(o,this.encodePathParam(e[s.name])),delete e[s.name]}var n="";for(t=0;t<i.length;t++)if(s=i[t],"query"===s.paramType){var p="";if(Array.isArray(s)){var h="";for(r=0;r<s.length;r++)r>0&&(h+=","),h+=encodeURIComponent(s[r]);p+=encodeURIComponent(s.name)+"="+h}else if(e[s.name])p+=encodeURIComponent(s.name)+"="+encodeURIComponent(e[s.name]);else if(s.required)throw""+s.name+" is a required query param.";""!==p&&n.length>0&&(n+="&"),n+=p}return n&&n.length>0&&(a+="?"+n),a},SwaggerOperation.prototype.supportHeaderParams=function(){return this.resource.api.supportHeaderParams},SwaggerOperation.prototype.supportedSubmitMethods=function(){return this.resource.api.supportedSubmitMethods},SwaggerOperation.prototype.getQueryParams=function(e){return this.getMatchingParams(["query"],e)},SwaggerOperation.prototype.getHeaderParams=function(e){return this.getMatchingParams(["header"],e)},SwaggerOperation.prototype.getMatchingParams=function(e,t){for(var r={},s=this.parameters,a=0;a<s.length;a++){var i=s[a];t&&t[i.name]&&(r[i.name]=t[i.name])}var o,n=this.resource.api.headers;for(o in n){var p=n[o];r[o]=p}return r},SwaggerOperation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary,r=this.parameters,s=0;s<r.length;s++){var a=r[s];t+="\n* "+a.name+(a.required?" (required)":"")+" - "+a.description}return e?t:(helpers.log(t),t)},SwaggerOperation.prototype.asCurl=function(e){var t,r=SwaggerRequest.prototype.setHeaders(e,{},this),s=[];for(t=0;t<this.parameters.length;t++){var a=this.parameters[t];a.paramType&&"header"===a.paramType&&e[a.name]&&(r[a.name]=e[a.name])}var i;for(i in r)s.push('--header "'+i+": "+r[i]+'"');return"curl "+s.join(" ")+" "+this.urlify(e)},SwaggerOperation.prototype.formatXml=function(e){var t,r,s,a,i,o,n,p,h,u,l,d,c;for(p=/(>)(<)(\/*)/g,u=/[ ]*(.*)[ ]+\n/g,t=/(<.+>)(.+\n)/g,e=e.replace(p,"$1\n$2$3").replace(u,"$1\n").replace(t,"$1\n$2"),n=0,r="",i=e.split("\n"),s=0,a="other",h={"single->single":0,"single->closing":-1,"single->opening":0,"single->other":0,"closing->single":0,"closing->closing":-1,"closing->opening":0,"closing->other":0,"opening->single":1,"opening->closing":0,"opening->opening":1,"opening->other":1,"other->single":0,"other->closing":-1,"other->opening":0,"other->other":0},l=function(e){var t,i,o,n,p,u,l;u={single:Boolean(e.match(/<.+\/>/)),closing:Boolean(e.match(/<\/.+>/)),opening:Boolean(e.match(/<[^!?].*>/))},p=function(){var e;e=[];for(o in u)l=u[o],l&&e.push(o);return e}()[0],p=void 0===p?"other":p,t=a+"->"+p,a=p,n="",s+=h[t],n=function(){var e,t,r=[];for(i=e=0,t=s;t>=0?t>e:e>t;i=t>=0?++e:--e)r.push("  ");return r}().join(""),"opening->closing"===t?r=r.substr(0,r.length-1)+e+"\n":r+=n+e+"\n"},d=0,c=i.length;c>d;d++)o=i[d],l(o);return r},SwaggerRequest.prototype.setHeaders=function(e,t,r){var s,a=t.responseContentType||"application/json",i=t.requestContentType||"application/json",o=r.parameters,n=[],p=[],h=e.body,u={};for(s=0;s<o.length;s++){var l=o[s];if("form"===l.paramType)n.push(l);else if("file"===l.paramType)p.push(l);else if("header"===l.paramType&&this.params.headers){var d=l.name,c=this.params.headers[l.name];"undefined"!=typeof this.params.headers[l.name]&&(u[d]=c)}}return!h||"POST"!==this.type&&"PUT"!==this.type&&"PATCH"!==this.type&&"DELETE"!==this.type?n.length>0?i=p.length>0?"multipart/form-data":"application/x-www-form-urlencoded":"DELETE"===this.type?h="{}":"DELETE"!==this.type&&(i=null):this.opts.requestContentType&&(i=this.opts.requestContentType),i&&this.operation.consumes&&-1===this.operation.consumes.indexOf(i)&&helpers.log("server doesn't consume "+i+", try "+JSON.stringify(this.operation.consumes)),a=this.opts&&this.opts.responseContentType?this.opts.responseContentType:"application/json",a&&r.produces&&-1===r.produces.indexOf(a)&&helpers.log("server can't produce "+a),(i&&""!==h||"application/x-www-form-urlencoded"===i)&&(u["Content-Type"]=i),a&&(u.Accept=a),u};


},{"./client":4,"./helpers":5,"./http":6}],4:[function(require,module,exports){
"use strict";var _={bind:require("lodash-compat/function/bind"),cloneDeep:require("lodash-compat/lang/cloneDeep"),find:require("lodash-compat/collection/find"),forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isFunction:require("lodash-compat/lang/isFunction"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isUndefined:require("lodash-compat/lang/isUndefined")},auth=require("./auth"),helpers=require("./helpers"),Model=require("./types/model"),Operation=require("./types/operation"),OperationGroup=require("./types/operationGroup"),Resolver=require("./resolver"),SwaggerHttp=require("./http"),SwaggerSpecConverter=require("./spec-converter"),reservedClientTags=["authorizationScheme","authorizations","basePath","build","buildFrom1_1Spec","buildFrom1_2Spec","buildFromSpec","clientAuthorizations","convertInfo","debug","defaultErrorCallback","defaultSuccessCallback","fail","failure","finish","help","idFromOp","info","initialize","isBuilt","isValid","models","modelsArray","options","parseUri","progress","resourceCount","sampleModels","selfReflect","setConsolidatedModels","spec","supportedSubmitMethods","swaggerRequstHeaders","tagFromLabel","url","useJQuery"],reservedApiTags=["apis","asCurl","description","externalDocs","help","label","name","operation","operations","operationsArray","path","tag"],supportedOperationMethods=["delete","get","head","options","patch","post","put"],SwaggerClient=module.exports=function(e,t){return this.authorizationScheme=null,this.authorizations=null,this.basePath=null,this.debug=!1,this.info=null,this.isBuilt=!1,this.isValid=!1,this.modelsArray=[],this.resourceCount=0,this.url=null,this.useJQuery=!1,"undefined"!=typeof e?this.initialize(e,t):this};SwaggerClient.prototype.initialize=function(e,t){this.models={},this.sampleModels={},t=t||{},"string"==typeof e?this.url=e:"object"==typeof e&&(t=e,this.url=t.url),this.swaggerRequstHeaders=t.swaggerRequstHeaders||"application/json;charset=utf-8,*/*",this.defaultSuccessCallback=t.defaultSuccessCallback||null,this.defaultErrorCallback=t.defaultErrorCallback||null,"function"==typeof t.success&&(this.success=t.success),t.useJQuery&&(this.useJQuery=t.useJQuery),this.clientAuthorizations=t.authorizations?t.authorizations:new auth.SwaggerAuthorizations,this.supportedSubmitMethods=t.supportedSubmitMethods||[],this.failure=t.failure||function(){},this.progress=t.progress||function(){},this.spec=_.cloneDeep(t.spec),this.options=t,"function"==typeof t.success&&(this.ready=!0,this.build())},SwaggerClient.prototype.build=function(e){if(this.isBuilt)return this;var t=this;this.progress("fetching resource list: "+this.url);var i={useJQuery:this.useJQuery,url:this.url,method:"get",headers:{accept:this.swaggerRequstHeaders},on:{error:function(e){return t.fail("http"!==t.url.substring(0,4)?"Please specify the protocol for "+t.url:0===e.status?"Can't read from server.  It may not have the appropriate access-control-origin settings.":404===e.status?"Can't read swagger JSON from "+t.url:e.status+" : "+e.statusText+" "+t.url)},response:function(e){var i=e.obj||JSON.parse(e.data);if(t.swaggerVersion=i.swaggerVersion,i.swagger&&2===parseInt(i.swagger))t.swaggerVersion=i.swagger,(new Resolver).resolve(i,t.buildFromSpec,t),t.isValid=!0;else{var s=new SwaggerSpecConverter;s.setDocumentationLocation(t.url),s.convert(e.obj,function(e){(new Resolver).resolve(e,t.buildFromSpec,t),t.isValid=!0})}}}};if(this.spec)setTimeout(function(){(new Resolver).resolve(t.spec,t.buildFromSpec,t)},10);else{if(this.clientAuthorizations.apply(i),e)return i;(new SwaggerHttp).execute(i)}return this},SwaggerClient.prototype.buildFromSpec=function(e){if(this.isBuilt)return this;this.apis={},this.apisArray=[],this.basePath=e.basePath||"",this.consumes=e.consumes,this.host=e.host||"",this.info=e.info||{},this.produces=e.produces,this.schemes=e.schemes||[],this.securityDefinitions=e.securityDefinitions,this.title=e.title||"",e.externalDocs&&(this.externalDocs=e.externalDocs),this.authSchemes=e.securityDefinitions;var t,i={};if(Array.isArray(e.tags))for(i={},t=0;t<e.tags.length;t++){var s=e.tags[t];i[s.name]=s}var r;"string"==typeof this.url&&(r=this.parseUri(this.url)),this.scheme="undefined"==typeof this.schemes||0===this.schemes.length?r.scheme||"http":this.schemes[0],("undefined"==typeof this.host||""===this.host)&&(this.host=r.host,r.port&&(this.host=this.host+":"+r.port)),this.definitions=e.definitions;var o;for(o in this.definitions){var a=new Model(o,this.definitions[o],this.models);a&&(this.models[o]=a)}var n=this;return n.apis.help=_.bind(n.help,n),_.forEach(e.paths,function(e,t){_.isPlainObject(e)&&_.forEach(supportedOperationMethods,function(s){var r=e[s];if(!_.isUndefined(r)){if(!_.isPlainObject(r))return void helpers.log("The '"+s+"' operation for '"+t+"' path is not an Operation Object");var o=r.tags;(_.isUndefined(o)||!_.isArray(o)||0===o.length)&&(o=r.tags=["default"]);var a=n.idFromOp(t,s,r),l=new Operation(n,r.scheme,a,s,t,r,n.definitions,n.models,n.clientAuthorizations);_.forEach(o,function(e){var t=_.indexOf(reservedClientTags,e)>-1?"_"+e:e,s=_.indexOf(reservedApiTags,e)>-1?"_"+e:e,r=n[t];if(t!==e&&helpers.log("The '"+e+"' tag conflicts with a SwaggerClient function/property name.  Use 'client."+t+"' or 'client.apis."+e+"' instead of 'client."+e+"'."),s!==e&&helpers.log("The '"+e+"' tag conflicts with a SwaggerClient operation function/property name.  Use 'client.apis."+s+"' instead of 'client.apis."+e+"'."),_.indexOf(reservedApiTags,a)>-1&&(helpers.log("The '"+a+"' operationId conflicts with a SwaggerClient operation function/property name.  Use 'client.apis."+s+"._"+a+"' instead of 'client.apis."+s+"."+a+"'."),a="_"+a,l.nickname=a),_.isUndefined(r)){r=n[t]=n.apis[s]={},r.operations={},r.label=s,r.apis={};var o=i[e];_.isUndefined(o)||(r.description=o.description,r.externalDocs=o.externalDocs),n[t].help=_.bind(n.help,r),n.apisArray.push(new OperationGroup(e,r.description,r.externalDocs,l))}_.isFunction(r.help)||(r.help=_.bind(n.help,r)),n.apis[s][a]=r[a]=_.bind(l.execute,l),n.apis[s][a].help=r[a].help=_.bind(l.help,l),n.apis[s][a].asCurl=r[a].asCurl=_.bind(l.asCurl,l),r.apis[a]=r.operations[a]=l;var u=_.find(n.apisArray,function(t){return t.tag===e});u&&u.operationsArray.push(l)})}})}),this.isBuilt=!0,this.success&&(this.isValid=!0,this.isBuilt=!0,this.success()),this},SwaggerClient.prototype.parseUri=function(e){var t=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,i=t.exec(e);return{scheme:i[4].replace(":",""),host:i[11],port:i[12],path:i[15]}},SwaggerClient.prototype.help=function(e){var t="";return this instanceof SwaggerClient?_.forEach(this.apis,function(e,i){_.isPlainObject(e)&&(t+="operations for the '"+i+"' tag\n",_.forEach(e.operations,function(e,i){t+="  * "+i+": "+e.summary+"\n"}))}):(this instanceof OperationGroup||_.isPlainObject(this))&&(t+="operations for the '"+this.label+"' tag\n",_.forEach(this.apis,function(e,i){t+="  * "+i+": "+e.summary+"\n"})),e?t:(helpers.log(t),t)},SwaggerClient.prototype.tagFromLabel=function(e){return e},SwaggerClient.prototype.idFromOp=function(e,t,i){var s=i.operationId.replace(/[\s!@#$%^&*()_+=\[{\]};:<>|.\/?,\\'""-]/g,"_")||e.substring(1)+"_"+t;return s=s.replace(/((_){2,})/g,"_"),s=s.replace(/^(_)*/g,""),s=s.replace(/([_])*$/g,"")},SwaggerClient.prototype.fail=function(e){throw this.failure(e),e};


},{"./auth":2,"./helpers":5,"./http":6,"./resolver":7,"./spec-converter":8,"./types/model":10,"./types/operation":11,"./types/operationGroup":12,"lodash-compat/array/indexOf":22,"lodash-compat/collection/find":23,"lodash-compat/collection/forEach":24,"lodash-compat/function/bind":26,"lodash-compat/lang/cloneDeep":82,"lodash-compat/lang/isArray":84,"lodash-compat/lang/isFunction":85,"lodash-compat/lang/isPlainObject":88,"lodash-compat/lang/isUndefined":91}],5:[function(require,module,exports){
(function (process){
...
"use strict";var helpers=require("./helpers"),jQuery=require("jquery"),request=require("superagent"),JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){return this.useJQuery=e&&"boolean"==typeof e.useJQuery?e.useJQuery:this.isIE8(),e&&"object"==typeof e.body&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),this.useJQuery?new JQueryHttpClient(t).execute(e):new SuperagentHttpClient(t).execute(e)},SwaggerHttp.prototype.isIE8=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=e.on,r=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var s={},o=e.getAllResponseHeaders().split("\n"),n=0;n<o.length;n++){var u=o[n].trim();if(0!==u.length){var a=u.indexOf(":");if(-1!==a){var i=u.substring(0,a).trim(),p=u.substring(a+1).trim();s[i]=p}else s[u]=null}}var d={url:r.url,method:r.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:s},y=s["content-type"]||s["Content-Type"]||null;if(y&&(0===y.indexOf("application/json")||y.indexOf("+json")>0))try{d.obj=e.responseJSON||JSON.parse(d.data)||{}}catch(l){helpers.log("unable to parse JSON content")}if(e.status>=200&&e.status<300)t.response(d);else{if(!(0===e.status||e.status>=400&&e.status<599))return t.response(d);t.error(d)}},jQuery.support.cors=!0,jQuery.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},o=request[t](e.url);for(r in s)o.set(r,s[r]);e.body&&o.send(e.body),o.end(function(t,r){var o,n={url:e.url,method:e.method,headers:s};!t&&r.error&&(t=r.error),t&&e.on&&e.on.error?(n.obj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,o=e.on.error):r&&e.on&&e.on.response&&(n.obj="undefined"!=typeof r.body?r.body:r.text,n.status=r.status,n.statusText=r.text,o=e.on.response),n.data=n.statusText,o&&o(n)})};


},{"./helpers":5,"jquery":20,"superagent":99}],7:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,r,i){this.scope=i||this;var o,s,n,t,a,l=0,f={},v={},p={};for(s in e.definitions){var h=e.definitions[s];for(a in h.properties)t=h.properties[a],this.resolveTo(t,p)}for(s in e.paths){var u,c,d;n=e.paths[s];for(u in n){c=n[u];var y,g=c.parameters;for(y in g){var b=g[y];"body"===b["in"]&&b.schema&&this.resolveTo(b.schema,p),b.$ref&&this.resolveInline(e,b,p,v)}for(d in c.responses){var j=c.responses[d];j.schema&&this.resolveTo(j.schema,p)}}}var A={},m=0;for(s in p){var $=s.split("#");2===$.length&&(o=$[0],n=$[1],Array.isArray(A[o])||(A[o]=[],m+=1),A[o].push(n))}for(s in A){var R=this,T=A[s];o=s;var x={useJQuery:!1,url:o,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){l+=1;var i;for(i=0;i<T.length;i++){var s=o+"#"+T[i];v[s]=null}l===m&&R.finish(e,p,f,v,r)},response:function(i){var s,n,t=i.obj;for(l+=1,s=0;s<T.length;s++){var a=t,h=T[s],u=h.split("/");for(n=0;n<u.length;n++){var c=u[n];if("undefined"==typeof a)break;c.length>0&&(a=a[c])}var d=o+"#"+h,y=u[n-1];"undefined"!=typeof a?f[d]={name:y,obj:a}:v[d]=null}l===m&&R.finish(e,p,f,v,r)}}};i&&i.clientAuthorizations&&i.clientAuthorizations.apply(x),(new SwaggerHttp).execute(x)}0===Object.keys(A).length&&r.call(this.scope,e,v)},Resolver.prototype.finish=function(e,r,i,o,s){var n;for(n in r){var t,a=r[n];for(t=0;t<a.length;t++){var l=i[a[t].obj.$ref];if(l)if(e.definitions||(e.definitions={}),"$ref"===a[t].resolveAs)e.definitions[l.name]=l.obj,a[t].obj.$ref="#/definitions/"+l.name;else if("inline"===a[t].resolveAs){var f,v=a[t].obj;delete v.$ref;for(f in l.obj)v[f]=l.obj[f]}}}s.call(this.scope,e,o)},Resolver.prototype.resolveInline=function(e,r,i,o){var s=r.$ref;if(s){if(0===s.indexOf("http"))Array.isArray(i[s])?i[s].push({obj:r,resolveAs:"inline"}):i[s]=[{obj:r,resolveAs:"inline"}];else if(0===s.indexOf("#")){var n,t=s.substring(1),a=t.split("/"),l=e;for(n=0;n<a.length;n++){var f=a[n];f.length>0&&(l=l[f])}if(l){delete r.$ref;var v;for(v in l)r[v]=l[v]}else o[s]=null}}else"array"===r.type&&this.resolveTo(r.items,i)},Resolver.prototype.resolveTo=function(e,r){var i=e.$ref;if(i)0===i.indexOf("http")&&(Array.isArray(r[i])?r[i].push({obj:e,resolveAs:"$ref"}):r[i]=[{obj:e,resolveAs:"$ref"}]);else if("array"===e.type){var o=e.items;this.resolveTo(o,r)}};


},{"./http":6}],8:[function(require,module,exports){
"use strict";var SwaggerClient=require("./client"),SwaggerHttp=require("./http"),SwaggerSpecConverter=module.exports=function(){this.errors=[],this.warnings=[],this.modelMap={}};SwaggerSpecConverter.prototype.setDocumentationLocation=function(e){this.docLocation=e},SwaggerSpecConverter.prototype.convert=function(e,t){if(!e||!Array.isArray(e.apis))return this.finish(t,null);var r={swagger:"2.0"};this.apiInfo(e,r),this.securityDefinitions(e,r);var i,o=!1;for(i=0;i<e.apis.length;i++){var s=e.apis[i];Array.isArray(s.operations)&&(o=!0)}o?(this.declaration(e,r),this.finish(t,r)):this.resourceListing(e,r,t)},SwaggerSpecConverter.prototype.declaration=function(e,t){var r,i;if(e.apis){{e.basePath}if(0===e.basePath.indexOf("http://")){var o=e.basePath.substring("http://".length),s=o.indexOf("/");s>0?(t.host=o.substring(0,s),t.basePath=o.substring(s)):(t.host=o,t.basePath="/")}e.consumes&&(t.consumes=e.consumes),e.produces&&(t.produces=e.produces);for(r in e.models){var n=e.models[r],a=n.id||r;this.modelMap[a]=r}for(i=0;i<e.apis.length;i++){var p=e.apis[i],u=p.path,c=p.operations;this.operations(u,e.resourcePath,c,t)}var f=e.models;this.models(f,t)}},SwaggerSpecConverter.prototype.models=function(e,t){if("object"==typeof e){var r;t.definitions=t.definitions||{};for(r in e){var i,o=e[r],s=[],n={properties:{}};for(i in o.properties){var a=o.properties[i],p={};this.dataType(a,p),a.description&&(p.description=a.description),a["enum"]&&(p["enum"]=a["enum"]),"boolean"==typeof a.required&&a.required===!0&&s.push(i),"string"==typeof a.required&&"true"===a.required&&s.push(i),n.properties[i]=p}s.length>0&&(n["enum"]=s),t.definitions[r]=n}}},SwaggerSpecConverter.prototype.operations=function(e,t,r,i){if(Array.isArray(r)){var o;i.paths||(i.paths={});var s=i.paths[e]||{},n=(t||"default").replace("/","");for(o=0;o<r.length;o++){var a=r[o],p=(a.method||a.httpMethod).toLowerCase(),u={tags:[n]};a.consumes?u.consumes=a.consumes:i.consumes&&(u.consumes=i.consumes),a.produces?u.produces=a.produces:i.produces&&(u.produces=i.produces),a.summary&&(u.summary=a.summary),a.notes&&(u.description=a.notes),a.nickname&&(u.operationId=a.nickname),a.deprecated&&(u.deprecated=a.deprecated),this.authorizations(a.authorizations,i),this.parameters(u,a.parameters,i),this.responseMessages(u,a,i),s[p]=u}i.paths[e]=s}},SwaggerSpecConverter.prototype.responseMessages=function(e,t){if("object"==typeof t){var r={};this.dataType(t,r),r.schema||(r={schema:r}),e.responses=e.responses||{};var i=!1;if(Array.isArray(t.responseMessages)){var o,s=t.responseMessages;for(o=0;o<s.length;o++){var n=s[o],a={description:n.message};200===n.code&&(i=!0),e.responses[""+n.code]=a}}i?e.responses["default"]=r:e.responses[200]=r}},SwaggerSpecConverter.prototype.authorizations=function(e){},SwaggerSpecConverter.prototype.parameters=function(e,t){if(Array.isArray(t)){var r;for(r=0;r<t.length;r++){var i=t[r],o={};if(o.name=i.name,o.description=i.description,o.required=i.required,o["in"]=i.paramType,"body"===o["in"]&&(o.name="body"),"form"===o["in"]&&(o["in"]="formData"),i.allowMultiple===!0||"true"===i.allowMultiple){var s={};if(this.dataType(i,s),o.type="array",o.items=s,i.allowableValues){var n=i.allowableValues;"LIST"===n.valueType&&(o["enum"]=n.values)}}else this.dataType(i,o);e.parameters=e.parameters||[],e.parameters.push(o)}}},SwaggerSpecConverter.prototype.dataType=function(e,t){if("object"==typeof e){e.minimum&&(t.minimum=e.minimum),e.maximum&&(t.maximum=e.maximum),e.defaultValue&&(t["default"]=e.defaultValue);var r=this.toJsonSchema(e);r&&(t=t||{},r.type&&(t.type=r.type),r.format&&(t.format=r.format),r.$ref&&(t.schema={$ref:r.$ref}),r.items&&(t.items=r.items))}},SwaggerSpecConverter.prototype.toJsonSchema=function(e){if(!e)return"object";var t=e.type||e.dataType||e.responseClass||"",r=t.toLowerCase(),i=(e.format||"").toLowerCase();if(0===r.indexOf("list[")){var o=t.substring(5,t.length-1),s=this.toJsonSchema({type:o});return{type:"array",items:s}}if("int"===r||"integer"===r&&"int32"===i)return{type:"integer",format:"int32"};if("long"===r||"integer"===r&&"int64"===i)return{type:"integer",format:"int64"};if("integer"===r)return{type:"integer",format:"int64"};if("float"===r||"number"===r&&"float"===i)return{type:"number",format:"float"};if("double"===r||"number"===r&&"double"===i)return{type:"number",format:"double"};if("string"===r&&"date-time"===i||"date"===r)return{type:"string",format:"date-time"};if("string"===r)return{type:"string"};if("file"===r)return{type:"file"};if("boolean"===r)return{type:"boolean"};if("array"===r||"list"===r){if(e.items){var n=this.toJsonSchema(e.items);return{type:"array",items:n}}return{type:"array",items:{type:"object"}}}return e.$ref?{$ref:"#/definitions/"+this.modelMap[e.$ref]||e.$ref}:{$ref:"#/definitions/"+this.modelMap[e.type]||e.type}},SwaggerSpecConverter.prototype.resourceListing=function(e,t,r){var i,o=0,s=this,n=e.apis.length;for(0===n&&this.finish(r,t),i=0;n>i;i++){var a=e.apis[i],p=a.path,u=this.getAbsolutePath(this.docLocation,p),c={url:u,headers:{accept:"application/json"},on:{},method:"get"};c.on.response=function(e){o+=1,e.obj&&s.declaration(e.obj,t),o===n&&s.finish(r,t)},c.on.error=function(e){console.error(e),o+=1,o===n&&s.finish(r,t)},(new SwaggerHttp).execute(c)}},SwaggerSpecConverter.prototype.getAbsolutePath=function(e,t){return 0===t.indexOf("http://")||0===t.indexOf("https://")?t:e+"/"+t},SwaggerSpecConverter.prototype.securityDefinitions=function(e,t){if(e.authorizations){var r;for(r in e.authorizations){var i=!1,o={},s=e.authorizations[r];if("apiKey"===s.type)o.type="apiKey",o["in"]=s.passAs,o.name=s.keyname||r,i=!0;else if("oauth2"===s.type){var n,a=s.scopes||[],p={};for(n in a){var u=a[n];p[u.scope]=u.description}if(o.type="oauth2",n>0&&(o.scopes=p),s.grantTypes){if(s.grantTypes.implicit){var c=s.grantTypes.implicit;o.flow="implicit",o.authorizationUrl=c.loginEndpoint,i=!0}if(s.grantTypes.authorization_code&&!o.flow){var f=s.grantTypes.authorization_code;o.flow="accessCode",o.authorizationUrl=f.tokenRequestEndpoint.url,o.tokenUrl=f.tokenEndpoint.url,i=!0}}}i&&(t.securityDefinitions=t.securityDefinitions||{},t.securityDefinitions[r]=o)}}},SwaggerSpecConverter.prototype.apiInfo=function(e,t){if(e.info){var r=e.info;t.info={},r.description&&(t.info.description=r.description),r.title&&(t.info.title=r.title),r.termsOfServiceUrl&&(t.info.termsOfService=r.termsOfServiceUrl),(r.license||r.licenseUrl)&&(t.license={},r.license&&(t.license.name=r.license),r.licenseUrl&&(t.license.url=r.licenseUrl))}else this.warnings.push("missing info section")},SwaggerSpecConverter.prototype.finish=function(e,t){e(t)};


},{"./client":4,"./http":6}],9:[function(require,module,exports){
"use strict";var helpers=require("../helpers"),ArrayModel=module.exports=function(e,t){this.models=t,this.name="arrayModel",this.definition=e||{},this.properties=[];var r=e.items;return r&&(r.type?this.type=helpers.typeFromJsonSchema(r.type,r.format):this.ref=r.$ref),this};ArrayModel.prototype.createJSONSample=function(e){var t;if(e=e||{},this.type)t=this.type;else if(this.ref){var r=helpers.simpleRef(this.ref);if("undefined"!=typeof e[r])return r;e[r]=this,t=this.models[r].createJSONSample(e)}return[t]},ArrayModel.prototype.getSampleValue=function(e){var t;if(e=e||{},this.type)t=this.type;else if(this.ref){var r=helpers.simpleRef(this.ref);t=this.models[r].getSampleValue(e)}return[t]},ArrayModel.prototype.getMockSignature=function(e){var t,r,i=[];for(t=0;t<this.properties.length;t++)r=this.properties[t],i.push(r.toString());var s='<span class="strong">',p="</span>",o=s+"array {"+p,a=s+"}"+p,h=o+"<div>"+i.join(",</div><div>")+"</div>"+a;for(e||(e={}),e[this.name]=this,t=0;t<this.properties.length;t++){r=this.properties[t];var n=r.$ref,l=this.models[n];l&&"undefined"==typeof e[n]&&(h+="<br>"+l.getMockSignature(e))}return h};


},{"../helpers":5}],10:[function(require,module,exports){
"use strict";var _={isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined")},ArrayModel=require("./arrayModel"),helpers=require("../helpers"),applyParameterMacro=function(e,t){return e.api&&e.api.parameterMacro?e.api.parameterMacro(e,t):t.defaultValue},applyModelPropertyMacro=function(e,t){return e.api&&e.api.modelPropertyMacro?e.api.modelPropertyMacro(e,t):t["default"]},Property=module.exports=function(e,t,i,s){this.models=s,this.schema=t,this.required=i,t.$ref?this.$ref=helpers.simpleRef(t.$ref):"array"===t.type&&t.items&&(t.items.$ref?this.$ref=helpers.simpleRef(t.items.$ref):t=t.items),this.name=e,this.description=t.description,this.obj=t,this.optional=!0,this.optional=!i,this["default"]=t["default"]||null,this.example=void 0!==t.example?t.example:null,this.collectionFormat=t.collectionFormat||null,this.maximum=t.maximum||null,this.exclusiveMaximum=t.exclusiveMaximum||null,this.minimum=t.minimum||null,this.exclusiveMinimum=t.exclusiveMinimum||null,this.maxLength=t.maxLength||null,this.minLength=t.minLength||null,this.pattern=t.pattern||null,this.maxItems=t.maxItems||null,this.minItems=t.minItems||null,this.uniqueItems=t.uniqueItems||null,this["enum"]=t["enum"]||null,this.multipleOf=t.multipleOf||null},Model=module.exports=function(e,t,i){if(this.models=i||{},this.name=e,this.definition=t||{},this.properties=[],"array"===t.type)return new ArrayModel(t,i);var s,r=t.required||[],n=t.properties;if(n)for(s in n){var a=!1,p=n[s];r.indexOf(s)>=0&&(a=!0),this.properties.push(new Property(s,p,a,this.models))}return this};Model.prototype.createJSONSample=function(e){var t,i={},s={},r=this.examples&&this.examples["application/json"]?this.examples["application/json"]:void 0;if(_.isUndefined(r)||(_.isPlainObject(r)?i=r:_.isString(r)?i=JSON.parse(this.examples["application/json"]):r=void 0),_.isUndefined(r)){for(e=e||{},e[this.name]=this,t=0;t<this.properties.length;t++){var n=this.properties[t],a=n.getSampleValue(e,s);i[n.name]=a}delete e[this.name]}return i},Model.prototype.getSampleValue=function(e){var t,i={},s={};for(t=0;t<this.properties.length;t++){var r=this.properties[t];i[r.name]=r.sampleValue(!1,e,s)}return i},Model.prototype.getMockSignature=function(e){var t,i,s=[];for(t=0;t<this.properties.length;t++)i=this.properties[t],s.push(i.toString());var r='<span class="strong">',n="</span>",a=r+this.name+" {"+n,p=r+"}"+n,l=a+"<div>"+s.join(",</div><div>")+"</div>"+p;for(e||(e={}),e[this.name]=this,t=0;t<this.properties.length;t++){i=this.properties[t];var o=i.$ref,h=this.models[o];h&&"undefined"==typeof e[h.name]&&(l+="<br>"+h.getMockSignature(e))}return l},Property.prototype.getSampleValue=function(e,t){return this.sampleValue(!1,e,t)},Property.prototype.isArray=function(){var e=this.schema;return"array"===e.type?!0:!1},Property.prototype.sampleValue=function(e,t,i){e=e||this.isArray(),t=t||{};var s,r=this,n=function(e){var s,n=helpers.simpleRef(e),p=r.models[n];return"undefined"!=typeof i[a]&&(s=i[a]),p&&"undefined"==typeof t[a]?(t[a]=this,s=p.getSampleValue(t,i),i[a]=s):s=i[a]||n,s},a=helpers.getStringSignature(this.obj,!0);return s=this.$ref?n(this.$ref):this.example?this.example:this["default"]?this["default"]:"date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string"===a?"string":"integer"===a?0:"long"===a?0:"float"===a?0:"double"===a?0:"boolean"===a?!0:this.schema.$ref?n(this.schema.$ref):this.schema.properties?new Model("InlineModel-"+new Date,this.schema,this.models).getSampleValue():{},t[a]=s,e?[s]:s},Property.prototype.toString=function(){var e,t=helpers.getStringSignature(this.obj),i='<span class="strong">',s="</span>",r=[];if("object"===t){for(var n in this.schema.properties)this.schema.properties.hasOwnProperty(n)&&(e=new Property(n,this.schema.properties[n],(this.schema.required||[]).indexOf(n)>-1,this.models),r.push(e.toString()));t=i+this.name+" {"+s+"<div>"+r.join(",</div><div>")+"</div>"+i+"}"+s}else""!==t?(t='<span class="propName '+this.required+'">'+this.name+'</span> (<span class="propType">'+t+"</span>",this.required||(t+=', <span class="propOptKey">optional</span>'),t+=")"):t=this.name+" ("+JSON.stringify(this.obj)+")";"undefined"!=typeof this.description&&(t+=": "+this.description),this["enum"]&&(t+=' = <span class="propVals">[\''+this["enum"].join("' or '")+"']</span>"),this.descr&&(t+=': <span class="propDesc">'+this.descr+"</span>");var a,p="",l="array"===this.schema.type;switch(a=l?this.schema.items?this.schema.items.type:"":this.schema.type,this["default"]&&(p+=helpers.optionHtml("Default",this["default"])),a){case"string":this.minLength&&(p+=helpers.optionHtml("Min. Length",this.minLength)),this.maxLength&&(p+=helpers.optionHtml("Max. Length",this.maxLength)),this.pattern&&(p+=helpers.optionHtml("Reg. Exp.",this.pattern));break;case"integer":case"number":this.minimum&&(p+=helpers.optionHtml("Min. Value",this.minimum)),this.exclusiveMinimum&&(p+=helpers.optionHtml("Exclusive Min.","true")),this.maximum&&(p+=helpers.optionHtml("Max. Value",this.maximum)),this.exclusiveMaximum&&(p+=helpers.optionHtml("Exclusive Max.","true")),this.multipleOf&&(p+=helpers.optionHtml("Multiple Of",this.multipleOf))}if(l&&(this.minItems&&(p+=helpers.optionHtml("Min. Items",this.minItems)),this.maxItems&&(p+=helpers.optionHtml("Max. Items",this.maxItems)),this.uniqueItems&&(p+=helpers.optionHtml("Unique Items","true")),this.collectionFormat&&(p+=helpers.optionHtml("Coll. Format",this.collectionFormat))),this["enum"]){var o;o="number"===a||"integer"===a?this["enum"].join(", "):'"'+this["enum"].join('", "')+'"',p+=helpers.optionHtml("Enum",o)}return p.length>0&&(t='<span class="propWrap">'+t+'<table class="optionsWrapper"><tr><th colspan="2">'+this.name+"</th></tr>"+p+"</table></span>"),t};


},{"../helpers":5,"./arrayModel":9,"lodash-compat/lang/isPlainObject":88,"lodash-compat/lang/isString":89,"lodash-compat/lang/isUndefined":91}],11:[function(require,module,exports){
"use strict";var ArrayModel=require("./arrayModel"),helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Operation=module.exports=function(e,t,r,s,n,i,a,o,p){var u=[];if(e=e||{},i=i||{},this.authorizations=i.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=i.consumes,this.deprecated=i.deprecated,this.description=i.description,this.host=e.host||"localhost",this.method=s||u.push("Operation "+r+" is missing method."),this.models=o||{},this.nickname=r||u.push("Operations must have a nickname."),this.operation=i,this.operations={},this.parameters=null!==i?i.parameters||[]:{},this.parent=e,this.path=n||u.push("Operation "+this.nickname+" is missing path."),this.produces=i.produces,this.responses=i.responses||{},this.scheme=t||e.scheme||"http",this.schemes=e.schemes,this.security=i.security,this.summary=i.summary||"",this.type=null,this.useJQuery=e.useJQuery,"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var h,l;if(a){var d;for(d in this.definitions)l=new Model(d,a[d],this.models),l&&(this.models[d]=l)}for(h=0;h<this.parameters.length;h++){var c=this.parameters[h];"array"===c.type&&(c.isList=!0,c.allowMultiple=!0);var m=this.getType(c);if(m&&"boolean"===m.toString().toLowerCase()&&(c.allowableValues={},c.isList=!0,c["enum"]=["true","false"]),"undefined"!=typeof c["enum"]){var f;for(c.allowableValues={},c.allowableValues.values=[],c.allowableValues.descriptiveValues=[],f=0;f<c["enum"].length;f++){var y=c["enum"][f],g=y===c["default"]?!0:!1;c.allowableValues.values.push(y),c.allowableValues.descriptiveValues.push({value:y,isDefault:g})}}"array"===c.type&&(m=[m],"undefined"==typeof c.allowableValues&&(delete c.isList,delete c.allowMultiple)),c.signature=this.getModelSignature(m,this.models).toString(),c.sampleJSON=this.getModelSampleJSON(m,this.models),c.responseClassSignature=c.signature}var v,b,O=this.responses;if(O[200]?(b=O[200],v="200"):O[201]?(b=O[201],v="201"):O[202]?(b=O[202],v="202"):O[203]?(b=O[203],v="203"):O[204]?(b=O[204],v="204"):O[205]?(b=O[205],v="205"):O[206]?(b=O[206],v="206"):O["default"]&&(b=O["default"],v="default"),b&&b.schema){var w,C=this.resolveModel(b.schema,a);delete O[v],C?(this.successResponse={},w=this.successResponse[v]=C):b.schema.type&&"object"!==b.schema.type?(this.successResponse={},w=this.successResponse[v]=b.schema):(this.successResponse={},w=this.successResponse[v]=new Model("Inline Response ("+this.method+":"+this.path+")",b.schema||{},this.models)),w&&(b.description&&(w.description=b.description),b.examples&&(w.examples=b.examples),b.headers&&(w.headers=b.headers)),this.type=b}return u.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(u),this};Operation.prototype.getType=function(e){var t,r=e.type,s=e.format,n=!1;"integer"===r&&"int32"===s?t="integer":"integer"===r&&"int64"===s?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===s?"date-time":"date"===s?"date":"string":"number"===r&&"float"===s?t="float":"number"===r&&"double"===s?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r&&(n=!0,e.items&&(t=this.getType(e.items))),e.$ref&&(t=e.$ref);var i=e.schema;if(i){var a=i.$ref;return a?(a=helpers.simpleRef(a),n?[a]:a):this.getType(i)}return n?[t]:t},Operation.prototype.resolveModel=function(e,t){if("undefined"!=typeof e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models)}return"array"===e.type?new ArrayModel(e,this.models):null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var s=this.parameters[r],n=s.signature;t+="\n  * "+s.name+" ("+n+"): "+s.description}return"undefined"==typeof e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,s;return e instanceof Array?(s=!0,e=e[0]):"undefined"==typeof e&&(e="undefined"),r="string"===e?!0:s&&t[s]||t[e]?!1:!0,r?s?"Array["+e+"]":e.toString():s?"Array["+t[e].getMockSignature()+"]":t[e].getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r=0;r<this.parameters.length;r++){var s=this.parameters[r];if("undefined"!=typeof e[s.name]&&"header"===s["in"]){var n=e[s.name];Array.isArray(n)&&(n=n.toString()),t[s.name]=n}}return t},Operation.prototype.urlify=function(e){for(var t={},r=this.path,s="",n=0;n<this.parameters.length;n++){var i=this.parameters[n];if("undefined"!=typeof e[i.name])if("path"===i["in"]){var a=new RegExp("{"+i.name+"}","gi"),o=e[i.name];o=Array.isArray(o)?this.encodePathCollection(i.collectionFormat,i.name,o):this.encodePathParam(o),r=r.replace(a,o)}else if("query"===i["in"]&&"undefined"!=typeof e[i.name])if(s+=""===s?"?":"&","undefined"!=typeof i.collectionFormat){var p=e[i.name];s+=Array.isArray(p)?this.encodeQueryCollection(i.collectionFormat,i.name,p):this.encodeQueryParam(i.name)+"="+this.encodeQueryParam(e[i.name])}else s+=this.encodeQueryParam(i.name)+"="+this.encodeQueryParam(e[i.name]);else"formData"===i["in"]&&(t[i.name]=e[i.name])}var u=this.scheme+"://"+this.host;return"/"!==this.basePath&&(u+=this.basePath),u+r+s},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var s=this.parameters[t];s.required===!0&&"undefined"==typeof e[s.name]&&(r=s.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var s,n,i,a={},o=0;o<this.parameters.length;o++){var p=this.parameters[o];"undefined"!=typeof t[p.name]&&("body"===p["in"]?s=t[p.name]:"formData"===p["in"]&&(a[p.name]=t[p.name]))}if("application/x-www-form-urlencoded"===e["Content-Type"]){var u="";for(n in a)i=a[n],"undefined"!=typeof i&&(""!==u&&(u+="&"),u+=encodeURIComponent(n)+"="+encodeURIComponent(i));s=u}else if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&r.useJQuery){var h=new FormData;h.type="formData";for(n in a)i=t[n],"undefined"!=typeof i&&("file"===i.type&&i.value?(delete e["Content-Type"],h.append(n,i.value)):h.append(n,i));s=h}return s},Operation.prototype.getModelSampleJSON=function(e,t){var r,s,n;if(s=e instanceof Array,r=t[e]?!1:!0,n=r?void 0:t[e].createJSONSample()){if(n=s?[n]:n,"string"==typeof n)return n;if("object"==typeof n){var i=n;if(n instanceof Array&&n.length>0&&(i=n[0]),i.nodeName){var a=(new XMLSerializer).serializeToString(i);return this.formatXml(a)}return JSON.stringify(n,null,2)}return n}},Operation.prototype["do"]=function(e,t,r,s,n){return this.execute(e,t,r,s,n)},Operation.prototype.execute=function(e,t,r,s,n){var i,a,o=e||{},p={};"object"==typeof t&&(p=t,i=r,a=s),"function"==typeof t&&(i=t,a=r),i=i||helpers.log,a=a||helpers.log,p.useJQuery&&(this.useJQuery=p.useJQuery);var u=this.getMissingParams(o);if(u.length>0){var h="missing required params: "+u;return void helpers.fail(h)}var l,d=this.getHeaderParams(o),c=this.setContentTypes(o,p),m={};for(l in d)m[l]=d[l];for(l in c)m[l]=c[l];var f=this.getBody(m,o,p),y=this.urlify(o),g={url:y,method:this.method.toUpperCase(),body:f,useJQuery:this.useJQuery,headers:m,on:{response:function(e){return i(e,n)},error:function(e){return a(e,n)}}};return this.clientAuthorizations.apply(g,this.operation.security),p.mock===!0?g:void(new SwaggerHttp).execute(g,p)},Operation.prototype.setContentTypes=function(e,t){var r,s,n="application/json",i=this.parameters,a=e.parameterContentType||"application/json",o=[],p=[],u={};for(s=0;s<i.length;s++){var h=i[s];if("formData"===h["in"])"file"===h.type?o.push(h):p.push(h);else if("header"===h["in"]&&t){var l=h.name,d=t[h.name];"undefined"!=typeof t[h.name]&&(u[l]=d)}else"body"===h["in"]&&"undefined"!=typeof e[h.name]&&(r=e[h.name])}return!r||"post"!==this.method&&"put"!==this.method&&"patch"!==this.method&&"delete"!==this.method?p.length>0?a=t.requestContentType?t.requestContentType:o.length>0?"multipart/form-data":"application/x-www-form-urlencoded":"DELETE"===this.type?r="{}":"DELETE"!==this.type&&(a=null):t.requestContentType&&(a=t.requestContentType),a&&this.consumes&&-1===this.consumes.indexOf(a)&&helpers.log("server doesn't consume "+a+", try "+JSON.stringify(this.consumes)),n=t.responseContentType?t.responseContentType:"application/json",n&&this.produces&&-1===this.produces.indexOf(n)&&helpers.log("server can't produce "+n),(a&&""!==r||"application/x-www-form-urlencoded"===a)&&(u["Content-Type"]=a),n&&(u.Accept=n),u},Operation.prototype.asCurl=function(e){var t=this.execute(e,{mock:!0});this.clientAuthorizations.apply(t);var r=[];if(r.push("-X "+this.method.toUpperCase()),t.headers){var s;for(s in t.headers)r.push('--header "'+s+": "+t.headers[s]+'"')}if(t.body){var n;n="object"==typeof t.body?JSON.stringify(t.body):t.body,r.push('-d "'+n.replace(/"/g,'\\"')+'"')}return"curl "+r.join(" ")+' "'+t.url+'"'},Operation.prototype.encodePathCollection=function(e,t,r){var s,n="",i="";for(i="ssv"===e?"%20":"tsv"===e?"\\t":"pipes"===e?"|":",",s=0;s<r.length;s++)0===s?n=this.encodeQueryParam(r[s]):n+=i+this.encodeQueryParam(r[s]);return n},Operation.prototype.encodeQueryCollection=function(e,t,r){var s,n="";if("default"===e||"multi"===e)for(s=0;s<r.length;s++)s>0&&(n+="&"),n+=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[s]);else{var i="";if("csv"===e)i=",";else if("ssv"===e)i="%20";else if("tsv"===e)i="\\t";else if("pipes"===e)i="|";else if("brackets"===e)for(s=0;s<r.length;s++)0!==s&&(n+="&"),n+=this.encodeQueryParam(t)+"[]="+this.encodeQueryParam(r[s]);if(""!==i)for(s=0;s<r.length;s++)0===s?n=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[s]):n+=i+this.encodeQueryParam(r[s])}return n},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)},Operation.prototype.encodePathParam=function(e){var t,r,s,n;if(e=e.toString(),-1===e.indexOf("/"))return encodeURIComponent(e);for(r=e.split("/"),t=[],s=0,n=r.length;n>s;s++)t.push(encodeURIComponent(r[s]));return t.join("/")};


},{"../helpers":5,"../http":6,"./arrayModel":9,"./model":10}],12:[function(require,module,exports){
...
function findIndex(e,a,n){var r=-1,l=e?e.length:0;for(a=baseCallback(a,n,3);++r<l;)if(a(e[r],r,e))return r;return-1}var baseCallback=require("../internal/baseCallback");module.exports=findIndex;


},{"../internal/baseCallback":29}],22:[function(require,module,exports){
...
},{"../internal/baseIndexOf":38,"../internal/binaryIndex":49}],23:[function(require,module,exports){
function find(a,e,r){if(isArray(a)){var i=findIndex(a,e,r);return i>-1?a[i]:void 0}return e=baseCallback(e,r,3),baseFind(a,e,baseEach)}var baseCallback=require("../internal/baseCallback"),baseEach=require("../internal/baseEach"),baseFind=require("../internal/baseFind"),findIndex=require("../array/findIndex"),isArray=require("../lang/isArray");module.exports=find;


},{"../array/findIndex":21,"../internal/baseCallback":29,"../internal/baseEach":33,"../internal/baseFind":34,"../lang/isArray":84}],24:[function(require,module,exports){
...
},{"../internal/arrayEach":28,"../internal/baseEach":33,"../internal/bindCallback":51,"../lang/isArray":84}],25:[function(require,module,exports){
...
},{"../lang/isNative":86}],26:[function(require,module,exports){
function bind(e,r){var a=BIND_FLAG;if(arguments.length>2){var l=baseSlice(arguments,2),n=replaceHolders(l,bind.placeholder);a|=PARTIAL_FLAG}return createWrapper(e,a,r,l,n)}var baseSlice=require("../internal/baseSlice"),createWrapper=require("../internal/createWrapper"),replaceHolders=require("../internal/replaceHolders"),BIND_FLAG=1,PARTIAL_FLAG=32;bind.placeholder={},module.exports=bind;


},{"../internal/baseSlice":47,"../internal/createWrapper":59,"../internal/replaceHolders":77}],27:[function(require,module,exports){
...
},{"../utility/identity":97,"./baseMatches":43,"./baseMatchesProperty":44,"./baseProperty":45,"./bindCallback":51,"./isBindable":68}],30:[function(require,module,exports){
...
},{"../lang/isArray":84,"../lang/isObject":87,"../object/keys":92,"./arrayCopy":27,"./arrayEach":28,"./baseCopy":31,"./baseForOwn":37,"./initCloneArray":65,"./initCloneByTag":66,"./initCloneObject":67,"./isHostObject":69}],31:[function(require,module,exports){
...
},{"../lang/isObject":87}],33:[function(require,module,exports){
...
},{"./baseForOwn":37,"./isLength":71,"./toObject":81}],34:[function(require,module,exports){
...
},{"./toObject":81}],36:[function(require,module,exports){
...
},{"../object/keysIn":93,"./baseFor":35}],37:[function(require,module,exports){
...
},{"../object/keys":92,"./baseFor":35}],38:[function(require,module,exports){
...
},{"./indexOfNaN":64}],39:[function(require,module,exports){
...
},{"../lang/isArray":84,"../lang/isTypedArray":90,"./equalArrays":60,"./equalByTag":61,"./equalObjects":62,"./isHostObject":69}],41:[function(require,module,exports){
...
},{"../object/keys":92,"./baseIsMatch":42,"./isStrictComparable":73}],44:[function(require,module,exports){
...
},{"./baseIsEqual":39,"./isStrictComparable":73}],45:[function(require,module,exports){
...
},{"../utility/identity":97,"./metaMap":75}],47:[function(require,module,exports){
function baseSlice(e,r,n){var l=-1,a=e.length;r=null==r?0:+r||0,0>r&&(r=-r>a?0:a+r),n="undefined"==typeof n||n>a?a:+n||0,0>n&&(n+=a),a=r>n?0:n-r>>>0,r>>>=0;for(var o=Array(a);++l<a;)o[l]=e[l+r];return o}module.exports=baseSlice;
...
},{"../utility/identity":97,"./binaryIndexBy":50}],50:[function(require,module,exports){
...
},{"../utility/identity":97}],52:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":86,"../utility/constant":96}],53:[function(require,module,exports){
...
},{"./createCtorWrapper":56}],56:[function(require,module,exports){
...
},{"../lang/isObject":87,"./baseCreate":32}],57:[function(require,module,exports){
(function (global){
function createHybridWrapper(r,e,a,A,o,t,p,_,l,R){function L(){for(var g=arguments.length,h=g,C=Array(g);h--;)C[h]=arguments[h];if(A&&(C=composeArgs(C,A,o)),t&&(C=composeArgsRight(C,t,p)),n||F){var d=L.placeholder,y=replaceHolders(C,d);if(g-=y.length,R>g){var H=_?arrayCopy(_):null,T=nativeMax(R-g,0),Y=n?y:null,m=n?null:y,v=n?C:null,B=n?null:C;e|=n?PARTIAL_FLAG:PARTIAL_RIGHT_FLAG,e&=~(n?PARTIAL_RIGHT_FLAG:PARTIAL_FLAG),c||(e&=~(BIND_FLAG|BIND_KEY_FLAG));var D=createHybridWrapper(r,e,a,v,Y,B,m,H,l,T);return D.placeholder=d,D}}var N=i?a:this;s&&(r=N[I]),_&&(C=reorder(C,_)),G&&l<C.length&&(C.length=l);var U=this&&this!==global&&this instanceof L?u||createCtorWrapper(r):r;return U.apply(N,C)}var G=e&ARY_FLAG,i=e&BIND_FLAG,s=e&BIND_KEY_FLAG,n=e&CURRY_FLAG,c=e&CURRY_BOUND_FLAG,F=e&CURRY_RIGHT_FLAG,u=!s&&createCtorWrapper(r),I=r;return L}var arrayCopy=require("./arrayCopy"),composeArgs=require("./composeArgs"),composeArgsRight=require("./composeArgsRight"),createCtorWrapper=require("./createCtorWrapper"),reorder=require("./reorder"),replaceHolders=require("./replaceHolders"),BIND_FLAG=1,BIND_KEY_FLAG=2,CURRY_BOUND_FLAG=4,CURRY_FLAG=8,CURRY_RIGHT_FLAG=16,PARTIAL_FLAG=32,PARTIAL_RIGHT_FLAG=64,ARY_FLAG=256,nativeMax=Math.max;module.exports=createHybridWrapper;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./arrayCopy":27,"./composeArgs":53,"./composeArgsRight":54,"./createCtorWrapper":56,"./reorder":76,"./replaceHolders":77}],58:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":56}],59:[function(require,module,exports){
function createWrapper(e,a,r,t,p,i,A,_){var n=a&BIND_KEY_FLAG;if(!n&&"function"!=typeof e)throw new TypeError(FUNC_ERROR_TEXT);var L=t?t.length:0;if(L||(a&=~(PARTIAL_FLAG|PARTIAL_RIGHT_FLAG),t=p=null),L-=p?p.length:0,a&PARTIAL_RIGHT_FLAG){var l=t,D=p;t=p=null}var R=!n&&getData(e),c=[e,a,r,t,p,l,D,i,A,_];if(R&&R!==!0&&(mergeData(c,R),a=c[1],_=c[9]),c[9]=null==_?n?0:e.length:nativeMax(_-L,0)||0,a==BIND_FLAG)var u=createBindWrapper(c[0],c[2]);else u=a!=PARTIAL_FLAG&&a!=(BIND_FLAG|PARTIAL_FLAG)||c[4].length?createHybridWrapper.apply(void 0,c):createPartialWrapper.apply(void 0,c);var G=R?baseSetData:setData;return G(u,c)}var baseSetData=require("./baseSetData"),createBindWrapper=require("./createBindWrapper"),createHybridWrapper=require("./createHybridWrapper"),createPartialWrapper=require("./createPartialWrapper"),getData=require("./getData"),mergeData=require("./mergeData"),setData=require("./setData"),BIND_FLAG=1,BIND_KEY_FLAG=2,PARTIAL_FLAG=32,PARTIAL_RIGHT_FLAG=64,FUNC_ERROR_TEXT="Expected a function",nativeMax=Math.max;module.exports=createWrapper;


},{"./baseSetData":46,"./createBindWrapper":55,"./createHybridWrapper":57,"./createPartialWrapper":58,"./getData":63,"./mergeData":74,"./setData":78}],60:[function(require,module,exports){
...
},{"../object/keys":92}],63:[function(require,module,exports){
...
},{"../utility/noop":98,"./metaMap":75}],64:[function(require,module,exports){
...
},{"./bufferClone":52}],67:[function(require,module,exports){
...
},{"../lang/isNative":86,"../support":95,"./baseSetData":46}],69:[function(require,module,exports){
...
},{"../lang/isObject":87}],74:[function(require,module,exports){
function mergeData(r,A){var e=r[1],R=A[1],_=e|R,G=ARY_FLAG|REARG_FLAG,a=BIND_FLAG|BIND_KEY_FLAG,L=G|a|CURRY_BOUND_FLAG|CURRY_RIGHT_FLAG,o=e&ARY_FLAG&&!(R&ARY_FLAG),F=e&REARG_FLAG&&!(R&REARG_FLAG),p=(F?r:A)[7],s=(o?r:A)[8],l=!(e>=REARG_FLAG&&R>a||e>a&&R>=REARG_FLAG),i=_>=G&&L>=_&&(REARG_FLAG>e||(F||o)&&p.length<=s);if(!l&&!i)return r;R&BIND_FLAG&&(r[2]=A[2],_|=e&BIND_FLAG?0:CURRY_BOUND_FLAG);var C=A[3];if(C){var E=r[3];r[3]=E?composeArgs(E,C,A[4]):arrayCopy(C),r[4]=E?replaceHolders(r[3],PLACEHOLDER):arrayCopy(A[4])}return C=A[5],C&&(E=r[5],r[5]=E?composeArgsRight(E,C,A[6]):arrayCopy(C),r[6]=E?replaceHolders(r[5],PLACEHOLDER):arrayCopy(A[6])),C=A[7],C&&(r[7]=arrayCopy(C)),R&ARY_FLAG&&(r[8]=null==r[8]?A[8]:nativeMin(r[8],A[8])),null==r[9]&&(r[9]=A[9]),r[0]=A[0],r[1]=_,r}var arrayCopy=require("./arrayCopy"),composeArgs=require("./composeArgs"),composeArgsRight=require("./composeArgsRight"),replaceHolders=require("./replaceHolders"),BIND_FLAG=1,BIND_KEY_FLAG=2,CURRY_BOUND_FLAG=4,CURRY_RIGHT_FLAG=16,REARG_FLAG=128,ARY_FLAG=256,PLACEHOLDER="__lodash_placeholder__",nativeMin=Math.min;module.exports=mergeData;


},{"./arrayCopy":27,"./composeArgs":53,"./composeArgsRight":54,"./replaceHolders":77}],75:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":86}],76:[function(require,module,exports){
...
},{"./arrayCopy":27,"./isIndex":70}],77:[function(require,module,exports){
...
},{"../date/now":25,"./baseSetData":46}],79:[function(require,module,exports){
...
},{"../lang/isArguments":83,"../support":95,"./baseForIn":36,"./isHostObject":69,"./isObjectLike":72}],80:[function(require,module,exports){
...
},{"../lang/isArguments":83,"../lang/isArray":84,"../lang/isString":89,"../object/keysIn":93,"../support":95,"./isIndex":70,"./isLength":71}],81:[function(require,module,exports){
...
},{"../lang/isObject":87,"../lang/isString":89,"../support":95}],82:[function(require,module,exports){
...
},{"../internal/baseClone":30,"../internal/bindCallback":51}],83:[function(require,module,exports){
...
},{"../internal/isLength":71,"../internal/isObjectLike":72,"../support":95}],84:[function(require,module,exports){
...
},{"../internal/isLength":71,"../internal/isObjectLike":72,"./isNative":86}],85:[function(require,module,exports){
(function (global){
...
},{"../internal/baseIsFunction":41,"./isNative":86}],86:[function(require,module,exports){
...
},{"../internal/isHostObject":69,"../internal/isObjectLike":72,"../string/escapeRegExp":94}],87:[function(require,module,exports){
...
},{"../internal/shimIsPlainObject":79,"../support":95,"./isArguments":83,"./isNative":86}],89:[function(require,module,exports){
...
},{"../internal/isObjectLike":72}],90:[function(require,module,exports){
...
},{"../internal/isLength":71,"../internal/isObjectLike":72}],91:[function(require,module,exports){
...
},{"../internal/isLength":71,"../internal/shimKeys":80,"../lang/isNative":86,"../lang/isObject":87,"../support":95}],93:[function(require,module,exports){
...
},{"../internal/arrayEach":28,"../internal/isIndex":70,"../internal/isLength":71,"../lang/isArguments":83,"../lang/isArray":84,"../lang/isFunction":85,"../lang/isObject":87,"../lang/isString":89,"../support":95}],94:[function(require,module,exports){
...
},{"../internal/baseToString":48}],95:[function(require,module,exports){
(function (global){
...
},{"./lang/isNative":86}],96:[function(require,module,exports){
