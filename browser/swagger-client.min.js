...
},{"./auth":2,"./helpers":4,"./http":5,"./resolver":6,"./spec-converter":8,"./types/model":9,"./types/operation":10,"./types/operationGroup":11,"lodash-compat/array/indexOf":54,"lodash-compat/collection/find":58,"lodash-compat/collection/forEach":59,"lodash-compat/function/bind":63,"lodash-compat/lang/cloneDeep":143,"lodash-compat/lang/isArray":145,"lodash-compat/lang/isFunction":147,"lodash-compat/lang/isObject":149,"lodash-compat/lang/isPlainObject":150,"lodash-compat/lang/isUndefined":153,"q":162}],4:[function(require,module,exports){
=======
...
>>>>>>> c89f6ccfac7510d7d492f9f59d6ff961a12ab660
(function (process){
...
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject")},JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t);var s=!1;if("undefined"!=typeof window&&"undefined"!=typeof window.jQuery&&(s=!0),this.isInternetExplorer()&&(e.useJQuery===!1||!hasJquery))throw new Exception("Unsupported configuration! JQuery is required but not available");(e&&e.useJQuery===!0||this.isInternetExplorer()&&s)&&(r=new JQueryHttpClient(t));var n=e.on.response,o=function(e){return t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),n(e)};return e.on.response=function(e){o(e)},_.isObject(e)&&_.isObject(e.body)&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),r.execute(e),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=jQuery||window.jQuery,r=e.on,s=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var t={},n=e.getAllResponseHeaders().split("\n"),o=0;o<n.length;o++){var a=n[o].trim();if(0!==a.length){var u=a.indexOf(":");if(-1!==u){var i=a.substring(0,u).trim(),p=a.substring(u+1).trim();t[i]=p}else t[a]=null}}var l={url:s.url,method:s.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:t};try{var d=e.responseJSON||jsyaml.safeLoad(e.responseText);l.obj="string"==typeof d?{}:d}catch(y){helpers.log("unable to parse JSON/YAML content")}if(l.obj=l.obj||null,e.status>=200&&e.status<300)r.response(l);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(l);r.error(l)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},n=request[t](e.url);for(r in s)n.set(r,s[r]);e.body&&n.send(e.body),"function"==typeof n.buffer&&n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var s,n={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(n.errObj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{n.obj=JSON.parse(n.statusText)}catch(o){n.obj=null}s=e.on.error}else if(r&&e.on&&e.on.response){var a;if(r.body&&Object.keys(r.body).length>0)a=r.body;else try{a=jsyaml.safeLoad(r.text),a="string"==typeof a?null:a}catch(o){helpers.log("cannot parse JSON/YAML content")}n.obj="object"==typeof a?a:null,n.status=r.status,n.statusText=r.text,s=e.on.response}n.data=n.statusText,s&&s(n)})};


},{"./helpers":4,"js-yaml":23,"lodash-compat/lang/isObject":149,"superagent":163}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){};Resolver.prototype.processAllOf=function(e,r,o,i,t){var s,n,l;r["x-resolved-from"]=["#/definitions/"+e];var f=r.allOf;for(f.sort(function(e,r){return e.$ref&&r.$ref?0:e.$ref?-1:1}),s=0;s<f.length;s++)l=f[s],n="/definitions/"+e+"/allOf",this.resolveInline(null,t,l,o,i,n)},Resolver.prototype.resolve=function(e,r,o,i){var t,s,n=r,l=o,f=i;"function"==typeof r&&(n=null,l=r,f=o);var a=n;this.scope=f||this,this.iteration=this.iteration||0;var p,h,v,d,u=0,c={},y={},g=[];e.definitions=e.definitions||{};for(p in e.definitions){var O=e.definitions[p];for(d in O.properties)v=O.properties[d],_.isArray(v.allOf)?this.processAllOf(p,v,g,y,e):this.resolveTo(n,v,g,"/definitions");O.allOf&&this.processAllOf(p,O,g,y,e)}for(p in e.paths){var m,x,b;h=e.paths[p];for(m in h)if("$ref"===m)t="/paths"+p,this.resolveInline(n,e,h,g,y,t);else{x=h[m];var A=h.parameters||[],k=x.parameters||[];for(s in A){var j=A[s];k.unshift(j)}for(s in k){var j=k[s];if(t="/paths"+p+"/"+m+"/parameters","body"===j["in"]&&j.schema)if(_.isArray(j.schema.allOf)){for(var R="inline_model",p=R,$=!1,w=0;!$;){if("undefined"==typeof e.definitions[p]){$=!0;break}p=R+"_"+w,w++}e.definitions[p]={allOf:j.schema.allOf},delete j.schema.allOf,j.schema.$ref="#/definitions/"+p,this.processAllOf(p,e.definitions[p],g,y,e)}else this.resolveTo(n,j.schema,g,t);j.$ref&&this.resolveInline(n,e,j,g,y,j.$ref)}for(b in x.responses){var I=x.responses[b];t="/paths"+p+"/"+m+"/responses/"+b,_.isObject(I)&&(I.$ref&&this.resolveInline(n,e,I,g,y,t),I.schema&&this.resolveTo(n,I.schema,g,t))}}h.parameters=[]}var S,q=0,T=[],J=g;for(s=0;s<J.length;s++){var N=J[s];if(n===N.root){if("ref"===N.resolveAs){var H,P=((N.root||"")+"/"+N.key).split("/"),z=[],U="";if(N.key.indexOf("../")>=0){for(var E=0;E<P.length;E++)".."===P[E]?z=z.slice(0,z.length-1):z.push(P[E]);for(H=0;H<z.length;H++)H>0&&(U+="/"),U+=z[H];N.root=U,T.push(N)}else if(S=N.key.split("#"),2===S.length){(0===S[0].indexOf("http://")||0===S[0].indexOf("https://"))&&(N.root=S[0]),t=S[1].split("/");var Q,B=e;for(H=0;H<t.length;H++){var C=t[H];if(""!==C){if(B=B[C],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&T.push(N)}}else if("inline"===N.resolveAs){if(N.key&&-1===N.key.indexOf("#")&&"/"!==N.key.charAt(0)){for(S=N.root.split("/"),t="",s=0;s<S.length-1;s++)t+=S[s]+"/";t+=N.key,N.root=t,N.location=""}T.push(N)}}else T.push(N)}q=T.length;for(var D=0;D<T.length;D++)!function(e,r,o){if(null===e.root||e.root===n)o.resolveItem(r,a,g,c,y,e),u+=1,u===q&&o.finish(r,n,g,c,y,l);else{var i={useJQuery:!1,url:e.root,method:"get",headers:{accept:o.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){u+=1,y[e.key]={root:e.root,location:e.location},u===q&&o.finish(r,a,g,c,y,l)},response:function(i){var t=i.obj;o.resolveItem(t,e.root,g,c,y,e),u+=1,u===q&&o.finish(r,a,g,c,y,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(i),(new SwaggerHttp).execute(i)}}(T[D],e,this);0===Object.keys(T).length&&this.finish(e,a,g,c,y,l)},Resolver.prototype.resolveItem=function(e,r,o,i,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?i[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,r,o,i,t,s){var n;for(n in o){var l=o[n],f=l.key,a=i[f];if(a)if(e.definitions=e.definitions||{},"ref"===l.resolveAs){for(f in a.obj)var p=this.retainRoot(a.obj[f],l.root);e.definitions[a.name]=a.obj,l.obj.$ref="#/definitions/"+a.name}else if("inline"===l.resolveAs){var h=l.obj;h["x-resolved-from"]=[l.key],delete h.$ref;for(f in a.obj){var p=this.retainRoot(a.obj[f],l.root);h[f]=p}}}var v=this.countUnresolvedRefs(e);0===v.length||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,r,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var r,o=this.getRefs(e),i=[],t=[];for(r in o)0===r.indexOf("#")?i.push(r.substring(1)):t.push(r);for(r=0;r<i.length;r++)for(var s=i[r],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,r){r=r||e;var o={};for(var i in r)if(r.hasOwnProperty(i)){var t=r[i];if("$ref"===i&&"string"==typeof t)o[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)o[n]=null}}return o},Resolver.prototype.retainRoot=function(e,r){for(var o in e){var i=e[o];"$ref"===o&&"string"==typeof i?0!==i.indexOf("http://")&&0!==i.indexOf("https://")&&(0!==i.indexOf("#")&&(i="#"+i),i=(r||"")+i,e[o]=i):_.isObject(i)&&this.retainRoot(i,r)}return e},Resolver.prototype.resolveInline=function(e,r,o,i,t,s){var n,l,f,a,p=o.$ref,h=o.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var d=0;d<f.length;d++)d>0&&(e+="/"),e+=f[d]}e+="/"+h.split("#")[0]}s=a[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),i.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],i.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})):i.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})}else"array"===o.type&&this.resolveTo(e,o.items,i,s)},Resolver.prototype.resolveTo=function(e,r,o,i){var t,s,n=r.$ref,l=e;if("undefined"!=typeof n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}i=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,i="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,i=""}o.push({obj:r,resolveAs:"ref",root:l,key:n,location:i})}else if("array"===r.type){var a=r.items;this.resolveTo(e,a,o,i)}},Resolver.prototype.resolveAllOf=function(e,r,o){o=o||0,r=r||e;var i;for(var t in r)if(r.hasOwnProperty(t)){var s=r[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+r+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,o+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l={};l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]),l.properties={},s.example&&(l.example=s.example);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(i in v){l.properties[i]=JSON.parse(JSON.stringify(v[i]));var d=v[i]["x-resolved-from"];("undefined"==typeof d||"self"===d)&&(d=p),l.properties[i]["x-resolved-from"]=d}}else if("required"===h){for(var u=l.required.concat(a[h]),c=0;c<u.length;++c)for(var y=c+1;y<u.length;++y)u[c]===u[y]&&u.splice(y--,1);l.required=u}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=JSON.parse(JSON.stringify(a[h])),"properties"===h)for(i in l[h])l[h][i]["x-resolved-from"]=p}r[t]=l}}_.isObject(s)&&this.resolveAllOf(e,s,o+1)}};
