...
"use strict";function OperationParams(){this.types={};for(var t=0;t<TYPES.length;t++)this.types[TYPES[t]]={}}var TYPES=["query","header","path","formData","body"];OperationParams.prototype.set=function(t,r,e){if(!this.types.hasOwnProperty(t))throw new Error("Parameter type"+r+"is not supported");this.types[t][r]=e},OperationParams.prototype.get=function(t,r){if(!this.types.hasOwnProperty(t))throw new Error("Parameter type"+r+"is not supported");return this.types[t][r]},OperationParams.prototype.exists=function(t,r){if(Array.isArray(t)){for(var e=0;e<t.length;e++)if(void 0!==this.get(t[e],r))return!0;return!1}return void 0!==this.get(t,r)},module.exports=OperationParams;
