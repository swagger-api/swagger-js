...
},{"./auth":2,"./helpers":4,"./http":5,"./resolver":6,"./spec-converter":8,"./types/model":9,"./types/operation":10,"./types/operationGroup":11,"lodash-compat/array/indexOf":53,"lodash-compat/collection/find":57,"lodash-compat/collection/forEach":58,"lodash-compat/function/bind":62,"lodash-compat/lang/cloneDeep":142,"lodash-compat/lang/isArray":144,"lodash-compat/lang/isFunction":146,"lodash-compat/lang/isObject":148,"lodash-compat/lang/isPlainObject":149,"lodash-compat/lang/isUndefined":152,"q":162}],4:[function(require,module,exports){
(function (process){
...
},{"./helpers":4,"js-yaml":23,"lodash-compat/lang/isObject":148,"superagent":164}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){};Resolver.prototype.processAllOf=function(e,r,o,i,t){var s,n,l;r["x-resolved-from"]=["#/definitions/"+e];var f=r.allOf;for(f.sort(function(e,r){return e.$ref&&r.$ref?0:e.$ref?-1:1}),s=0;s<f.length;s++)l=f[s],n="/definitions/"+e+"/allOf",this.resolveInline(null,t,l,o,i,n)},Resolver.prototype.resolve=function(e,r,o,i){this.spec=e;var t,s,n=r,l=o,f=i,p={};"function"==typeof r&&(n=null,l=r,f=o);var a=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(p.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(p.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,y={},g={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var m=e.definitions[h];for(d in m.properties)c=m.properties[d],_.isArray(c.allOf)?this.processAllOf(h,c,O,g,e):this.resolveTo(n,c,O,"/definitions");m.allOf&&this.processAllOf(h,m,O,g,e)}for(h in e.paths){var x,b,A;v=e.paths[h];for(x in v)if("$ref"===x)t="/paths"+h,this.resolveInline(n,e,v,O,g,t);else{b=v[x];var k=v.parameters||[],j=b.parameters||[];for(s in k){var R=k[s];j.unshift(R)}for(s in j){var R=j[s];if(t="/paths"+h+"/"+x+"/parameters","body"===R["in"]&&R.schema)if(_.isArray(R.schema.allOf)){for(var $="inline_model",h=$,I=!1,q=0;!I;){if("undefined"==typeof e.definitions[h]){I=!0;break}h=$+"_"+q,q++}e.definitions[h]={allOf:R.schema.allOf},delete R.schema.allOf,R.schema.$ref="#/definitions/"+h,this.processAllOf(h,e.definitions[h],O,g,e)}else this.resolveTo(n,R.schema,O,t);R.$ref&&this.resolveInline(n,e,R,O,g,R.$ref)}for(A in b.responses){var w=b.responses[A];t="/paths"+h+"/"+x+"/responses/"+A,_.isObject(w)&&(w.$ref&&this.resolveInline(n,e,w,O,g,t),w.schema&&this.resolveTo(n,w.schema,O,t))}}v.parameters=[]}var S,T=0,N=[],J=O;for(s=0;s<J.length;s++){var D=J[s];if(n===D.root){if("ref"===D.resolveAs){var H,P=((D.root||"")+"/"+D.key).split("/"),z=[],U="";if(D.key.indexOf("../")>=0){for(var E=0;E<P.length;E++)".."===P[E]?z=z.slice(0,z.length-1):z.push(P[E]);for(H=0;H<z.length;H++)H>0&&(U+="/"),U+=z[H];D.root=U,N.push(D)}else if(S=D.key.split("#"),2===S.length){(0===S[0].indexOf("http://")||0===S[0].indexOf("https://"))&&(D.root=S[0]),t=S[1].split("/");var Q,B=e;for(H=0;H<t.length;H++){var C=t[H];if(""!==C){if(B=B[C],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&N.push(D)}}else if("inline"===D.resolveAs){if(D.key&&-1===D.key.indexOf("#")&&"/"!==D.key.charAt(0)){for(S=D.root.split("/"),t="",s=0;s<S.length-1;s++)t+=S[s]+"/";t+=D.key,D.root=t,D.location=""}N.push(D)}}else N.push(D)}T=N.length;for(var F=0;F<N.length;F++)!function(e,r,o){if(null===e.root||e.root===n)o.resolveItem(r,a,O,y,g,e),u+=1,u===T&&o.finish(r,n,O,y,g,l);else{var i={useJQuery:!1,url:e.root,method:"get",headers:{accept:o.scope.swaggerRequestHeaders||"application/json"},on:{error:function(i){u+=1,g[e.key]={root:e.root,location:e.location},u===T&&o.finish(r,a,O,y,g,l)},response:function(i){var t=i.obj;o.resolveItem(t,e.root,O,y,g,e),u+=1,u===T&&o.finish(r,a,O,y,g,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(i),(new SwaggerHttp).execute(i,p)}}(N[F],e,this);0===Object.keys(N).length&&this.finish(e,a,O,y,g,l)},Resolver.prototype.resolveItem=function(e,r,o,i,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var p=0;p<f.length;p++){var a=f[p];if(-1!==a.indexOf("~1")&&(a=f[p].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==a.charAt(0)&&(a="/"+a)),"undefined"==typeof l||null===l)break;if(""===a&&p===f.length-1&&f.length>1){l=null;break}a.length>0&&(l=l[a])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?i[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,r,o,i,t,s){var n;for(n in o){var l=o[n],f=l.key,p=i[f];if(p)if(e.definitions=e.definitions||{},"ref"===l.resolveAs){for(f in p.obj)var a=this.retainRoot(p.obj[f],l.root);e.definitions[p.name]=p.obj,l.obj.$ref="#/definitions/"+p.name}else if("inline"===l.resolveAs){var h=l.obj;h["x-resolved-from"]=[l.key],delete h.$ref;for(f in p.obj){var a=this.retainRoot(p.obj[f],l.root);h[f]=a}}}var v=this.countUnresolvedRefs(e);0===v||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,r,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var r,o=this.getRefs(e),i=[],t=[];for(r in o)0===r.indexOf("#")?i.push(r.substring(1)):t.push(r);for(r=0;r<i.length;r++)for(var s=i[r],n=s.split("/"),l=e,f=0;f<n.length;f++){var p=n[f];if(""!==p&&(l=l[p],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,r){r=r||e;var o={};for(var i in r)if(r.hasOwnProperty(i)){var t=r[i];if("$ref"===i&&"string"==typeof t)o[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)o[n]=null}}return o},Resolver.prototype.retainRoot=function(e,r){for(var o in e){var i=e[o];"$ref"===o&&"string"==typeof i?0!==i.indexOf("http://")&&0!==i.indexOf("https://")&&(0!==i.indexOf("#")&&(i="#"+i),i=(r||"")+i,e[o]=i):_.isObject(i)&&this.retainRoot(i,r)}return e},Resolver.prototype.resolveInline=function(e,r,o,i,t,s){var n,l,f,p,a=o.$ref,h=o.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))p=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+p[0],s=p[1];else{if(p=h.split("#"),""!==p[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=p[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),i.push({obj:o,resolveAs:"inline",root:e,key:a,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],i.push({obj:o,resolveAs:"inline",root:e,key:a,location:s})):i.push({obj:o,resolveAs:"inline",root:e,key:a,location:s})}else"array"===o.type&&this.resolveTo(e,o.items,i,s)},Resolver.prototype.resolveTo=function(e,r,o,i){var t,s,n=r.$ref,l=e;if("undefined"!=typeof n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}i=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,i="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,i=""}o.push({obj:r,resolveAs:"ref",root:l,key:n,location:i})}else if("array"===r.type){var p=r.items;this.resolveTo(e,p,o,i)}else if(r&&r.properties){var a=this.uniqueName("inline_model");this.spec.definitions[a]=_.cloneDeep(r),r.$ref="#/definitions/"+a,delete r.type,delete r.properties}},Resolver.prototype.uniqueName=function(e){for(var r=e,o=0;;){if(!_.isObject(this.spec.definitions[r]))return r;r=e+"_"+o,o++}},Resolver.prototype.resolveAllOf=function(e,r,o){o=o||0,r=r||e;var i;for(var t in r)if(r.hasOwnProperty(t)){var s=r[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+r+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,o+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l={};l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]),l.properties={},s.example&&(l.example=s.example);for(var f=0;f<n.length;f++){var p=n[f],a="self";"undefined"!=typeof p["x-resolved-from"]&&(a=p["x-resolved-from"][0]);for(var h in p)if(l.hasOwnProperty(h))if("properties"===h){var v=p[h];for(i in v){l.properties[i]=JSON.parse(JSON.stringify(v[i]));var c=v[i]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=a),l.properties[i]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(p[h]),u=0;u<d.length;++u)for(var y=u+1;y<d.length;++y)d[u]===d[y]&&d.splice(y--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(a);else if(l[h]=JSON.parse(JSON.stringify(p[h])),"properties"===h)for(i in l[h])l[h][i]["x-resolved-from"]=a}r[t]=l}}_.isObject(s)&&this.resolveAllOf(e,s,o+1)}};
...
},{"base64-js":12,"ieee754":19,"is-array":22}],16:[function(require,module,exports){
...
},{"./lib/inherit":21}],21:[function(require,module,exports){
...
},{"inherit":20}],28:[function(require,module,exports){
