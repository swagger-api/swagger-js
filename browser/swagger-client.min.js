...
},{"btoa":17,"cookiejar":18}],3:[function(require,module,exports){
...
},{"./helpers":5,"jquery":19,"superagent":98}],7:[function(require,module,exports){
...
"use strict";var _={isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined")},ArrayModel=require("./arrayModel"),helpers=require("../helpers"),Property=module.exports=function(e,t,i,s){this.models=s,this.schema=t,this.required=i,t.$ref?this.$ref=helpers.simpleRef(t.$ref):"array"===t.type&&t.items&&(t.items.$ref?this.$ref=helpers.simpleRef(t.items.$ref):t=t.items),this.name=e,this.description=t.description,this.obj=t,this.optional=!0,this.optional=!i,this["default"]=t["default"]||null,this.example=void 0!==t.example?t.example:null,this.collectionFormat=t.collectionFormat||null,this.maximum=t.maximum||null,this.exclusiveMaximum=t.exclusiveMaximum||null,this.minimum=t.minimum||null,this.exclusiveMinimum=t.exclusiveMinimum||null,this.maxLength=t.maxLength||null,this.minLength=t.minLength||null,this.pattern=t.pattern||null,this.maxItems=t.maxItems||null,this.minItems=t.minItems||null,this.uniqueItems=t.uniqueItems||null,this["enum"]=t["enum"]||null,this.multipleOf=t.multipleOf||null},Model=module.exports=function(e,t,i){if(this.models=i||{},this.name=e,this.definition=t||{},this.properties=[],"array"===t.type)return new ArrayModel(t,i);var s,r=t.required||[],n=t.properties;if(n)for(s in n){var a=!1,l=n[s];r.indexOf(s)>=0&&(a=!0),this.properties.push(new Property(s,l,a,this.models))}return this};Model.prototype.createJSONSample=function(e){var t,i={},s={},r=this.examples&&this.examples["application/json"]?this.examples["application/json"]:void 0;if(_.isUndefined(r)||(_.isPlainObject(r)?i=r:_.isString(r)?i=JSON.parse(this.examples["application/json"]):r=void 0),_.isUndefined(r)){for(e=e||{},e[this.name]=this,t=0;t<this.properties.length;t++){var n=this.properties[t],a=n.getSampleValue(e,s);i[n.name]=a}delete e[this.name]}return i},Model.prototype.getSampleValue=function(e){var t,i={},s={};for(t=0;t<this.properties.length;t++){var r=this.properties[t];i[r.name]=r.sampleValue(!1,e,s)}return i},Model.prototype.getMockSignature=function(e){var t,i,s=[];for(t=0;t<this.properties.length;t++)i=this.properties[t],s.push(i.toString());var r='<span class="strong">',n="</span>",a=r+this.name+" {"+n,l=r+"}"+n,p=a+"<div>"+s.join(",</div><div>")+"</div>"+l;for(e||(e={}),e[this.name]=this,t=0;t<this.properties.length;t++){i=this.properties[t];var o=i.$ref,h=this.models[o];h&&"undefined"==typeof e[h.name]&&(p+="<br>"+h.getMockSignature(e))}return p},Property.prototype.getSampleValue=function(e,t){return this.sampleValue(!1,e,t)},Property.prototype.isArray=function(){var e=this.schema;return"array"===e.type?!0:!1},Property.prototype.sampleValue=function(e,t,i){e=e||this.isArray(),t=t||{};var s,r=this,n=function(e){var s,n=helpers.simpleRef(e),l=r.models[n];return"undefined"!=typeof i[a]&&(s=i[a]),l&&"undefined"==typeof t[a]?(t[a]=this,s=l.getSampleValue(t,i),i[a]=s):s=i[a]||n,s},a=helpers.getStringSignature(this.obj,!0);return s=this.$ref?n(this.$ref):this.example?this.example:this["default"]?this["default"]:"date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string"===a?"string":"integer"===a?0:"long"===a?0:"float"===a?0:"double"===a?0:"boolean"===a?!0:this.schema.$ref?n(this.schema.$ref):this.schema.properties?new Model("InlineModel-"+new Date,this.schema,this.models).getSampleValue():{},t[a]=s,e?[s]:s},Property.prototype.toString=function(){var e,t=helpers.getStringSignature(this.obj),i='<span class="strong">',s="</span>",r=[];if("object"===t){for(var n in this.schema.properties)this.schema.properties.hasOwnProperty(n)&&(e=new Property(n,this.schema.properties[n],(this.schema.required||[]).indexOf(n)>-1,this.models),r.push(e.toString()));t=i+this.name+" {"+s+"<div>"+r.join(",</div><div>")+"</div>"+i+"}"+s}else""!==t?(t='<span class="propName '+this.required+'">'+this.name+'</span> (<span class="propType">'+t+"</span>",this.required||(t+=', <span class="propOptKey">optional</span>'),t+=")"):t=this.name+" ("+JSON.stringify(this.obj)+")";"undefined"!=typeof this.description&&(t+=": "+this.description),this["enum"]&&(t+=' = <span class="propVals">[\''+this["enum"].join("' or '")+"']</span>"),this.descr&&(t+=': <span class="propDesc">'+this.descr+"</span>");var a,l="",p="array"===this.schema.type;switch(a=p?this.schema.items?this.schema.items.type:"":this.schema.type,this["default"]&&(l+=helpers.optionHtml("Default",this["default"])),a){case"string":this.minLength&&(l+=helpers.optionHtml("Min. Length",this.minLength)),this.maxLength&&(l+=helpers.optionHtml("Max. Length",this.maxLength)),this.pattern&&(l+=helpers.optionHtml("Reg. Exp.",this.pattern));break;case"integer":case"number":this.minimum&&(l+=helpers.optionHtml("Min. Value",this.minimum)),this.exclusiveMinimum&&(l+=helpers.optionHtml("Exclusive Min.","true")),this.maximum&&(l+=helpers.optionHtml("Max. Value",this.maximum)),this.exclusiveMaximum&&(l+=helpers.optionHtml("Exclusive Max.","true")),this.multipleOf&&(l+=helpers.optionHtml("Multiple Of",this.multipleOf))}if(p&&(this.minItems&&(l+=helpers.optionHtml("Min. Items",this.minItems)),this.maxItems&&(l+=helpers.optionHtml("Max. Items",this.maxItems)),this.uniqueItems&&(l+=helpers.optionHtml("Unique Items","true")),this.collectionFormat&&(l+=helpers.optionHtml("Coll. Format",this.collectionFormat))),this["enum"]){var o;o="number"===a||"integer"===a?this["enum"].join(", "):'"'+this["enum"].join('", "')+'"',l+=helpers.optionHtml("Enum",o)}return l.length>0&&(t='<span class="propWrap">'+t+'<table class="optionsWrapper"><tr><th colspan="2">'+this.name+"</th></tr>"+l+"</table></span>"),t};


},{"../helpers":5,"./arrayModel":8,"lodash-compat/lang/isPlainObject":87,"lodash-compat/lang/isString":88,"lodash-compat/lang/isUndefined":90}],10:[function(require,module,exports){
...
},{"../helpers":5,"../http":6,"./arrayModel":8,"./model":9}],11:[function(require,module,exports){
...
},{"../internal/baseCallback":28}],21:[function(require,module,exports){
...
},{"../internal/baseIndexOf":37,"../internal/binaryIndex":48}],22:[function(require,module,exports){
...
},{"../array/findIndex":20,"../internal/baseCallback":28,"../internal/baseEach":32,"../internal/baseFind":33,"../lang/isArray":83}],23:[function(require,module,exports){
...
},{"../internal/arrayEach":27,"../internal/baseEach":32,"../internal/bindCallback":50,"../lang/isArray":83}],24:[function(require,module,exports){
...
},{"../lang/isNative":85}],25:[function(require,module,exports){
...
},{"../internal/baseSlice":46,"../internal/createWrapper":58,"../internal/replaceHolders":76}],26:[function(require,module,exports){
...
},{"../utility/identity":96,"./baseMatches":42,"./baseMatchesProperty":43,"./baseProperty":44,"./bindCallback":50,"./isBindable":67}],29:[function(require,module,exports){
...
},{"../lang/isArray":83,"../lang/isObject":86,"../object/keys":91,"./arrayCopy":26,"./arrayEach":27,"./baseCopy":30,"./baseForOwn":36,"./initCloneArray":64,"./initCloneByTag":65,"./initCloneObject":66,"./isHostObject":68}],30:[function(require,module,exports){
...
},{"../lang/isObject":86}],32:[function(require,module,exports){
...
},{"./baseForOwn":36,"./isLength":70,"./toObject":80}],33:[function(require,module,exports){
...
},{"../object/keysIn":92,"./baseFor":34}],36:[function(require,module,exports){
...
},{"../object/keys":91,"./baseFor":34}],37:[function(require,module,exports){
...
},{"../lang/isArray":83,"../lang/isTypedArray":89,"./equalArrays":59,"./equalByTag":60,"./equalObjects":61,"./isHostObject":68}],40:[function(require,module,exports){
...
},{"../object/keys":91,"./baseIsMatch":41,"./isStrictComparable":72}],43:[function(require,module,exports){
...
},{"./baseIsEqual":38,"./isStrictComparable":72}],44:[function(require,module,exports){
...
},{"../utility/identity":96,"./metaMap":74}],46:[function(require,module,exports){
...
},{"../utility/identity":96,"./binaryIndexBy":49}],49:[function(require,module,exports){
...
},{"../utility/identity":96}],51:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":85,"../utility/constant":95}],52:[function(require,module,exports){
...
},{"./createCtorWrapper":55}],55:[function(require,module,exports){
...
},{"../lang/isObject":86,"./baseCreate":31}],56:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":26,"./composeArgs":52,"./composeArgsRight":53,"./createCtorWrapper":55,"./reorder":75,"./replaceHolders":76}],57:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":55}],58:[function(require,module,exports){
...
},{"./baseSetData":45,"./createBindWrapper":54,"./createHybridWrapper":56,"./createPartialWrapper":57,"./getData":62,"./mergeData":73,"./setData":77}],59:[function(require,module,exports){
...
},{"../object/keys":91}],62:[function(require,module,exports){
...
},{"../utility/noop":97,"./metaMap":74}],63:[function(require,module,exports){
...
},{"./bufferClone":51}],66:[function(require,module,exports){
...
},{"../lang/isNative":85,"../support":94,"./baseSetData":45}],68:[function(require,module,exports){
...
},{"../lang/isObject":86}],73:[function(require,module,exports){
...
},{"./arrayCopy":26,"./composeArgs":52,"./composeArgsRight":53,"./replaceHolders":76}],74:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":85}],75:[function(require,module,exports){
...
},{"./arrayCopy":26,"./isIndex":69}],76:[function(require,module,exports){
...
},{"../date/now":24,"./baseSetData":45}],78:[function(require,module,exports){
...
},{"../lang/isArguments":82,"../support":94,"./baseForIn":35,"./isHostObject":68,"./isObjectLike":71}],79:[function(require,module,exports){
...
},{"../lang/isArguments":82,"../lang/isArray":83,"../lang/isString":88,"../object/keysIn":92,"../support":94,"./isIndex":69,"./isLength":70}],80:[function(require,module,exports){
...
},{"../lang/isObject":86,"../lang/isString":88,"../support":94}],81:[function(require,module,exports){
...
},{"../internal/baseClone":29,"../internal/bindCallback":50}],82:[function(require,module,exports){
...
},{"../internal/isLength":70,"../internal/isObjectLike":71,"../support":94}],83:[function(require,module,exports){
...
},{"../internal/isLength":70,"../internal/isObjectLike":71,"./isNative":85}],84:[function(require,module,exports){
(function (global){
...
},{"../internal/baseIsFunction":40,"./isNative":85}],85:[function(require,module,exports){
...
},{"../internal/isHostObject":68,"../internal/isObjectLike":71,"../string/escapeRegExp":93}],86:[function(require,module,exports){
...
},{"../internal/shimIsPlainObject":78,"../support":94,"./isArguments":82,"./isNative":85}],88:[function(require,module,exports){
...
},{"../internal/isObjectLike":71}],89:[function(require,module,exports){
...
},{"../internal/isLength":70,"../internal/isObjectLike":71}],90:[function(require,module,exports){
...
},{"../internal/isLength":70,"../internal/shimKeys":79,"../lang/isNative":85,"../lang/isObject":86,"../support":94}],92:[function(require,module,exports){
...
},{"../internal/arrayEach":27,"../internal/isIndex":69,"../internal/isLength":70,"../lang/isArguments":82,"../lang/isArray":83,"../lang/isFunction":84,"../lang/isObject":86,"../lang/isString":88,"../support":94}],93:[function(require,module,exports){
...
},{"../internal/baseToString":47}],94:[function(require,module,exports){
(function (global){
...
},{"./lang/isNative":85}],95:[function(require,module,exports){
