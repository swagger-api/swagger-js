...
"use strict";var OperationGroup=module.exports=function(t,i,o,r,s){this.description=o,this.externalDocs=r,this.name=t,this.operation=s,this.operationsArray=[],this.path=t,this.tag=t,this.tagOrder=i};OperationGroup.prototype.sort=function(){};
