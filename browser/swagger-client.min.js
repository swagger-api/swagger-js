...
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,t,o,r){var i=t,s=o,n=r;"function"==typeof t&&(i=null,s=t,n=o);var l=i;this.scope=n||this,this.iteration=this.iteration||0;var f,a,p,h,v=0,c={},u={},y=[];for(f in e.definitions){var d=e.definitions[f];for(h in d.properties)p=d.properties[h],this.resolveTo(i,p,y,"/definitions")}for(f in e.paths){var g,b,O;a=e.paths[f];for(g in a)if("$ref"===g){var k=a[g];R=k.indexOf("#")>0?k.split("#")[1]:0===k.indexOf("http://")||0===k.indexOf("https://")?"":"/paths"+f,this.resolveInline(i,e,a,y,u,R)}else{b=a[g];var x,j=b.parameters;for(x in j){var m=j[x],R="/paths"+f+"/"+g+"/parameters";"body"===m["in"]&&m.schema&&this.resolveTo(i,m.schema,y,R),m.$ref&&this.resolveInline(i,e,m,y,u,m.$ref)}for(O in b.responses){var A=b.responses[O],R=R="/paths"+f+"/"+g+"/responses/"+O;"object"==typeof A&&A.$ref&&this.resolveInline(i,e,A,y,u,R),A.schema&&A.schema.$ref&&this.resolveTo(i,A.schema,y,R)}}}for(var $=0,I=[],T=y,x=0;x<T.length;x++){var w=T[x];if(i===w.root)if("ref"===w.resolveAs){var H=((w.root||"")+"/"+w.key).split("/"),S=[],q="";if(w.key.indexOf("../")>=0){for(var z=0;z<H.length;z++)".."===H[z]?S=S.slice(0,S.length-1):S.push(H[z]);for(var J=0;J<S.length;J++)J>0&&(q+="/"),q+=S[J];w.root=q,I.push(w)}else{var N=w.key.split("#");if(2===N.length){(0===N[0].indexOf("http://")||0===N[0].indexOf("https://"))&&(w.root=N[0]);for(var Q,R=N[1].split("/"),B=e,J=0;J<R.length;J++){var C=R[J];if(""!==C){if(B=B[C],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&I.push(w)}}}else"inline"===w.resolveAs&&I.push(w);else I.push(w)}$=I.length;var D=0;for(D=0;D<I.length;D++){var E=I[D],F=this;if(null===E.root)F.resolveItem(e,l,y,c,u,E),v+=1,v==$&&this.finish(e,i,y,c,u,s);else{var G={useJQuery:!1,url:E.root,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){v+=1,u[E.key]=null,v===$&&F.finish(e,l,y,c,u,s)},response:function(t){var o=t.obj;if(null===o||0===Object.keys(o).length)try{o=JSON.parse(t.data)}catch(r){o={}}F.resolveItem(o,l,y,c,u,E),v+=1,v==$&&F.finish(e,l,y,c,u,s)}}};n&&n.clientAuthorizations&&n.clientAuthorizations.apply(G),(new SwaggerHttp).execute(G)}}0===Object.keys(I).length&&s.call(this.scope,e,u)},Resolver.prototype.resolveItem=function(e,t,o,r,i,s){for(var n=s.location,l=e,f=n.split("/"),a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key,f=s.key.split("/"),v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?r[h]={name:v,obj:l,key:s.key,root:s.root}:i[h]=null},Resolver.prototype.finish=function(e,t,o,r,i,s){var n;for(n in o){var l=o[n],f=l.key,a=r[f];if(a)if(e.definitions=e.definitions||{},"ref"===l.resolveAs)e.definitions[a.name]=a.obj,l.obj.$ref="#/definitions/"+a.name;else if("inline"===l.resolveAs){var p=l.obj;delete p.$ref;for(f in a.obj){var h=this.retainRoot(a.obj[f]);p[f]=h}}}2===this.iteration?s.call(this.scope,e,i):(this.iteration+=1,this.resolve(e,t,s,this.scope))},Resolver.prototype.retainRoot=function(e,t){for(var o in e){var r=e[o];"$ref"===o&&"string"==typeof r?0!=r.indexOf("http://")&&0!=r.indexOf("https://")&&(0!==r.indexOf("#")&&(r="#"+r),r=(t||"")+r,e[o]=r):"object"==typeof r&&this.retainRoot(r,t)}return e},Resolver.prototype.countRefs=function(e,t){t=t||0;for(var o in e){var r=e[o];"$ref"===o&&"string"==typeof r?t+=1:"object"==typeof r&&(t+=this.countRefs(r))}return t},Resolver.prototype.resolveInline=function(e,t,o,r,i,s){var n=o.$ref;n?(n.indexOf("#")>=0&&(s=n.split("#")[1]),0===n.indexOf("http")?(n.indexOf("#")>=0?(e=n.split("#")[0],s=n.split("#")[1]):e=n,r.push({obj:o,resolveAs:"inline",root:e,key:n,location:s})):r.push(0===n.indexOf("#")?{obj:o,resolveAs:"inline",root:e,key:n,location:s}:{obj:o,resolveAs:"inline",root:e,key:n,location:s})):"array"===o.type&&this.resolveTo(e,o.items,r,s)},Resolver.prototype.resolveTo=function(e,t,o,r){var i=t.$ref;if(i)i.indexOf("#")>=0&&(r=i.split("#")[1]),o.push({obj:t,resolveAs:"ref",root:e,key:i,location:r});else if("array"===t.type){var s=t.items;this.resolveTo(e,s,o,r)}};
