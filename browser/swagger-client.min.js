...
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,r,o,i){var t=r,s=o,n=i;"function"==typeof r&&(t=null,s=r,n=o),this.scope=n||this,this.iteration=this.iteration||0;var l,a,f,h,p,v=0,y={},c={},u={};for(a in e.definitions){var d=e.definitions[a];for(p in d.properties)h=d.properties[p],this.resolveTo(t,h,u)}for(a in e.paths){var g,b,A;f=e.paths[a];for(g in f)if("$ref"===g)this.resolveInline(t,e,f,u,c);else{b=f[g];var j,m=b.parameters;for(j in m){var k=m[j];"body"===k["in"]&&k.schema&&this.resolveTo(t,k.schema,u),k.$ref&&this.resolveInline(t,e,k,u,c)}for(A in b.responses){var $=b.responses[A];"object"==typeof $&&$.$ref&&this.resolveInline(t,e,$,u,c),$.schema&&$.schema.$ref&&this.resolveTo(t,$.schema,u)}}}var O,x={},R=0;for(a in u){var T=a.split("#");if(0===a.indexOf("http"))2===T.length?(l=T[0],f=T[1],Array.isArray(x[l])||(x[l]=[],R+=1),x[l].push({path:f,key:a})):(Array.isArray(x[a])||(x[a]=[],R+=1),x[a].push(null));else if(O=u[a],O.length>1)console.log("more than one match!");else if(O=O[0],O.root){if(0===a.indexOf("/")){var w=O.root.split("//");if(w.length>1){var I=w[1].split("/");l=w[0]+"//"+I[0]}O.root=l}T=a.split("#"),T.length>1?(l+=T[0],f=T[1]):(l=O.root,f=O.obj.$ref),Array.isArray(x[l])||(x[l]=[],R+=1),x[l].push({path:f,key:O.key})}}for(a in x){var H=this,S=x[a];l=a;var q={useJQuery:!1,url:l,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){v+=1;var r;for(r=0;r<S.length;r++){var o=l+"#"+S[r];c[o]=null}v===R&&H.finish(e,t,u,y,c,s)},response:function(r){var o,i,n=r.obj;if(null===n||0===Object.keys(n).length)try{n=JSON.parse(r.data)}catch(f){n={}}for(v+=1,o=0;o<S.length;o++)if(null===S[o])y[a]={name:a,obj:n};else{var h=S[o].path,p=n,d=h.split("/");for(i=0;i<d.length;i++){var g=d[i];if(-1!==g.indexOf("~1")&&(g=d[i].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==g.charAt(0)&&(g="/"+g)),"undefined"==typeof p)break;g.length>0&&(p=p[g])}var b=l+"#"+h,A=d[i-1];"undefined"!=typeof p?y[b]={name:A,obj:p,key:S.key}:c[b]=null}v===R&&H.finish(e,t,u,y,c,s)}}};n&&n.clientAuthorizations&&n.clientAuthorizations.apply(q),(new SwaggerHttp).execute(q)}0===Object.keys(x).length&&s.call(this.scope,e,c)},Resolver.prototype.finish=function(e,r,o,i,t,s){var n;for(n in o){var l,a=o[n];for(l=0;l<a.length;l++){var f=a[l].key;0!==f.indexOf("http")&&(f=a[l].root+f);var h=i[f];if(h)if(e.definitions=e.definitions||{},"$ref"===a[l].resolveAs)e.definitions[h.name]=h.obj,a[l].obj.$ref="#/definitions/"+h.name;else if("inline"===a[l].resolveAs){var p=a[l].obj;delete p.$ref;for(f in h.obj)p[f]=h.obj[f]}}}2===this.iteration?s.call(this.scope,e,t):(this.iteration+=1,this.resolve(e,r,s,this.scope))},Resolver.prototype.resolveInline=function(e,r,o,i,t){var s=o.$ref;if(s)if(0===s.indexOf("http"))i[s]=i[s]||[],i[s]=[{obj:o,resolveAs:"inline",root:e,key:s}];else if(0===s.indexOf("#")){var n,l=s.substring(1),a=l.split("/"),f=r;for(n=0;n<a.length;n++){var h=a[n];h.length>0&&(f=f[h])}if(f){delete o.$ref;var p;for(p in f)o[p]=f[p]}else t[s]=null}else Array.isArray(i[s])?i[s].push({obj:o,resolveAs:"inline",root:e,key:s}):i[s]=[{obj:o,resolveAs:"inline",root:e,key:s}];else"array"===o.type&&this.resolveTo(e,o.items,i)},Resolver.prototype.resolveTo=function(e,r,o){var i=r.$ref;if(i)0===i.indexOf("http")&&(Array.isArray(o[i])?o[i].push({obj:r,resolveAs:"$ref",root:e,key:i}):o[i]=[{obj:r,resolveAs:"$ref",root:e,key:i}]);else if("array"===r.type){var t=r.items;this.resolveTo(e,t,o)}};
