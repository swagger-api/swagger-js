...
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,r,o){this.scope=o||this;var i,s,n,t,l,a=0,f={},v={},p={};for(s in e.definitions){var h=e.definitions[s];for(l in h.properties)t=h.properties[l],this.resolveTo(t,p)}for(s in e.paths){var c,u,g;n=e.paths[s];for(c in n)if("$ref"===c){{n[c]}this.resolveInline(e,n,p,v)}else{u=n[c];var d,y=u.parameters;for(d in y){var b=y[d];"body"===b["in"]&&b.schema&&this.resolveTo(b.schema,p),b.$ref&&this.resolveInline(e,b,p,v)}for(g in u.responses){var A=u.responses[g];A.schema&&this.resolveTo(A.schema,p)}}}var j={},m=0;for(s in p){var $=s.split("#");2===$.length&&(i=$[0],n=$[1],Array.isArray(j[i])||(j[i]=[],m+=1),j[i].push(n))}for(s in j){var x=this,R=j[s];i=s;var T={useJQuery:!1,url:i,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){a+=1;var o;for(o=0;o<R.length;o++){var s=i+"#"+R[o];v[s]=null}a===m&&x.finish(e,p,f,v,r)},response:function(o){var s,n,t=o.obj;for(a+=1,s=0;s<R.length;s++){var l=t,h=R[s],c=h.split("/");for(n=0;n<c.length;n++){var u=c[n];if(-1!==u.indexOf("~1")&&(u=c[n].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==u.charAt(0)&&(u="/"+u)),"undefined"==typeof l)break;u.length>0&&(l=l[u],console.log("looking for "+u+" in "),l&&console.log("found!"),console.log(l))}console.log("location: "+l);var g=i+"#"+h,d=c[n-1];"undefined"!=typeof l?f[g]={name:d,obj:l}:v[g]=null}a===m&&x.finish(e,p,f,v,r)}}};o&&o.clientAuthorizations&&o.clientAuthorizations.apply(T),(new SwaggerHttp).execute(T)}0===Object.keys(j).length&&r.call(this.scope,e,v)},Resolver.prototype.finish=function(e,r,o,i,s){var n;for(n in r){var t,l=r[n];for(t=0;t<l.length;t++){var a=o[l[t].obj.$ref];if(a)if(e.definitions||(e.definitions={}),"$ref"===l[t].resolveAs)e.definitions[a.name]=a.obj,l[t].obj.$ref="#/definitions/"+a.name;else if("inline"===l[t].resolveAs){var f,v=l[t].obj;delete v.$ref;for(f in a.obj)v[f]=a.obj[f]}}}s.call(this.scope,e,i)},Resolver.prototype.resolveInline=function(e,r,o,i){var s=r.$ref;if(s){if(0===s.indexOf("http"))Array.isArray(o[s])?o[s].push({obj:r,resolveAs:"inline"}):o[s]=[{obj:r,resolveAs:"inline"}];else if(0===s.indexOf("#")){var n,t=s.substring(1),l=t.split("/"),a=e;for(n=0;n<l.length;n++){var f=l[n];f.length>0&&(a=a[f])}if(a){delete r.$ref;var v;for(v in a)r[v]=a[v]}else i[s]=null}}else"array"===r.type&&this.resolveTo(r.items,o)},Resolver.prototype.resolveTo=function(e,r){var o=e.$ref;if(o)0===o.indexOf("http")&&(Array.isArray(r[o])?r[o].push({obj:e,resolveAs:"$ref"}):r[o]=[{obj:e,resolveAs:"$ref"}]);else if("array"===e.type){var i=e.items;this.resolveTo(i,r)}};
