...
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){this.failedUrls=[]};Resolver.prototype.processAllOf=function(e,o,i,r,t,s){var n,l,f;i["x-resolved-from"]=["#/definitions/"+o];var a=i.allOf;for(a.sort(function(e,o){return e.$ref&&o.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+o+"/allOf",this.resolveInline(e,s,f,r,t,l)},Resolver.prototype.resolve=function(e,o,i,r){this.spec=e;var t,s,n=o,l=i,f=r,a={};"function"==typeof o&&(n=null,l=o,f=i);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,y={},g={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var m=e.definitions[h];for(d in m.properties)c=m.properties[d],_.isArray(c.allOf)?this.processAllOf(n,h,c,O,g,e):this.resolveTo(n,c,O,"/definitions");m.allOf&&this.processAllOf(n,h,m,O,g,e)}for(h in e.paths){var x,b,k;v=e.paths[h];for(x in v)if("$ref"===x)t="/paths"+h,this.resolveInline(n,e,v,O,g,t);else{b=v[x];var A=v.parameters||[],j=b.parameters||[];for(s in A){var R=A[s];j.unshift(R)}"parameters"!==x&&_.isObject(b)&&(b.parameters=b.parameters||j);for(s in j){var R=j[s];if(t="/paths"+h+"/"+x+"/parameters","body"===R["in"]&&R.schema)if(_.isArray(R.schema.allOf)){for(var $="inline_model",h=$,w=!1,I=0;!w;){if("undefined"==typeof e.definitions[h]){w=!0;break}h=$+"_"+I,I++}e.definitions[h]={allOf:R.schema.allOf},delete R.schema.allOf,R.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,g,e)}else this.resolveTo(n,R.schema,O,t);R.$ref&&this.resolveInline(n,e,R,O,g,R.$ref)}for(k in b.responses){var q=b.responses[k];if(t="/paths"+h+"/"+x+"/responses/"+k,_.isObject(q)&&(q.$ref&&this.resolveInline(n,e,q,O,g,t),q.schema)){var T=q;if(_.isArray(T.schema.allOf)){for(var $="inline_model",h=$,w=!1,I=0;!w;){if("undefined"==typeof e.definitions[h]){w=!0;break}h=$+"_"+I,I++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,g,e)}else this.resolveTo(n,q.schema,O,t)}}}v.parameters=[]}var D,U=0,S=[],H=O;for(s=0;s<H.length;s++){var P=H[s];if(n===P.root){if("ref"===P.resolveAs){var z,N=((P.root||"")+"/"+P.key).split("/"),E=[],J="";if(P.key.indexOf("../")>=0){for(var Q=0;Q<N.length;Q++)".."===N[Q]?E=E.slice(0,E.length-1):E.push(N[Q]);for(z=0;z<E.length;z++)z>0&&(J+="/"),J+=E[z];P.root=J,S.push(P)}else if(D=P.key.split("#"),2===D.length){(0===D[0].indexOf("http://")||0===D[0].indexOf("https://"))&&(P.root=D[0]),t=D[1].split("/");var B,C=e;for(z=0;z<t.length;z++){var F=t[z];if(""!==F){if(C=C[F],"undefined"==typeof C){B=null;break}B=C}}null===B&&S.push(P)}}else if("inline"===P.resolveAs){if(P.key&&-1===P.key.indexOf("#")&&"/"!==P.key.charAt(0)){for(D=P.root.split("/"),t="",s=0;s<D.length-1;s++)t+=D[s]+"/";t+=P.key,P.root=t,P.location=""}S.push(P)}}else S.push(P)}U=S.length;for(var G=0;G<S.length;G++)!function(e,o,i){if(null===e.root||e.root===n)i.resolveItem(o,p,O,y,g,e),u+=1,u===U&&i.finish(o,n,O,y,g,l,!0);else if(-1===i.failedUrls.indexOf(e.root)){var r={useJQuery:!1,url:e.root,method:"get",headers:{accept:i.scope.swaggerRequestHeaders||"application/json"},on:{error:function(t){u+=1,console.log("failed url: "+r.url),i.failedUrls.push(r.url),g[e.key]={root:e.root,location:e.location},u===U&&i.finish(o,p,O,y,g,l)},response:function(r){var t=r.obj;i.resolveItem(t,e.root,O,y,g,e),u+=1,u===U&&i.finish(o,p,O,y,g,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(r),(new SwaggerHttp).execute(r,a)}else console.log("skipping "+e.root),u+=1,g[e.key]={root:e.root,location:e.location},u===U&&i.finish(o,p,O,y,g,l)}(S[G],e,this);0===Object.keys(S).length&&this.finish(e,p,O,y,g,l)},Resolver.prototype.resolveItem=function(e,o,i,r,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?r[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,o,i,r,t,s,n){var l;for(l in i){var f=i[l],a=f.key,p=r[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj)var h=this.retainRoot(p.obj[a],f.root);e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(p.obj[a],f.root)),v[a]=h}}}var c=this.countUnresolvedRefs(e);0===c||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,o,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var o,i=this.getRefs(e),r=[],t=[];for(o in i)0===o.indexOf("#")?r.push(o.substring(1)):t.push(o);for(o=0;o<r.length;o++)for(var s=r[o],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,o){o=o||e;var i={};for(var r in o)if(o.hasOwnProperty(r)){var t=o[r];if("$ref"===r&&"string"==typeof t)i[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)i[n]=null}}return i},Resolver.prototype.retainRoot=function(e,o){for(var i in e){var r=e[i];if("$ref"===i&&"string"==typeof r){if(0!==r.indexOf("http://")&&0!==r.indexOf("https://")){var t=!0;if(o){var s=o.slice(-1);if("/"!==s&&0!==r.indexOf("#")&&0!==r.indexOf("http://")&&r.indexOf("https://")){console.log("working with "+r),t=!1;var n=o.split("/");n=n.splice(0,n.length-1),o="";for(var l=0;l<n.length;l++)o+=n[l]+"/"}}0!==r.indexOf("#")&&t&&(r="#"+r),r=(o||"")+r,e[i]=r}}else _.isObject(r)&&this.retainRoot(r,o)}return e},Resolver.prototype.resolveInline=function(e,o,i,r,t,s){var n,l,f,a,p=i.$ref,h=i.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=a[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),r.push({obj:i,resolveAs:"inline",root:e,key:p,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],r.push({obj:i,resolveAs:"inline",root:e,key:p,location:s})):r.push({obj:i,resolveAs:"inline",root:e,key:p,location:s})}else"array"===i.type&&this.resolveTo(e,i.items,r,s)},Resolver.prototype.resolveTo=function(e,o,i,r){var t,s,n=o.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}r=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,r="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,r=""}i.push({obj:o,resolveAs:"ref",root:l,key:n,location:r})}else if("array"===o.type){var a=o.items;this.resolveTo(e,a,i,r)}else if(o&&o.properties){var p=this.uniqueName("inline_model");this.spec.definitions[p]=_.cloneDeep(o),o.$ref="#/definitions/"+p,delete o.type,delete o.properties}},Resolver.prototype.uniqueName=function(e){for(var o=e,i=0;;){if(!_.isObject(this.spec.definitions[o]))return o;o=e+"_"+i,i++}},Resolver.prototype.resolveAllOf=function(e,o,i){i=i||0,o=o||e;var r;for(var t in o)if(o.hasOwnProperty(t)){var s=o[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+o+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,i+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(r in v){l.properties[r]=_.cloneDeep(v[r]);var c=v[r]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=p),l.properties[r]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(a[h]),u=0;u<d.length;++u)for(var y=u+1;y<d.length;++y)d[u]===d[y]&&d.splice(y--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(r in l[h])l[h][r]["x-resolved-from"]=p}o[t]=l}}_.isObject(s)&&this.resolveAllOf(e,s,i+1)}};
