...
"use strict";var _={forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined"),keys:require("lodash-compat/object/keys"),map:require("lodash-compat/collection/map")},helpers=require("../helpers"),applyParameterMacro=function(e,i){return e.api&&e.api.parameterMacro?e.api.parameterMacro(e,i):i.defaultValue},applyModelPropertyMacro=function(e,i){return e.api&&e.api.modelPropertyMacro?e.api.modelPropertyMacro(e,i):i["default"]},Model=module.exports=function(e,i,t){return this.definition=i||{},this.isArray="array"===i.type,this.models=t||{},this.name=e||"Inline Model",this},schemaToHTML=function(e,i,t){for(var n='<span class="strong">',r="</span>",s={},a=[],o=0,p=function(e,i,n){var r,a=i;return e.$ref?(a=helpers.simpleRef(e.$ref),r=t[a]):_.isUndefined(i)&&(a="Inline Model "+ ++o,r=new Model(a,e,t)),n!==!0&&(s[a]=_.isUndefined(r)?{}:r.definition),a},l=function(e){var i='<span class="propType">',t=e.type||"object";return e.$ref?i+=p(e,helpers.simpleRef(e.$ref)):"object"===t?i+=p(e):"array"===t?(i+="Array[",_.isArray(e.items)?i+=_.map(e.items,p).join(","):_.isPlainObject(e.items)?i+=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?p(e.items):e.items.type:p(e.items,helpers.simpleRef(e.items.$ref)):(helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),i+=p({})),i+="]"):i+=e.type,i+="</span>"},m=function(e,i){var t="",n=e.type||"object",r="array"===n;switch(r&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),e["default"]&&(t+=helpers.optionHtml("Default",e["default"])),n){case"string":e.minLength&&(t+=helpers.optionHtml("Min. Length",e.minLength)),e.maxLength&&(t+=helpers.optionHtml("Max. Length",e.maxLength)),e.pattern&&(t+=helpers.optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(t+=helpers.optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(t+=helpers.optionHtml("Exclusive Min.","true")),e.maximum&&(t+=helpers.optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(t+=helpers.optionHtml("Exclusive Max.","true")),e.multipleOf&&(t+=helpers.optionHtml("Multiple Of",e.multipleOf))}if(r&&(e.minItems&&(t+=helpers.optionHtml("Min. Items",e.minItems)),e.maxItems&&(t+=helpers.optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(t+=helpers.optionHtml("Unique Items","true")),e.collectionFormat&&(t+=helpers.optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var s;s="number"===n||"integer"===n?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',t+=helpers.optionHtml("Enum",s)}return t.length>0&&(i='<span class="propWrap">'+i+'<table class="optionsWrapper"><tr><th colspan="2">'+n+"</th></tr>"+t+"</table></span>"),i},c=function(e,i){var t=e.type||"object",s="array"===e.type,o=n+i+" "+(s?"[":"{")+r;return i&&a.push(i),s?_.isArray(e.items)?o+="<div>"+_.map(e.items,function(e){var i=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],i)>-1?p(e):m(e,i):p(e,helpers.simpleRef(e.$ref))}).join(",</div><div>"):_.isPlainObject(e.items)?o+=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?"<div>"+p(e.items)+"</div>":"<div>"+m(e.items,e.items.type)+"</div>":"<div>"+p(e.items,helpers.simpleRef(e.items.$ref))+"</div>":(helpers.log("Array type's 'items' property is not an array or an object, cannot process"),o+="<div>"+p({},void 0,!0)+"</div>"):e.$ref?o+="<div>"+p(e,i)+"</div>":"object"===t?(o+="<div>",_.isPlainObject(e.properties)&&(o+=_.map(e.properties,function(i,t){var n=_.indexOf(e.required||[],t)>-1,r='<span class="propName '+n+'">'+t+"</span> (";return r+=l(i),n||(r+=', <span class="propOptKey">optional</span>'),r+=")",_.isUndefined(i.description)||(r+=": "+i.description),i["enum"]&&(r+=' = <span class="propVals">[\''+i["enum"].join("' or '")+"']</span>"),m(i,r)}).join(",</div><div>")),o+="</div>"):o="<div>"+m(e,t)+"</div>",o+n+(s?"]":"}")+r},d=c(i,e);_.keys(s).length>0;)_.forEach(s,function(e,i){var t=_.indexOf(a,i)>-1;delete s[i],t||(a.push(i),d+="<br />"+c(e,i))});return d},schemaToJSON=function(e,i,t){var n,r,s=e.type||"object";return e.example?r=e.example:_.isUndefined(e.items)&&_.isArray(e["enum"])&&(r=e["enum"][0]),_.isUndefined(r)&&(e.$ref?(n=i[helpers.simpleRef(e.$ref)],_.isUndefined(n)||(_.isUndefined(t[n.name])?(t[n.name]=n,r=schemaToJSON(n.definition,i,t),delete t[n.name]):r="array"===n.type?[]:{})):e["default"]?r=e["default"]:"date-time"===s?r=(new Date).toISOString():"date"===s?r=(new Date).toISOString().split("T")[0]:"string"===s?r="string":"integer"===s?r=0:"long"===s?r=0:"float"===s?r=0:"double"===s?r=0:"boolean"===s?r=!0:"object"===s?(r={},_.forEach(e.properties,function(e,n){r[n]=schemaToJSON(e,i,t)})):"array"===s&&(r=[],_.isArray(e.items)?_.forEach(e.items,function(e){r.push(schemaToJSON(e,i,t))}):_.isPlainObject(e.items)?r.push(schemaToJSON(e.items,i,t)):_.isUndefined(e.items)?r.push({}):helpers.log("Array type's 'items' property is not an array or an object, cannot process"))),r};Model.prototype.createJSONSample=Model.prototype.getSampleValue=function(e){return e=e||{},e[this.name]=this,this.examples&&_.isPlainObject(this.examples)&&this.examples["application/json"]?(this.definition.example=this.examples["application/json"],_.isString(this.definition.example)&&(this.definition.example=JSON.parse(this.definition.example))):this.definition.example=this.examples,schemaToJSON(this.definition,this.models,e)},Model.prototype.getMockSignature=function(){return schemaToHTML(this.name,this.definition,this.models)};
