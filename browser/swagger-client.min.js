...
},{"_process":16,"lodash-compat/lang/isPlainObject":141}],5:[function(require,module,exports){
"use strict";function isParseable(e){return"string"!=typeof e?!1:(e=e.trim().toLowerCase(),e.match(/[+\/]ya?ml$/)?!0:e.match(/[+\/]json$/)?!0:!1)}var helpers=require("./helpers"),jQuery=require("jquery"),request=require("superagent"),jsyaml=require("js-yaml"),JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),(e&&e.useJQuery===!0||this.isInternetExplorer())&&(r=new JQueryHttpClient(t));var s=e.on.response,n=function(e){t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),s(e)};e.on.response=function(e){n(e)},e&&"object"==typeof e.body&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),r.execute(e)},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=e.on,r=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var s={},n=e.getAllResponseHeaders().split("\n"),o=0;o<n.length;o++){var a=n[o].trim();if(0!==a.length){var u=a.indexOf(":");if(-1!==u){var p=a.substring(0,u).trim(),i=a.substring(u+1).trim();s[p]=i}else s[a]=null}}var l={url:r.url,method:r.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:s},d=s["content-type"]||s["Content-Type"]||null;if(d&&(0===d.indexOf("application/json")||d.indexOf("+json")>0))try{l.obj=e.responseJSON||JSON.parse(l.data)||{}}catch(y){helpers.log("unable to parse JSON content")}if(l.obj=l.obj||null,e.status>=200&&e.status<300)t.response(l);else{if(!(0===e.status||e.status>=400&&e.status<599))return t.response(l);t.error(l)}},jQuery.support.cors=!0,jQuery.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},n=request[t](e.url),o=s.accept||s.Accept;for(r in s)n.set(r,s[r]);e.body&&n.send(e.body),isParseable(o)&&n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var s,n={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error)n.obj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,s=e.on.error;else if(r&&e.on&&e.on.response){var o;if(r.body&&Object.keys(r.body).length>0)o=r.body;else{var a=r.headers["content-type"]||r.headers["Content-Type"];if(r.text&&isParseable(a))try{o=jsyaml.safeLoad(r.text)}catch(u){helpers.log("Cannot parse JSON/YAML content")}}n.obj=o||null,n.status=r.status,n.statusText=r.text,s=e.on.response}n.data=n.statusText,s&&s(n)})};


},{"./helpers":4,"jquery":19,"js-yaml":20,"superagent":153}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,r,i){this.scope=i||this,this.iteration=this.iteration||0;var s,o,t,n,a,l=0,f={},h={},v={};for(o in e.definitions){var p=e.definitions[o];for(a in p.properties)n=p.properties[a],this.resolveTo(n,v)}for(o in e.paths){var c,u,y;t=e.paths[o];for(c in t)if("$ref"===c)this.resolveInline(e,t,v,h);else{u=t[c];var d,g=u.parameters;for(d in g){var b=g[d];"body"===b["in"]&&b.schema&&this.resolveTo(b.schema,v),b.$ref&&this.resolveInline(e,b,v,h)}for(y in u.responses){var A=u.responses[y];"object"==typeof A&&A.$ref&&this.resolveInline(e,A,v,h),A.schema&&A.schema.$ref&&this.resolveTo(A.schema,v)}}}var j={},m=0;for(o in v){var $=o.split("#");2===$.length?(s=$[0],t=$[1],Array.isArray(j[s])||(j[s]=[],m+=1),j[s].push(t)):(Array.isArray(j[o])||(j[o]=[],m+=1),j[o].push(null))}for(o in j){var x=this,R=j[o];s=o;var T={useJQuery:!1,url:s,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){l+=1;var i;for(i=0;i<R.length;i++){var o=s+"#"+R[i];h[o]=null}l===m&&x.finish(e,v,f,h,r)},response:function(i){var t,n,a=i.obj||{};for(l+=1,t=0;t<R.length;t++){var p=R[t];if(null===p)f[o]={name:o,obj:a};else{var c=a,u=p.split("/");for(n=0;n<u.length;n++){var y=u[n];if(-1!==y.indexOf("~1")&&(y=u[n].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==y.charAt(0)&&(y="/"+y)),"undefined"==typeof c)break;y.length>0&&(c=c[y])}var d=s+"#"+p,g=u[n-1];"undefined"!=typeof c?f[d]={name:g,obj:c}:h[d]=null}}l===m&&x.finish(e,v,f,h,r)}}};i&&i.clientAuthorizations&&i.clientAuthorizations.apply(T),(new SwaggerHttp).execute(T)}0===Object.keys(j).length&&r.call(this.scope,e,h)},Resolver.prototype.finish=function(e,r,i,s,o){var t;for(t in r){var n,a=r[t];for(n=0;n<a.length;n++){var l=i[a[n].obj.$ref];if(l)if(e.definitions||(e.definitions={}),"$ref"===a[n].resolveAs)e.definitions[l.name]=l.obj,a[n].obj.$ref="#/definitions/"+l.name;else if("inline"===a[n].resolveAs){var f,h=a[n].obj;delete h.$ref;for(f in l.obj)h[f]=l.obj[f]}}}2===this.iteration?o.call(this.scope,e,s):(this.iteration+=1,this.resolve(e,o,this.scope))},Resolver.prototype.resolveInline=function(e,r,i,s){var o=r.$ref;if(o){if(0===o.indexOf("http"))Array.isArray(i[o])?i[o].push({obj:r,resolveAs:"inline"}):i[o]=[{obj:r,resolveAs:"inline"}];else if(0===o.indexOf("#")){var t,n=o.substring(1),a=n.split("/"),l=e;for(t=0;t<a.length;t++){var f=a[t];f.length>0&&(l=l[f])}if(l){delete r.$ref;var h;for(h in l)r[h]=l[h]}else s[o]=null}}else"array"===r.type&&this.resolveTo(r.items,i)},Resolver.prototype.resolveTo=function(e,r){var i=e.$ref;if(i)0===i.indexOf("http")&&(Array.isArray(r[i])?r[i].push({obj:e,resolveAs:"$ref"}):r[i]=[{obj:e,resolveAs:"$ref"}]);else if("array"===e.type){var s=e.items;this.resolveTo(s,r)}};
...
"use strict";var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined"),keys:require("lodash-compat/object/keys"),map:require("lodash-compat/collection/map")},helpers=require("../helpers"),jsyaml=require("js-yaml"),Model=module.exports=function(e,i,t,n){return this.definition=i||{},this.isArray="array"===i.type,this.models=t||{},this.name=i.title||e||"Inline Model",this.modelPropertyMacro=n||function(e){return e["default"]},this},schemaToHTML=function(e,i,t,n){var s='<span class="strong">',r="</span>",a={},o=[],p=0,l=function(e,i,s){var r,o=i;return e.$ref?(o=e.title||helpers.simpleRef(e.$ref),r=t[o]):_.isUndefined(i)&&(o=e.title||"Inline Model "+ ++p,r=new Model(o,e,t,n)),s!==!0&&(a[o]=_.isUndefined(r)?{}:r.definition),o},m=function(e){var i='<span class="propType">',t=e.type||"object";return e.$ref?i+=l(e,helpers.simpleRef(e.$ref)):"object"===t?i+=_.isUndefined(e.properties)?"object":l(e):"array"===t?(i+="Array[",_.isArray(e.items)?i+=_.map(e.items,l).join(","):_.isPlainObject(e.items)?i+=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?l(e.items):e.items.type:l(e.items,helpers.simpleRef(e.items.$ref)):(helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),i+="object"),i+="]"):i+=e.type,i+="</span>"},d=function(e,i){var t="",n=e.type||"object",s="array"===n;switch(s&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e["default"])||(t+=helpers.optionHtml("Default",e["default"])),n){case"string":e.minLength&&(t+=helpers.optionHtml("Min. Length",e.minLength)),e.maxLength&&(t+=helpers.optionHtml("Max. Length",e.maxLength)),e.pattern&&(t+=helpers.optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(t+=helpers.optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(t+=helpers.optionHtml("Exclusive Min.","true")),e.maximum&&(t+=helpers.optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(t+=helpers.optionHtml("Exclusive Max.","true")),e.multipleOf&&(t+=helpers.optionHtml("Multiple Of",e.multipleOf))}if(s&&(e.minItems&&(t+=helpers.optionHtml("Min. Items",e.minItems)),e.maxItems&&(t+=helpers.optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(t+=helpers.optionHtml("Unique Items","true")),e.collectionFormat&&(t+=helpers.optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var r;r="number"===n||"integer"===n?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',t+=helpers.optionHtml("Enum",r)}return t.length>0&&(i='<span class="propWrap">'+i+'<table class="optionsWrapper"><tr><th colspan="2">'+n+"</th></tr>"+t+"</table></span>"),i},c=function(e,i){var a=e.type||"object",p="array"===e.type,c=s+i+" "+(p?"[":"{")+r;return i&&o.push(i),p?_.isArray(e.items)?c+="<div>"+_.map(e.items,function(e){var i=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],i)>-1?"object"===i&&_.isUndefined(e.properties)?"object":l(e):d(e,i):l(e,helpers.simpleRef(e.$ref))}).join(",</div><div>"):_.isPlainObject(e.items)?c+=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"<div>object</div>":"<div>"+l(e.items)+"</div>":"<div>"+d(e.items,e.items.type)+"</div>":"<div>"+l(e.items,helpers.simpleRef(e.items.$ref))+"</div>":(helpers.log("Array type's 'items' property is not an array or an object, cannot process"),c+="<div>object</div>"):e.$ref?c+="<div>"+l(e,i)+"</div>":"object"===a?(c+="<div>",_.isPlainObject(e.properties)&&(c+=_.map(e.properties,function(i,s){var r,a=_.indexOf(e.required,s)>=0,o=_.cloneDeep(i),p=a?"required":"",l='<span class="propName '+p+'">'+s+"</span> (";return o["default"]=n(o),o=helpers.resolveSchema(o),_.isUndefined(o.$ref)||(r=t[helpers.simpleRef(o.$ref)],_.isUndefined(r)||-1!==_.indexOf([void 0,"array","object"],r.definition.type)||(o=helpers.resolveSchema(r.definition))),l+=m(o),a||(l+=', <span class="propOptKey">optional</span>'),l+=")",_.isUndefined(o.description)||(l+=": "+o.description),o["enum"]&&(l+=' = <span class="propVals">[\''+o["enum"].join("', '")+"']</span>"),d(o,l)}).join(",</div><div>")),c+="</div>"):c="<div>"+d(e,a)+"</div>",c+s+(p?"]":"}")+r};i=helpers.resolveSchema(i);for(var f=c(i,e);_.keys(a).length>0;)_.forEach(a,function(e,i){var t=_.indexOf(o,i)>-1;delete a[i],t||(o.push(i),f+="<br />"+c(e,i))});return f},schemaToJSON=function(e,i,t,n){e=helpers.resolveSchema(e);var s,r,a=e.type||"object",o=e.format;return e.example?r=e.example:_.isUndefined(e.items)&&_.isArray(e["enum"])&&(r=e["enum"][0]),_.isUndefined(r)&&(e.$ref?(s=i[helpers.simpleRef(e.$ref)],_.isUndefined(s)||(_.isUndefined(t[s.name])?(t[s.name]=s,r=schemaToJSON(s.definition,i,t,n),delete t[s.name]):r="array"===s.type?[]:{})):_.isUndefined(e["default"])?"string"===a?r="date-time"===o?(new Date).toISOString():"date"===o?(new Date).toISOString().split("T")[0]:"string":"integer"===a?r=0:"number"===a?r=0:"boolean"===a?r=!0:"object"===a?(r={},_.forEach(e.properties,function(e,s){var a=_.cloneDeep(e);a["default"]=n(e),r[s]=schemaToJSON(a,i,t,n)})):"array"===a&&(r=[],_.isArray(e.items)?_.forEach(e.items,function(e){r.push(schemaToJSON(e,i,t,n))}):_.isPlainObject(e.items)?r.push(schemaToJSON(e.items,i,t,n)):_.isUndefined(e.items)?r.push({}):helpers.log("Array type's 'items' property is not an array or an object, cannot process")):r=e["default"]),r};Model.prototype.createJSONSample=Model.prototype.getSampleValue=function(e){return e=e||{},e[this.name]=this,this.examples&&_.isPlainObject(this.examples)&&this.examples["application/json"]?(this.definition.example=this.examples["application/json"],_.isString(this.definition.example)&&(this.definition.example=jsyaml.safeLoad(this.definition.example))):this.definition.example||(this.definition.example=this.examples),schemaToJSON(this.definition,this.models,e,this.modelPropertyMacro)},Model.prototype.getMockSignature=function(){return schemaToHTML(this.name,this.definition,this.models,this.modelPropertyMacro)};


},{"../helpers":4,"js-yaml":20,"lodash-compat/array/indexOf":51,"lodash-compat/collection/forEach":55,"lodash-compat/collection/map":56,"lodash-compat/lang/cloneDeep":135,"lodash-compat/lang/isArray":137,"lodash-compat/lang/isPlainObject":141,"lodash-compat/lang/isString":142,"lodash-compat/lang/isUndefined":144,"lodash-compat/object/keys":145}],9:[function(require,module,exports){
...
},{"../helpers":4,"../http":5,"./model":8,"lodash-compat/lang/cloneDeep":135,"lodash-compat/lang/isUndefined":144}],10:[function(require,module,exports){
...
"use strict";function compileStyleMap(e,t){var n,i,r,E,o,c,p;if(null===t)return{};for(n={},i=Object.keys(t),r=0,E=i.length;E>r;r+=1)o=i[r],c=String(t[o]),"!!"===o.slice(0,2)&&(o="tag:yaml.org,2002:"+o.slice(2)),p=e.compiledTypeMap[o],p&&_hasOwnProperty.call(p.styleAliases,c)&&(c=p.styleAliases[c]),n[o]=c;return n}function encodeHex(e){var t,n,i;if(t=e.toString(16).toUpperCase(),255>=e)n="x",i=2;else if(65535>=e)n="u",i=4;else{if(!(4294967295>=e))throw new YAMLException("code point within a string may not be greater than 0xFFFFFFFF");n="U",i=8}return"\\"+n+common.repeat("0",i-t.length)+t}function State(e){this.schema=e.schema||DEFAULT_FULL_SCHEMA,this.indent=Math.max(1,e.indent||2),this.skipInvalid=e.skipInvalid||!1,this.flowLevel=common.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=compileStyleMap(this.schema,e.styles||null),this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function indentString(e,t){for(var n,i=common.repeat(" ",t),r=0,E=-1,o="",c=e.length;c>r;)E=e.indexOf("\n",r),-1===E?(n=e.slice(r),r=c):(n=e.slice(r,E+1),r=E+1),n.length&&"\n"!==n&&(o+=i),o+=n;return o}function generateNextLine(e,t){return"\n"+common.repeat(" ",e.indent*t)}function testImplicitResolving(e,t){var n,i,r;for(n=0,i=e.implicitTypes.length;i>n;n+=1)if(r=e.implicitTypes[n],r.resolve(t))return!0;return!1}function StringBuilder(e){this.source=e,this.result="",this.checkpoint=0}function writeScalar(e,t,n){var i,r,E,o,c,p,s,l,u,A,a,C,_,d,S,f,h,R,m,g,N;if(0===t.length)return void(e.dump="''");if(-1!==DEPRECATED_BOOLEANS_SYNTAX.indexOf(t))return void(e.dump="'"+t+"'");for(i=!0,r=t.length?t.charCodeAt(0):0,E=CHAR_SPACE===r||CHAR_SPACE===t.charCodeAt(t.length-1),(CHAR_MINUS===r||CHAR_QUESTION===r||CHAR_COMMERCIAL_AT===r||CHAR_GRAVE_ACCENT===r)&&(i=!1),E?(i=!1,o=!1,c=!1):(o=!0,c=!0),p=!0,s=new StringBuilder(t),l=!1,u=0,A=0,a=e.indent*n,C=80,40>a?C-=a:C=40,d=0;d<t.length;d++){if(_=t.charCodeAt(d),i){if(simpleChar(_))continue;i=!1}p&&_===CHAR_SINGLE_QUOTE&&(p=!1),S=ESCAPE_SEQUENCES[_],f=needsHexEscape(_),(S||f)&&(_!==CHAR_LINE_FEED&&_!==CHAR_DOUBLE_QUOTE&&_!==CHAR_SINGLE_QUOTE?(o=!1,c=!1):_===CHAR_LINE_FEED&&(l=!0,p=!1,d>0&&(h=t.charCodeAt(d-1),h===CHAR_SPACE&&(c=!1,o=!1)),o&&(R=d-u,u=d,R>A&&(A=R))),_!==CHAR_DOUBLE_QUOTE&&(p=!1),s.takeUpTo(d),s.escapeChar())}if(i&&testImplicitResolving(e,t)&&(i=!1),m="",(o||c)&&(g=0,t.charCodeAt(t.length-1)===CHAR_LINE_FEED&&(g+=1,t.charCodeAt(t.length-2)===CHAR_LINE_FEED&&(g+=1)),0===g?m="-":2===g&&(m="+")),c&&C>A&&(o=!1),l||(c=!1),i)e.dump=t;else if(p)e.dump="'"+t+"'";else if(o)N=fold(t,C),e.dump=">"+m+"\n"+indentString(N,a);else if(c)m||(t=t.replace(/\n$/,"")),e.dump="|"+m+"\n"+indentString(t,a);else{if(!s)throw new Error("Failed to dump scalar value");s.finish(),e.dump='"'+s.result+'"'}}function fold(e,t){var n,i="",r=0,E=e.length,o=/\n+$/.exec(e);for(o&&(E=o.index+1);E>r;)n=e.indexOf("\n",r),n>E||-1===n?(i&&(i+="\n\n"),i+=foldLine(e.slice(r,E),t),r=E):(i&&(i+="\n\n"),i+=foldLine(e.slice(r,n),t),r=n+1);return o&&"\n"!==o[0]&&(i+=o[0]),i}function foldLine(e,t){if(""===e)return e;for(var n,i,r,E=/[^\s] [^\s]/g,o="",c=0,p=0,s=E.exec(e);s;)n=s.index,n-p>t&&(i=c!==p?c:n,o&&(o+="\n"),r=e.slice(p,i),o+=r,p=i+1),c=n+1,s=E.exec(e);return o&&(o+="\n"),o+=p!==c&&e.length-p>t?e.slice(p,c)+"\n"+e.slice(c+1):e.slice(p)}function simpleChar(e){return CHAR_TAB!==e&&CHAR_LINE_FEED!==e&&CHAR_CARRIAGE_RETURN!==e&&CHAR_COMMA!==e&&CHAR_LEFT_SQUARE_BRACKET!==e&&CHAR_RIGHT_SQUARE_BRACKET!==e&&CHAR_LEFT_CURLY_BRACKET!==e&&CHAR_RIGHT_CURLY_BRACKET!==e&&CHAR_SHARP!==e&&CHAR_AMPERSAND!==e&&CHAR_ASTERISK!==e&&CHAR_EXCLAMATION!==e&&CHAR_VERTICAL_LINE!==e&&CHAR_GREATER_THAN!==e&&CHAR_SINGLE_QUOTE!==e&&CHAR_DOUBLE_QUOTE!==e&&CHAR_PERCENT!==e&&CHAR_COLON!==e&&!ESCAPE_SEQUENCES[e]&&!needsHexEscape(e)}function needsHexEscape(e){return!(e>=32&&126>=e||133===e||e>=160&&55295>=e||e>=57344&&65533>=e||e>=65536&&1114111>=e)}function writeFlowSequence(e,t,n){var i,r,E="",o=e.tag;for(i=0,r=n.length;r>i;i+=1)writeNode(e,t,n[i],!1,!1)&&(0!==i&&(E+=", "),E+=e.dump);e.tag=o,e.dump="["+E+"]"}function writeBlockSequence(e,t,n,i){var r,E,o="",c=e.tag;for(r=0,E=n.length;E>r;r+=1)writeNode(e,t+1,n[r],!0,!0)&&(i&&0===r||(o+=generateNextLine(e,t)),o+="- "+e.dump);e.tag=c,e.dump=o||"[]"}function writeFlowMapping(e,t,n){var i,r,E,o,c,p="",s=e.tag,l=Object.keys(n);for(i=0,r=l.length;r>i;i+=1)c="",0!==i&&(c+=", "),E=l[i],o=n[E],writeNode(e,t,E,!1,!1)&&(e.dump.length>1024&&(c+="? "),c+=e.dump+": ",writeNode(e,t,o,!1,!1)&&(c+=e.dump,p+=c));e.tag=s,e.dump="{"+p+"}"}function writeBlockMapping(e,t,n,i){var r,E,o,c,p,s,l="",u=e.tag,A=Object.keys(n);for(r=0,E=A.length;E>r;r+=1)s="",i&&0===r||(s+=generateNextLine(e,t)),o=A[r],c=n[o],writeNode(e,t+1,o,!0,!0)&&(p=null!==e.tag&&"?"!==e.tag||e.dump&&e.dump.length>1024,p&&(s+=e.dump&&CHAR_LINE_FEED===e.dump.charCodeAt(0)?"?":"? "),s+=e.dump,p&&(s+=generateNextLine(e,t)),writeNode(e,t+1,c,!0,p)&&(s+=e.dump&&CHAR_LINE_FEED===e.dump.charCodeAt(0)?":":": ",s+=e.dump,l+=s));e.tag=u,e.dump=l||"{}"}function detectType(e,t,n){var i,r,E,o,c,p;for(r=n?e.explicitTypes:e.implicitTypes,E=0,o=r.length;o>E;E+=1)if(c=r[E],(c.instanceOf||c.predicate)&&(!c.instanceOf||"object"==typeof t&&t instanceof c.instanceOf)&&(!c.predicate||c.predicate(t))){if(e.tag=n?c.tag:"?",c.represent){if(p=e.styleMap[c.tag]||c.defaultStyle,"[object Function]"===_toString.call(c.represent))i=c.represent(t,p);else{if(!_hasOwnProperty.call(c.represent,p))throw new YAMLException("!<"+c.tag+'> tag resolver accepts not "'+p+'" style');i=c.represent[p](t,p)}e.dump=i}return!0}return!1}function writeNode(e,t,n,i,r){e.tag=null,e.dump=n,detectType(e,n,!1)||detectType(e,n,!0);var E=_toString.call(e.dump);i&&(i=0>e.flowLevel||e.flowLevel>t),(null!==e.tag&&"?"!==e.tag||2!==e.indent&&t>0)&&(r=!1);var o,c,p="[object Object]"===E||"[object Array]"===E;if(p&&(o=e.duplicates.indexOf(n),c=-1!==o),c&&e.usedDuplicates[o])e.dump="*ref_"+o;else{if(p&&c&&!e.usedDuplicates[o]&&(e.usedDuplicates[o]=!0),"[object Object]"===E)i&&0!==Object.keys(e.dump).length?(writeBlockMapping(e,t,e.dump,r),c&&(e.dump="&ref_"+o+(0===t?"\n":"")+e.dump)):(writeFlowMapping(e,t,e.dump),c&&(e.dump="&ref_"+o+" "+e.dump));else if("[object Array]"===E)i&&0!==e.dump.length?(writeBlockSequence(e,t,e.dump,r),c&&(e.dump="&ref_"+o+(0===t?"\n":"")+e.dump)):(writeFlowSequence(e,t,e.dump),c&&(e.dump="&ref_"+o+" "+e.dump));else{if("[object String]"!==E){if(e.skipInvalid)return!1;throw new YAMLException("unacceptable kind of an object to dump "+E)}"?"!==e.tag&&writeScalar(e,e.dump,t)}null!==e.tag&&"?"!==e.tag&&(e.dump="!<"+e.tag+"> "+e.dump)}return!0}function getDuplicateReferences(e,t){var n,i,r=[],E=[];for(inspectNode(e,r,E),n=0,i=E.length;i>n;n+=1)t.duplicates.push(r[E[n]]);t.usedDuplicates=new Array(i)}function inspectNode(e,t,n){{var i,r,E;_toString.call(e)}if(null!==e&&"object"==typeof e)if(r=t.indexOf(e),-1!==r)-1===n.indexOf(r)&&n.push(r);else if(t.push(e),Array.isArray(e))for(r=0,E=e.length;E>r;r+=1)inspectNode(e[r],t,n);else for(i=Object.keys(e),r=0,E=i.length;E>r;r+=1)inspectNode(e[i[r]],t,n)}function dump(e,t){t=t||{};var n=new State(t);return getDuplicateReferences(e,n),writeNode(n,0,e,!0,!0)?n.dump+"\n":""}function safeDump(e,t){return dump(e,common.extend({schema:DEFAULT_SAFE_SCHEMA},t))}var common=require("./common"),YAMLException=require("./exception"),DEFAULT_FULL_SCHEMA=require("./schema/default_full"),DEFAULT_SAFE_SCHEMA=require("./schema/default_safe"),_toString=Object.prototype.toString,_hasOwnProperty=Object.prototype.hasOwnProperty,CHAR_TAB=9,CHAR_LINE_FEED=10,CHAR_CARRIAGE_RETURN=13,CHAR_SPACE=32,CHAR_EXCLAMATION=33,CHAR_DOUBLE_QUOTE=34,CHAR_SHARP=35,CHAR_PERCENT=37,CHAR_AMPERSAND=38,CHAR_SINGLE_QUOTE=39,CHAR_ASTERISK=42,CHAR_COMMA=44,CHAR_MINUS=45,CHAR_COLON=58,CHAR_GREATER_THAN=62,CHAR_QUESTION=63,CHAR_COMMERCIAL_AT=64,CHAR_LEFT_SQUARE_BRACKET=91,CHAR_RIGHT_SQUARE_BRACKET=93,CHAR_GRAVE_ACCENT=96,CHAR_LEFT_CURLY_BRACKET=123,CHAR_VERTICAL_LINE=124,CHAR_RIGHT_CURLY_BRACKET=125,ESCAPE_SEQUENCES={};ESCAPE_SEQUENCES[0]="\\0",ESCAPE_SEQUENCES[7]="\\a",ESCAPE_SEQUENCES[8]="\\b",ESCAPE_SEQUENCES[9]="\\t",ESCAPE_SEQUENCES[10]="\\n",ESCAPE_SEQUENCES[11]="\\v",ESCAPE_SEQUENCES[12]="\\f",ESCAPE_SEQUENCES[13]="\\r",ESCAPE_SEQUENCES[27]="\\e",ESCAPE_SEQUENCES[34]='\\"',ESCAPE_SEQUENCES[92]="\\\\",ESCAPE_SEQUENCES[133]="\\N",ESCAPE_SEQUENCES[160]="\\_",ESCAPE_SEQUENCES[8232]="\\L",ESCAPE_SEQUENCES[8233]="\\P";var DEPRECATED_BOOLEANS_SYNTAX=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"];StringBuilder.prototype.takeUpTo=function(e){var t;if(e<this.checkpoint)throw t=new Error("position should be > checkpoint"),t.position=e,t.checkpoint=this.checkpoint,t;return this.result+=this.source.slice(this.checkpoint,e),this.checkpoint=e,this},StringBuilder.prototype.escapeChar=function(){var e,t;return e=this.source.charCodeAt(this.checkpoint),t=ESCAPE_SEQUENCES[e]||encodeHex(e),this.result+=t,this.checkpoint+=1,this},StringBuilder.prototype.finish=function(){this.source.length>this.checkpoint&&this.takeUpTo(this.source.length)},module.exports.dump=dump,module.exports.safeDump=safeDump;
...
},{"../internal/baseIndexOf":77,"../internal/binaryIndex":91}],52:[function(require,module,exports){
...
},{"../internal/LazyWrapper":60,"../internal/LodashWrapper":61,"../internal/baseLodash":82,"../internal/isObjectLike":122,"../internal/wrapperClone":134,"../lang/isArray":137}],54:[function(require,module,exports){
...
},{"../internal/baseEach":70,"../internal/createFind":101}],55:[function(require,module,exports){
...
},{"../internal/arrayEach":63,"../internal/baseEach":70,"../internal/createForEach":102}],56:[function(require,module,exports){
...
},{"../internal/arrayMap":64,"../internal/baseCallback":66,"../internal/baseMap":83,"../lang/isArray":137}],57:[function(require,module,exports){
...
},{"../lang/isNative":139}],58:[function(require,module,exports){
...
},{"../internal/createWrapper":105,"../internal/replaceHolders":128,"./restParam":59}],59:[function(require,module,exports){
...
},{"./baseCreate":69,"./baseLodash":82}],61:[function(require,module,exports){
...
},{"./baseCreate":69,"./baseLodash":82}],62:[function(require,module,exports){
...
},{"../lang/isNative":139,"../object/keys":145,"./baseCopy":68,"./getSymbols":112}],66:[function(require,module,exports){
...
},{"../utility/identity":150,"../utility/property":152,"./baseMatches":84,"./baseMatchesProperty":85,"./bindCallback":93}],67:[function(require,module,exports){
...
},{"../lang/isArray":137,"../lang/isObject":140,"./arrayCopy":62,"./arrayEach":63,"./baseAssign":65,"./baseForOwn":75,"./initCloneArray":114,"./initCloneByTag":115,"./initCloneObject":116,"./isHostObject":117}],68:[function(require,module,exports){
...
},{"../lang/isObject":140}],70:[function(require,module,exports){
...
},{"../object/keysIn":146,"./baseFor":73}],75:[function(require,module,exports){
...
},{"../object/keys":145,"./baseFor":73}],76:[function(require,module,exports){
...
},{"./toObject":132}],77:[function(require,module,exports){
...
},{"./indexOfNaN":113}],78:[function(require,module,exports){
...
},{"./baseIsEqualDeep":79}],79:[function(require,module,exports){
...
},{"../lang/isArray":137,"../lang/isTypedArray":143,"./equalArrays":106,"./equalByTag":107,"./equalObjects":108,"./isHostObject":117}],80:[function(require,module,exports){
...
},{"./baseIsEqual":78}],82:[function(require,module,exports){
...
},{"./baseEach":70,"./getLength":111,"./isLength":121}],84:[function(require,module,exports){
...
},{"../object/keys":145,"../utility/constant":149,"./baseIsMatch":81,"./isStrictComparable":123,"./toObject":132}],85:[function(require,module,exports){
...
},{"../array/last":52,"../lang/isArray":137,"./baseGet":76,"./baseIsEqual":78,"./baseSlice":89,"./isKey":119,"./isStrictComparable":123,"./toObject":132,"./toPath":133}],86:[function(require,module,exports){
...
},{"./toObject":132}],87:[function(require,module,exports){
...
},{"./baseGet":76,"./toPath":133}],88:[function(require,module,exports){
...
},{"../utility/identity":150,"./metaMap":125}],89:[function(require,module,exports){
...
},{"../utility/identity":150,"./binaryIndexBy":92}],92:[function(require,module,exports){
...
},{"../utility/identity":150}],94:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":139,"../utility/constant":149}],95:[function(require,module,exports){
...
},{"./getLength":111,"./isLength":121,"./toObject":132}],98:[function(require,module,exports){
...
},{"./toObject":132}],99:[function(require,module,exports){
(function (global){
...
},{"../lang/isObject":140,"./baseCreate":69}],101:[function(require,module,exports){
...
},{"../lang/isArray":137,"./baseCallback":66,"./baseFind":71,"./baseFindIndex":72}],102:[function(require,module,exports){
...
},{"../lang/isArray":137,"./bindCallback":93}],103:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":62,"./composeArgs":95,"./composeArgsRight":96,"./createCtorWrapper":100,"./isLaziable":120,"./reorder":127,"./replaceHolders":128,"./setData":129}],104:[function(require,module,exports){
(function (global){
...
},{"./baseSetData":88,"./createBindWrapper":99,"./createHybridWrapper":103,"./createPartialWrapper":104,"./getData":109,"./mergeData":124,"./setData":129}],106:[function(require,module,exports){
...
},{"../object/keys":145}],109:[function(require,module,exports){
...
},{"../utility/noop":151,"./metaMap":125}],110:[function(require,module,exports){
...
},{"../support":148,"../utility/constant":149,"./baseProperty":86,"./realNames":126}],111:[function(require,module,exports){
var baseProperty=require("./baseProperty"),getLength=baseProperty("length");module.exports=getLength;


},{"./baseProperty":86}],112:[function(require,module,exports){
...
},{"../lang/isNative":139,"../utility/constant":149,"./toObject":132}],113:[function(require,module,exports){
...
},{"./bufferClone":94}],116:[function(require,module,exports){
...
},{"../lang/isArray":137,"./toObject":132}],120:[function(require,module,exports){
...
},{"../chain/lodash":53,"./LazyWrapper":60,"./getFuncName":110}],121:[function(require,module,exports){
...
},{"../lang/isObject":140}],124:[function(require,module,exports){
...
},{"./arrayCopy":62,"./composeArgs":95,"./composeArgsRight":96,"./replaceHolders":128}],125:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":139}],126:[function(require,module,exports){
...
},{"./arrayCopy":62,"./isIndex":118}],128:[function(require,module,exports){
...
},{"../date/now":57,"./baseSetData":88}],130:[function(require,module,exports){
...
},{"../lang/isArguments":136,"../support":148,"./baseForIn":74,"./isHostObject":117,"./isObjectLike":122}],131:[function(require,module,exports){
...
},{"../lang/isArguments":136,"../lang/isArray":137,"../lang/isString":142,"../object/keysIn":146,"../support":148,"./isIndex":118,"./isLength":121}],132:[function(require,module,exports){
...
},{"../lang/isObject":140,"../lang/isString":142,"../support":148}],133:[function(require,module,exports){
...
},{"../lang/isArray":137,"./baseToString":90}],134:[function(require,module,exports){
...
},{"./LazyWrapper":60,"./LodashWrapper":61,"./arrayCopy":62}],135:[function(require,module,exports){
...
},{"../internal/baseClone":67,"../internal/bindCallback":93}],136:[function(require,module,exports){
...
},{"../internal/isLength":121,"../internal/isObjectLike":122,"../support":148}],137:[function(require,module,exports){
...
},{"../internal/isLength":121,"../internal/isObjectLike":122,"./isNative":139}],138:[function(require,module,exports){
(function (global){
...
},{"../internal/baseIsFunction":80,"./isNative":139}],139:[function(require,module,exports){
...
},{"../internal/isHostObject":117,"../internal/isObjectLike":122,"../string/escapeRegExp":147}],140:[function(require,module,exports){
...
},{"../internal/shimIsPlainObject":130,"../support":148,"./isArguments":136,"./isNative":139}],142:[function(require,module,exports){
...
},{"../internal/isObjectLike":122}],143:[function(require,module,exports){
...
},{"../internal/isLength":121,"../internal/isObjectLike":122}],144:[function(require,module,exports){
...
},{"../internal/isLength":121,"../internal/shimKeys":131,"../lang/isNative":139,"../lang/isObject":140,"../support":148}],146:[function(require,module,exports){
...
},{"../internal/arrayEach":63,"../internal/isIndex":118,"../internal/isLength":121,"../lang/isArguments":136,"../lang/isArray":137,"../lang/isFunction":138,"../lang/isObject":140,"../lang/isString":142,"../support":148}],147:[function(require,module,exports){
...
},{"../internal/baseToString":90}],148:[function(require,module,exports){
(function (global){
...
},{"../internal/baseProperty":86,"../internal/basePropertyDeep":87,"../internal/isKey":119}],153:[function(require,module,exports){
