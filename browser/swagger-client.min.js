...
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray"),isString:require("lodash-compat/lang/isString")},Resolver=module.exports=function(){this.failedUrls=[]};Resolver.prototype.processAllOf=function(e,i,r,t,o,s){var n,l,f;r["x-resolved-from"]=["#/definitions/"+i];var a=r.allOf;for(a.sort(function(e,i){return e.$ref&&i.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+i+"/allOf",this.resolveInline(e,s,f,t,o,l)},Resolver.prototype.resolve=function(e,i,r,t){this.spec=e;var o,s,n=i,l=r,f=t,a={};"function"==typeof i&&(n=null,l=i,f=r);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,v,d,c,u=0,m={},y={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var g=e.definitions[h];if(g.$ref)this.resolveInline(n,e,g,O,y,g);else{for(c in g.properties)d=g.properties[c],_.isArray(d.allOf)?this.processAllOf(n,h,d,O,y,e):this.resolveTo(n,d,O,"/definitions");g.allOf&&this.processAllOf(n,h,g,O,y,e)}}e.parameters=e.parameters||{};for(h in e.parameters){var x=e.parameters[h];if("body"===x["in"]&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,A=!1,k=0;!A;){if("undefined"==typeof e.definitions[h]){A=!0;break}h=b+"_"+k,k++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,x.schema,O,o);x.$ref&&this.resolveInline(n,e,x,O,y,x.$ref)}for(h in e.paths){var j,$,R;v=e.paths[h];for(j in v)if("$ref"===j)o="/paths"+h,this.resolveInline(n,e,v,O,y,o);else{$=v[j];var I=v.parameters||[],q=$.parameters||[];for(s in I){var x=I[s];q.unshift(x)}"parameters"!==j&&_.isObject($)&&($.parameters=$.parameters||q);for(s in q){var x=q[s];if(o="/paths"+h+"/"+j+"/parameters","body"===x["in"]&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,A=!1,k=0;!A;){if("undefined"==typeof e.definitions[h]){A=!0;break}h=b+"_"+k,k++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,x.schema,O,o);x.$ref&&this.resolveInline(n,e,x,O,y,x.$ref)}for(R in $.responses){var w=$.responses[R];if(o="/paths"+h+"/"+j+"/responses/"+R,_.isObject(w)&&(w.$ref&&this.resolveInline(n,e,w,O,y,o),w.schema)){var T=w;if(_.isArray(T.schema.allOf)){for(var b="inline_model",h=b,A=!1,k=0;!A;){if("undefined"==typeof e.definitions[h]){A=!0;break}h=b+"_"+k,k++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else"array"===T.schema.type?T.schema.items&&T.schema.items.$ref&&this.resolveInline(n,e,T.schema.items,O,y,o):this.resolveTo(n,w.schema,O,o)}}}v.parameters=[]}var S,D=0,U=[],H=O;for(s=0;s<H.length;s++){var N=H[s];if(n===N.root){if("ref"===N.resolveAs){var P,z=((N.root||"")+"/"+N.key).split("/"),E=[],J="";if(N.key.indexOf("../")>=0){for(var Q=0;Q<z.length;Q++)".."===z[Q]?E=E.slice(0,E.length-1):E.push(z[Q]);for(P=0;P<E.length;P++)P>0&&(J+="/"),J+=E[P];N.root=J,U.push(N)}else if(S=N.key.split("#"),2===S.length){0!==S[0].indexOf("http://")&&0!==S[0].indexOf("https://")||(N.root=S[0]),o=S[1].split("/");var B,C=e;for(P=0;P<o.length;P++){var F=o[P];if(""!==F){if(C=C[F],"undefined"==typeof C){B=null;break}B=C}}null===B&&U.push(N)}}else if("inline"===N.resolveAs){if(N.key&&-1===N.key.indexOf("#")&&"/"!==N.key.charAt(0)){for(S=N.root.split("/"),o="",s=0;s<S.length-1;s++)o+=S[s]+"/";o+=N.key,N.root=o,N.location=""}U.push(N)}}else U.push(N)}D=U.length;for(var G=0;G<U.length;G++)!function(e,i,r){if(e.root&&e.root!==n)if(-1===r.failedUrls.indexOf(e.root)){var t={useJQuery:!1,url:e.root,method:"get",headers:{accept:r.scope.swaggerRequestHeaders||"application/json"},on:{error:function(o){u+=1,console.log("failed url: "+t.url),r.failedUrls.push(t.url),y[e.key]={root:e.root,location:e.location},u===D&&r.finish(i,p,O,m,y,l)},response:function(t){var o=t.obj;r.resolveItem(o,e.root,O,m,y,e),u+=1,u===D&&r.finish(i,p,O,m,y,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(t),(new SwaggerHttp).execute(t,a)}else u+=1,y[e.key]={root:e.root,location:e.location},u===D&&r.finish(i,p,O,m,y,l);else r.resolveItem(i,p,O,m,y,e),u+=1,u===D&&r.finish(i,n,O,m,y,l,!0)}(U[G],e,this);0===Object.keys(U).length&&this.finish(e,p,O,m,y,l)},Resolver.prototype.resolveItem=function(e,i,r,t,o,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?t[h]={name:v,obj:l,key:s.key,root:s.root}:o[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,i,r,t,o,s,n){var l;for(l in r){var f=r[l],a=f.key,p=t[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj){var h=this.retainRoot(a,p.obj[a],f.root);p.obj[a]=h}e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(a,p.obj[a],f.root)),v[a]=h}}}var d=this.countUnresolvedRefs(e);0===d||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,o)):(this.iteration+=1,this.resolve(e,i,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var i,r=this.getRefs(e),t=[],o=[];for(i in r)0===i.indexOf("#")?t.push(i.substring(1)):o.push(i);for(i=0;i<t.length;i++)for(var s=t[i],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){o.push(s);break}}return o.length},Resolver.prototype.getRefs=function(e,i){i=i||e;var r={};for(var t in i)if(i.hasOwnProperty(t)){var o=i[t];if("$ref"===t&&"string"==typeof o)r[o]=null;else if(_.isObject(o)){var s=this.getRefs(o);for(var n in s)r[n]=null}}return r},Resolver.prototype.retainRoot=function(e,i,r){if(_.isObject(i))for(var t in i){var o=i[t];if("$ref"===t&&"string"==typeof o){if(0!==o.indexOf("http://")&&0!==o.indexOf("https://")){var s=!0;if(r){var n=r.slice(-1);if("/"!==n&&0!==o.indexOf("#")&&0!==o.indexOf("http://")&&o.indexOf("https://")){s=!1;var l=r.split("/");l=l.splice(0,l.length-1),r="";for(var f=0;f<l.length;f++)r+=l[f]+"/"}}0!==o.indexOf("#")&&s&&(o="#"+o),o=(r||"")+o,i[t]=o}}else _.isObject(o)&&this.retainRoot(t,o,r)}else _.isString(i)&&"$ref"===e&&-1===i.indexOf("http:")&&-1===i.indexOf("https:")&&(i=r+i);return i},Resolver.prototype.resolveInline=function(e,i,r,t,o,s){var n,l,f,a,p=r.$ref,h=r.$ref,v=!1;if(e=e||"",h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var d=0;d<f.length;d++)d>0&&(e+="/"),e+=f[d]}e+="/"+h.split("#")[0]}s=a[1]}if(0===h.indexOf("http"))h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("#"))s=h.split("#")[1],t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("/")&&-1===h.indexOf("#")){s=h;var c=e.match(/^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i);c&&(e=c[0]+h.substring(1),s=""),t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else"array"===r.type&&this.resolveTo(e,r.items,t,s)},Resolver.prototype.resolveTo=function(e,i,r,t){var o,s,n=i.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(o=e.split("/"),l="",s=0;s<o.length-1;s++)l+=o[s]+"/";l+=f[0]}t=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,t="";else{for(o=e.split("/"),l="",s=0;s<o.length-1;s++)l+=o[s]+"/";l+=n,t=""}r.push({obj:i,resolveAs:"ref",root:l,key:n,location:t})}else if("array"===i.type){var a=i.items;this.resolveTo(e,a,r,t)}else if(i&&i.properties){var p=this.uniqueName("inline_model");i.title&&(p=this.uniqueName(i.title)),delete i.title,this.spec.definitions[p]=_.cloneDeep(i),i.$ref="#/definitions/"+p,delete i.type,delete i.properties}},Resolver.prototype.uniqueName=function(e){for(var i=e,r=0;;){if(!_.isObject(this.spec.definitions[i]))return i;i=e+"_"+r,r++}},Resolver.prototype.resolveAllOf=function(e,i,r){r=r||0,i=i||e;var t;for(var o in i)if(i.hasOwnProperty(o)){var s=i[o];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+i+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,r+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(t in v){l.properties[t]=_.cloneDeep(v[t]);var d=v[t]["x-resolved-from"];"undefined"!=typeof d&&"self"!==d||(d=p),l.properties[t]["x-resolved-from"]=d}}else if("required"===h){for(var c=l.required.concat(a[h]),u=0;u<c.length;++u)for(var m=u+1;m<c.length;++m)c[u]===c[m]&&c.splice(m--,1);l.required=c}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(t in l[h])l[h][t]["x-resolved-from"]=p}i[o]=l}}}};
