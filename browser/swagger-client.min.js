...
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,r,i){this.scope=i||this;var s,o,n,t,a,l=0,f={},v={},p={};for(o in e.definitions){var h=e.definitions[o];for(a in h.properties)t=h.properties[a],this.resolveTo(t,p)}for(o in e.paths){var c,u,d;n=e.paths[o];for(c in n)if("$ref"===c){{n[c]}this.resolveInline(e,n,p,v)}else{u=n[c];var y,g=u.parameters;for(y in g){var b=g[y];"body"===b["in"]&&b.schema&&this.resolveTo(b.schema,p),b.$ref&&this.resolveInline(e,b,p,v)}for(d in u.responses){var A=u.responses[d];A.schema&&this.resolveTo(A.schema,p)}}}var j={},m=0;for(o in p){var $=o.split("#");2===$.length&&(s=$[0],n=$[1],Array.isArray(j[s])||(j[s]=[],m+=1),j[s].push(n))}for(o in j){var x=this,R=j[o];s=o;var T={useJQuery:!1,url:s,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){l+=1;var i;for(i=0;i<R.length;i++){var o=s+"#"+R[i];v[o]=null}l===m&&x.finish(e,p,f,v,r)},response:function(i){var o,n,t=i.obj;for(l+=1,o=0;o<R.length;o++){var a=t,h=R[o],c=h.split("/");for(n=0;n<c.length;n++){var u=c[n];if(-1!==u.indexOf("~1")&&(u=c[n].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==u.charAt(0)&&(u="/"+u)),"undefined"==typeof a)break;u.length>0&&(a=a[u])}var d=s+"#"+h,y=c[n-1];"undefined"!=typeof a?f[d]={name:y,obj:a}:v[d]=null}l===m&&x.finish(e,p,f,v,r)}}};i&&i.clientAuthorizations&&i.clientAuthorizations.apply(T),(new SwaggerHttp).execute(T)}0===Object.keys(j).length&&r.call(this.scope,e,v)},Resolver.prototype.finish=function(e,r,i,s,o){var n;for(n in r){var t,a=r[n];for(t=0;t<a.length;t++){var l=i[a[t].obj.$ref];if(l)if(e.definitions||(e.definitions={}),"$ref"===a[t].resolveAs)e.definitions[l.name]=l.obj,a[t].obj.$ref="#/definitions/"+l.name;else if("inline"===a[t].resolveAs){var f,v=a[t].obj;delete v.$ref;for(f in l.obj)v[f]=l.obj[f]}}}o.call(this.scope,e,s)},Resolver.prototype.resolveInline=function(e,r,i,s){var o=r.$ref;if(o){if(0===o.indexOf("http"))Array.isArray(i[o])?i[o].push({obj:r,resolveAs:"inline"}):i[o]=[{obj:r,resolveAs:"inline"}];else if(0===o.indexOf("#")){var n,t=o.substring(1),a=t.split("/"),l=e;for(n=0;n<a.length;n++){var f=a[n];f.length>0&&(l=l[f])}if(l){delete r.$ref;var v;for(v in l)r[v]=l[v]}else s[o]=null}}else"array"===r.type&&this.resolveTo(r.items,i)},Resolver.prototype.resolveTo=function(e,r){var i=e.$ref;if(i)0===i.indexOf("http")&&(Array.isArray(r[i])?r[i].push({obj:e,resolveAs:"$ref"}):r[i]=[{obj:e,resolveAs:"$ref"}]);else if("array"===e.type){var s=e.items;this.resolveTo(s,r)}};
