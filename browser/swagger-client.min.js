...
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){};Resolver.prototype.processAllOf=function(e,o,r,i,t,s){var n,l,f;r["x-resolved-from"]=["#/definitions/"+o];var p=r.allOf;for(p.sort(function(e,o){return e.$ref&&o.$ref?0:e.$ref?-1:1}),n=0;n<p.length;n++)f=p[n],l="/definitions/"+o+"/allOf",this.resolveInline(e,s,f,i,t,l)},Resolver.prototype.resolve=function(e,o,r,i){this.spec=e;var t,s,n=o,l=r,f=i,p={};"function"==typeof o&&(n=null,l=o,f=r);var a=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(p.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(p.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,y={},g={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var m=e.definitions[h];for(d in m.properties)c=m.properties[d],_.isArray(c.allOf)?this.processAllOf(n,h,c,O,g,e):this.resolveTo(n,c,O,"/definitions");m.allOf&&this.processAllOf(n,h,m,O,g,e)}for(h in e.paths){var x,b,A;v=e.paths[h];for(x in v)if("$ref"===x)t="/paths"+h,this.resolveInline(n,e,v,O,g,t);else{b=v[x];var k=v.parameters||[],j=b.parameters||[];for(s in k){var R=k[s];j.unshift(R)}for(s in j){var R=j[s];if(t="/paths"+h+"/"+x+"/parameters","body"===R["in"]&&R.schema)if(_.isArray(R.schema.allOf)){for(var $="inline_model",h=$,I=!1,q=0;!I;){if("undefined"==typeof e.definitions[h]){I=!0;break}h=$+"_"+q,q++}e.definitions[h]={allOf:R.schema.allOf},delete R.schema.allOf,R.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,g,e)}else this.resolveTo(n,R.schema,O,t);R.$ref&&this.resolveInline(n,e,R,O,g,R.$ref)}for(A in b.responses){var w=b.responses[A];t="/paths"+h+"/"+x+"/responses/"+A,_.isObject(w)&&(w.$ref&&this.resolveInline(n,e,w,O,g,t),w.schema&&this.resolveTo(n,w.schema,O,t))}}v.parameters=[]}var T,D=0,S=[],H=O;for(s=0;s<H.length;s++){var P=H[s];if(n===P.root){if("ref"===P.resolveAs){var z,N=((P.root||"")+"/"+P.key).split("/"),U=[],E="";if(P.key.indexOf("../")>=0){for(var J=0;J<N.length;J++)".."===N[J]?U=U.slice(0,U.length-1):U.push(N[J]);for(z=0;z<U.length;z++)z>0&&(E+="/"),E+=U[z];P.root=E,S.push(P)}else if(T=P.key.split("#"),2===T.length){(0===T[0].indexOf("http://")||0===T[0].indexOf("https://"))&&(P.root=T[0]),t=T[1].split("/");var Q,B=e;for(z=0;z<t.length;z++){var C=t[z];if(""!==C){if(B=B[C],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&S.push(P)}}else if("inline"===P.resolveAs){if(P.key&&-1===P.key.indexOf("#")&&"/"!==P.key.charAt(0)){for(T=P.root.split("/"),t="",s=0;s<T.length-1;s++)t+=T[s]+"/";t+=P.key,P.root=t,P.location=""}S.push(P)}}else S.push(P)}D=S.length;for(var F=0;F<S.length;F++)!function(e,o,r){if(null===e.root||e.root===n)r.resolveItem(o,a,O,y,g,e),u+=1,u===D&&r.finish(o,n,O,y,g,l);else{var i={useJQuery:!1,url:e.root,method:"get",headers:{accept:r.scope.swaggerRequestHeaders||"application/json"},on:{error:function(i){u+=1,g[e.key]={root:e.root,location:e.location},u===D&&r.finish(o,a,O,y,g,l)},response:function(i){var t=i.obj;r.resolveItem(t,e.root,O,y,g,e),u+=1,u===D&&r.finish(o,a,O,y,g,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(i),(new SwaggerHttp).execute(i,p)}}(S[F],e,this);0===Object.keys(S).length&&this.finish(e,a,O,y,g,l)},Resolver.prototype.resolveItem=function(e,o,r,i,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var p=0;p<f.length;p++){var a=f[p];if(-1!==a.indexOf("~1")&&(a=f[p].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==a.charAt(0)&&(a="/"+a)),"undefined"==typeof l||null===l)break;if(""===a&&p===f.length-1&&f.length>1){l=null;break}a.length>0&&(l=l[a])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?i[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,o,r,i,t,s){var n;for(n in r){var l=r[n],f=l.key,p=i[f];if(p)if(e.definitions=e.definitions||{},"ref"===l.resolveAs){for(f in p.obj)var a=this.retainRoot(p.obj[f],l.root);e.definitions[p.name]=p.obj,l.obj.$ref="#/definitions/"+p.name}else if("inline"===l.resolveAs){var h=l.obj;h["x-resolved-from"]=[l.key],delete h.$ref;for(f in p.obj){var a=this.retainRoot(p.obj[f],l.root);h[f]=a}}}var v=this.countUnresolvedRefs(e);0===v||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,o,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var o,r=this.getRefs(e),i=[],t=[];for(o in r)0===o.indexOf("#")?i.push(o.substring(1)):t.push(o);for(o=0;o<i.length;o++)for(var s=i[o],n=s.split("/"),l=e,f=0;f<n.length;f++){var p=n[f];if(""!==p&&(l=l[p],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,o){o=o||e;var r={};for(var i in o)if(o.hasOwnProperty(i)){var t=o[i];if("$ref"===i&&"string"==typeof t)r[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)r[n]=null}}return r},Resolver.prototype.retainRoot=function(e,o){for(var r in e){var i=e[r];"$ref"===r&&"string"==typeof i?0!==i.indexOf("http://")&&0!==i.indexOf("https://")&&(0!==i.indexOf("#")&&(i="#"+i),i=(o||"")+i,e[r]=i):_.isObject(i)&&this.retainRoot(i,o)}return e},Resolver.prototype.resolveInline=function(e,o,r,i,t,s){var n,l,f,p,a=r.$ref,h=r.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))p=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+p[0],s=p[1];else{if(p=h.split("#"),""!==p[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=p[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),i.push({obj:r,resolveAs:"inline",root:e,key:a,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],i.push({obj:r,resolveAs:"inline",root:e,key:a,location:s})):i.push({obj:r,resolveAs:"inline",root:e,key:a,location:s})}else"array"===r.type&&this.resolveTo(e,r.items,i,s)},Resolver.prototype.resolveTo=function(e,o,r,i){var t,s,n=o.$ref,l=e;if("undefined"!=typeof n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}i=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,i="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,i=""}r.push({obj:o,resolveAs:"ref",root:l,key:n,location:i})}else if("array"===o.type){var p=o.items;this.resolveTo(e,p,r,i)}else if(o&&o.properties){var a=this.uniqueName("inline_model");this.spec.definitions[a]=_.cloneDeep(o),o.$ref="#/definitions/"+a,delete o.type,delete o.properties}},Resolver.prototype.uniqueName=function(e){for(var o=e,r=0;;){if(!_.isObject(this.spec.definitions[o]))return o;o=e+"_"+r,r++}},Resolver.prototype.resolveAllOf=function(e,o,r){r=r||0,o=o||e;var i;for(var t in o)if(o.hasOwnProperty(t)){var s=o[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+o+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,r+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var p=n[f],a="self";"undefined"!=typeof p["x-resolved-from"]&&(a=p["x-resolved-from"][0]);for(var h in p)if(l.hasOwnProperty(h))if("properties"===h){var v=p[h];for(i in v){l.properties[i]=_.cloneDeep(v[i]);var c=v[i]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=a),l.properties[i]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(p[h]),u=0;u<d.length;++u)for(var y=u+1;y<d.length;++y)d[u]===d[y]&&d.splice(y--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(a);else if(l[h]=_.cloneDeep(p[h]),"properties"===h)for(i in l[h])l[h][i]["x-resolved-from"]=a}o[t]=l}}_.isObject(s)&&this.resolveAllOf(e,s,r+1)}};
