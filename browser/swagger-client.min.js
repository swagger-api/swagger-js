...
},{"./auth":2,"./helpers":4,"./http":5,"./resolver":6,"./spec-converter":7,"./types/model":8,"./types/operation":9,"./types/operationGroup":10,"lodash-compat/array/indexOf":20,"lodash-compat/collection/find":21,"lodash-compat/collection/forEach":22,"lodash-compat/function/bind":25,"lodash-compat/lang/cloneDeep":83,"lodash-compat/lang/isArray":85,"lodash-compat/lang/isFunction":86,"lodash-compat/lang/isPlainObject":89,"lodash-compat/lang/isUndefined":92}],4:[function(require,module,exports){
(function (process){
...
},{"./helpers":4,"jquery":18,"superagent":100}],6:[function(require,module,exports){
...
"use strict";var SwaggerClient=require("./client"),SwaggerHttp=require("./http"),SwaggerSpecConverter=module.exports=function(){this.errors=[],this.warnings=[],this.modelMap={}};SwaggerSpecConverter.prototype.setDocumentationLocation=function(e){this.docLocation=e},SwaggerSpecConverter.prototype.convert=function(e,t){if(!e||!Array.isArray(e.apis))return this.finish(t,null);var r={swagger:"2.0"};r.originalVersion=e.swaggerVersion,this.apiInfo(e,r),this.securityDefinitions(e,r);var i,o=!1;for(i=0;i<e.apis.length;i++){var s=e.apis[i];Array.isArray(s.operations)&&(o=!0)}o?(this.declaration(e,r),this.finish(t,r)):this.resourceListing(e,r,t)},SwaggerSpecConverter.prototype.declaration=function(e,t){var r,i;if(e.apis){{e.basePath}if(0===e.basePath.indexOf("http://")){var o=e.basePath.substring("http://".length),s=o.indexOf("/");s>0?(t.host=o.substring(0,s),t.basePath=o.substring(s)):(t.host=o,t.basePath="/")}if(e.consumes&&(t.consumes=e.consumes),e.produces&&(t.produces=e.produces),"object"==typeof e)for(r in e.models){var n=e.models[r],a=n.id||r;this.modelMap[a]=r}for(i=0;i<e.apis.length;i++){var p=e.apis[i],u=p.path,c=p.operations;this.operations(u,e.resourcePath,c,t)}var f=e.models;this.models(f,t)}},SwaggerSpecConverter.prototype.models=function(e,t){if("object"==typeof e){var r;t.definitions=t.definitions||{};for(r in e){var i,o=e[r],s=[],n={properties:{}};for(i in o.properties){var a=o.properties[i],p={};this.dataType(a,p),a.description&&(p.description=a.description),a["enum"]&&(p["enum"]=a["enum"]),"boolean"==typeof a.required&&a.required===!0&&s.push(i),"string"==typeof a.required&&"true"===a.required&&s.push(i),n.properties[i]=p}s.length>0&&(n["enum"]=s),t.definitions[r]=n}}},SwaggerSpecConverter.prototype.extractTag=function(e){return(e||"default").replace("/","")},SwaggerSpecConverter.prototype.operations=function(e,t,r,i){if(Array.isArray(r)){var o;i.paths||(i.paths={});var s=i.paths[e]||{},n=this.extractTag(t);for(o=0;o<r.length;o++){var a=r[o],p=(a.method||a.httpMethod).toLowerCase(),u={tags:[n]};if(a.authorizations)for(var c in a.authorizations){u.security=u.security||[];var f=a.authorizations[c];if(f){var l=[];for(var m in f)l.push(f[m].scope);var h={};h[c]=l,u.security.push(h)}else{var h={};h[c]=[],u.security.push(h)}}a.consumes?u.consumes=a.consumes:i.consumes&&(u.consumes=i.consumes),a.produces?u.produces=a.produces:i.produces&&(u.produces=i.produces),a.summary&&(u.summary=a.summary),a.notes&&(u.description=a.notes),a.nickname&&(u.operationId=a.nickname),a.deprecated&&(u.deprecated=a.deprecated),this.authorizations(a.authorizations,i),this.parameters(u,a.parameters,i),this.responseMessages(u,a,i),s[p]=u}i.paths[e]=s}},SwaggerSpecConverter.prototype.responseMessages=function(e,t){if("object"==typeof t){var r={};this.dataType(t,r),r.schema||(r={schema:r}),e.responses=e.responses||{};var i=!1;if(Array.isArray(t.responseMessages)){var o,s=t.responseMessages;for(o=0;o<s.length;o++){var n=s[o],a={description:n.message};200===n.code&&(i=!0),e.responses[""+n.code]=a}}i?e.responses["default"]=r:e.responses[200]=r}},SwaggerSpecConverter.prototype.authorizations=function(e){},SwaggerSpecConverter.prototype.parameters=function(e,t){if(Array.isArray(t)){var r;for(r=0;r<t.length;r++){var i=t[r],o={};if(o.name=i.name,o.description=i.description,o.required=i.required,o["in"]=i.paramType,"body"===o["in"]&&(o.name="body"),"form"===o["in"]&&(o["in"]="formData"),i.allowMultiple===!0||"true"===i.allowMultiple){var s={};if(this.dataType(i,s),o.type="array",o.items=s,i.allowableValues){var n=i.allowableValues;"LIST"===n.valueType&&(o["enum"]=n.values)}}else this.dataType(i,o);e.parameters=e.parameters||[],e.parameters.push(o)}}},SwaggerSpecConverter.prototype.dataType=function(e,t){if("object"==typeof e){e.minimum&&(t.minimum=e.minimum),e.maximum&&(t.maximum=e.maximum),e.defaultValue&&(t["default"]=e.defaultValue);var r=this.toJsonSchema(e);r&&(t=t||{},r.type&&(t.type=r.type),r.format&&(t.format=r.format),r.$ref&&(t.schema={$ref:r.$ref}),r.items&&(t.items=r.items))}},SwaggerSpecConverter.prototype.toJsonSchema=function(e){if(!e)return"object";var t=e.type||e.dataType||e.responseClass||"",r=t.toLowerCase(),i=(e.format||"").toLowerCase();if(0===r.indexOf("list[")){var o=t.substring(5,t.length-1),s=this.toJsonSchema({type:o});return{type:"array",items:s}}if("int"===r||"integer"===r&&"int32"===i)return{type:"integer",format:"int32"};if("long"===r||"integer"===r&&"int64"===i)return{type:"integer",format:"int64"};if("integer"===r)return{type:"integer",format:"int64"};if("float"===r||"number"===r&&"float"===i)return{type:"number",format:"float"};if("double"===r||"number"===r&&"double"===i)return{type:"number",format:"double"};if("string"===r&&"date-time"===i||"date"===r)return{type:"string",format:"date-time"};if("string"===r)return{type:"string"};if("file"===r)return{type:"file"};if("boolean"===r)return{type:"boolean"};if("array"===r||"list"===r){if(e.items){var n=this.toJsonSchema(e.items);return{type:"array",items:n}}return{type:"array",items:{type:"object"}}}return e.$ref?{$ref:"#/definitions/"+this.modelMap[e.$ref]||e.$ref}:{$ref:"#/definitions/"+this.modelMap[e.type]||e.type}},SwaggerSpecConverter.prototype.resourceListing=function(e,t,r){var i,o=0,s=this,n=e.apis.length,a=t;for(0===n&&this.finish(r,t),i=0;n>i;i++){var p=e.apis[i],u=p.path,c=this.getAbsolutePath(e.swaggerVersion,this.docLocation,u);p.description&&(t.tags=t.tags||[],t.tags.push({name:this.extractTag(p.path),description:p.description||""}));var f={url:c,headers:{accept:"application/json"},on:{},method:"get"};f.on.response=function(e){o+=1,e.obj&&s.declaration(e.obj,a),o===n&&s.finish(r,a)},f.on.error=function(e){console.error(e),o+=1,o===n&&s.finish(r,a)},(new SwaggerHttp).execute(f)}},SwaggerSpecConverter.prototype.getAbsolutePath=function(e,t,r){if("1.0"===e&&t.endsWith(".json")){var i=t.lastIndexOf("/");i>0&&(t=t.substring(0,i))}var o=t;return 0===r.indexOf("http://")||0===r.indexOf("https://")?o=r:(t.endsWith("/")&&(o=t.substring(0,t.length-1)),o+=r),o=o.replace("{format}","json")},SwaggerSpecConverter.prototype.securityDefinitions=function(e,t){if(e.authorizations){var r;for(r in e.authorizations){var i=!1,o={},s=e.authorizations[r];if("apiKey"===s.type)o.type="apiKey",o["in"]=s.passAs,o.name=s.keyname||r,i=!0;else if("oauth2"===s.type){var n,a=s.scopes||[],p={};for(n in a){var u=a[n];p[u.scope]=u.description}if(o.type="oauth2",n>0&&(o.scopes=p),s.grantTypes){if(s.grantTypes.implicit){var c=s.grantTypes.implicit;o.flow="implicit",o.authorizationUrl=c.loginEndpoint,i=!0}if(s.grantTypes.authorization_code&&!o.flow){var f=s.grantTypes.authorization_code;o.flow="accessCode",o.authorizationUrl=f.tokenRequestEndpoint.url,o.tokenUrl=f.tokenEndpoint.url,i=!0}}}i&&(t.securityDefinitions=t.securityDefinitions||{},t.securityDefinitions[r]=o)}}},SwaggerSpecConverter.prototype.apiInfo=function(e,t){if(e.info){var r=e.info;t.info={},r.description&&(t.info.description=r.description),r.title&&(t.info.title=r.title),r.termsOfServiceUrl&&(t.info.termsOfService=r.termsOfServiceUrl),(r.license||r.licenseUrl)&&(t.license={},r.license&&(t.license.name=r.license),r.licenseUrl&&(t.license.url=r.licenseUrl))}else this.warnings.push("missing info section")},SwaggerSpecConverter.prototype.finish=function(e,t){e(t)};


},{"./client":3,"./http":5}],8:[function(require,module,exports){
"use strict";var _={forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined"),keys:require("lodash-compat/object/keys"),map:require("lodash-compat/collection/map")},helpers=require("../helpers"),applyParameterMacro=function(e,t){return e.api&&e.api.parameterMacro?e.api.parameterMacro(e,t):t.defaultValue},applyModelPropertyMacro=function(e,t){return e.api&&e.api.modelPropertyMacro?e.api.modelPropertyMacro(e,t):t["default"]},Property=module.exports=function(e,t,i,s){this.models=s,this.schema=t,this.required=i,t.$ref?this.$ref=helpers.simpleRef(t.$ref):"array"===t.type&&t.items&&(t.items.$ref?this.$ref=helpers.simpleRef(t.items.$ref):t=t.items),this.name=e,this.description=t.description,this.obj=t,this.optional=!0,this.optional=!i,this["default"]=t["default"]||null,this.example=void 0!==t.example?t.example:null,this.collectionFormat=t.collectionFormat||null,this.maximum=t.maximum||null,this.exclusiveMaximum=t.exclusiveMaximum||null,this.minimum=t.minimum||null,this.exclusiveMinimum=t.exclusiveMinimum||null,this.maxLength=t.maxLength||null,this.minLength=t.minLength||null,this.pattern=t.pattern||null,this.maxItems=t.maxItems||null,this.minItems=t.minItems||null,this.uniqueItems=t.uniqueItems||null,this["enum"]=t["enum"]||null,this.multipleOf=t.multipleOf||null},Model=module.exports=function(e,t,i){this.definition=t||{},this.isArray="array"===t.type,this.models=i||{},this.name=e||"Inline Model",this.properties=[];var s,n=t.required||[],r=t.properties;if(r)for(s in r){var a=!1,o=r[s];n.indexOf(s)>=0&&(a=!0),this.properties.push(new Property(s,o,a,this.models))}return this},schemaToHTML=function(e,t,i){for(var s='<span class="strong">',n="</span>",r={},a=[],o=0,p=function(e,t,s){var n,a=t;return e.$ref?(a=helpers.simpleRef(e.$ref),n=i[a]):_.isUndefined(t)&&(a="Inline Model "+ ++o,n=new Model(a,e,i)),s!==!0&&(r[a]=_.isUndefined(n)?{}:n.definition),a},l=function(e){var t='<span class="propType">',i=e.type||"object";return e.$ref?t+=p(e,helpers.simpleRef(e.$ref)):"object"===i?t+=p(e):"array"===i?(t+="Array[",_.isArray(e.items)?t+=_.map(e.items,p).join(","):_.isPlainObject(e.items)?t+=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?p(e.items):e.items.type:p(e.items,helpers.simpleRef(e.items.$ref)):(helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),t+=p({})),t+="]"):t+=e.type,t+="</span>"},m=function(e,t){var i="",s=e.type||"object",n="array"===s;switch(n&&(s=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),e["default"]&&(i+=helpers.optionHtml("Default",e["default"])),s){case"string":e.minLength&&(i+=helpers.optionHtml("Min. Length",e.minLength)),e.maxLength&&(i+=helpers.optionHtml("Max. Length",e.maxLength)),e.pattern&&(i+=helpers.optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(i+=helpers.optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(i+=helpers.optionHtml("Exclusive Min.","true")),e.maximum&&(i+=helpers.optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(i+=helpers.optionHtml("Exclusive Max.","true")),e.multipleOf&&(i+=helpers.optionHtml("Multiple Of",e.multipleOf))}if(n&&(e.minItems&&(i+=helpers.optionHtml("Min. Items",e.minItems)),e.maxItems&&(i+=helpers.optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(i+=helpers.optionHtml("Unique Items","true")),e.collectionFormat&&(i+=helpers.optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var r;r="number"===s||"integer"===s?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',i+=helpers.optionHtml("Enum",r)}return i.length>0&&(t='<span class="propWrap">'+t+'<table class="optionsWrapper"><tr><th colspan="2">'+s+"</th></tr>"+i+"</table></span>"),t},h=function(e,t){var i=e.type||"object",r="array"===e.type,o=s+t+" "+(r?"[":"{")+n;return t&&a.push(t),r?_.isArray(e.items)?o+="<div>"+_.map(e.items,function(e){var t=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],t)>-1?p(e):m(e,t):p(e,helpers.simpleRef(e.$ref))}).join(",</div><div>"):_.isPlainObject(e.items)?o+=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?"<div>"+p(e.items)+"</div>":"<div>"+m(e.items,e.items.type)+"</div>":"<div>"+p(e.items,helpers.simpleRef(e.items.$ref))+"</div>":(helpers.log("Array type's 'items' property is not an array or an object, cannot process"),o+="<div>"+p({},void 0,!0)+"</div>"):e.$ref?o+="<div>"+p(e,t)+"</div>":"object"===i?(o+="<div>",_.isPlainObject(e.properties)&&(o+=_.map(e.properties,function(t,i){var s=_.indexOf(e.required||[],i)>-1,n='<span class="propName '+s+'">'+i+"</span> (";return n+=l(t),s||(n+=', <span class="propOptKey">optional</span>'),n+=")",_.isUndefined(t.description)||(n+=": "+t.description),t["enum"]&&(n+=' = <span class="propVals">[\''+t["enum"].join("' or '")+"']</span>"),m(t,n)}).join(",</div><div>")),o+="</div>"):o="<div>"+m(e,i)+"</div>",o+s+(r?"]":"}")+n},u=h(t,e);_.keys(r).length>0;)_.forEach(r,function(e,t){var i=_.indexOf(a,t)>-1;delete r[t],i||(a.push(t),u+="<br />"+h(e,t))});return u},schemaToJSON=function(e,t,i){var s,n,r=e.type||"object";return e.example?n=e.example:_.isUndefined(e.items)&&_.isArray(e["enum"])&&(n=e["enum"][0]),_.isUndefined(n)&&(e.$ref?(s=t[helpers.simpleRef(e.$ref)],_.isUndefined(s)||(_.isUndefined(i[s.name])?(i[s.name]=s,n=schemaToJSON(s.definition,t,i),delete i[s.name]):n="array"===s.type?[]:{})):e["default"]?n=e["default"]:"date-time"===r?n=(new Date).toISOString():"date"===r?n=(new Date).toISOString().split("T")[0]:"string"===r?n="string":"integer"===r?n=0:"long"===r?n=0:"float"===r?n=0:"double"===r?n=0:"boolean"===r?n=!0:"object"===r?(n={},_.forEach(e.properties,function(e,s){n[s]=schemaToJSON(e,t,i)})):"array"===r&&(n=[],_.isArray(e.items)?_.forEach(e.items,function(e){n.push(schemaToJSON(e,t,i))}):_.isPlainObject(e.items)?n.push(schemaToJSON(e.items,t,i)):_.isUndefined(e.items)?n.push({}):helpers.log("Array type's 'items' property is not an array or an object, cannot process"))),n};Model.prototype.createJSONSample=Model.prototype.getSampleValue=function(e){return e=e||{},e[this.name]=this,this.examples&&_.isPlainObject(this.examples)&&this.examples["application/json"]?(this.definition.example=this.examples["application/json"],_.isString(this.definition.example)&&(this.definition.example=JSON.parse(this.definition.example))):this.definition.example=this.examples,schemaToJSON(this.definition,this.models,e)},Model.prototype.getMockSignature=function(){return schemaToHTML(this.name,this.definition,this.models)},Property.prototype.getSampleValue=function(e,t){return this.sampleValue(!1,e,t)},Property.prototype.isArray=function(){var e=this.schema;return"array"===e.type?!0:!1},Property.prototype.sampleValue=function(e,t,i){e=e||this.isArray(),t=t||{};var s,n=this,r=function(e){var s,r=helpers.simpleRef(e),o=n.models[r];return"undefined"!=typeof i[a]&&(s=i[a]),o&&"undefined"==typeof t[a]?(t[a]=this,s=o.getSampleValue(t,i),i[a]=s):s=i[a]||r,s},a=helpers.getStringSignature(this.obj,!0);return s=this.$ref?r(this.$ref):this.example?this.example:this["default"]?this["default"]:"date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string"===a?"string":"integer"===a?0:"long"===a?0:"float"===a?0:"double"===a?0:"boolean"===a?!0:this.schema.$ref?r(this.schema.$ref):this.schema.properties?new Model(void 0,this.schema,this.models).getSampleValue():{},t[a]=s,e?[s]:s},Property.prototype.toString=function(){var e,t=helpers.getStringSignature(this.obj),i='<span class="strong">',s="</span>",n=[];if("object"===t){for(var r in this.schema.properties)this.schema.properties.hasOwnProperty(r)&&(e=new Property(r,this.schema.properties[r],(this.schema.required||[]).indexOf(r)>-1,this.models),n.push(e.toString()));t=i+this.name+" {"+s+"<div>"+n.join(",</div><div>")+"</div>"+i+"}"+s}else""!==t?(t='<span class="propName '+this.required+'">'+this.name+'</span> (<span class="propType">'+t+"</span>",this.required||(t+=', <span class="propOptKey">optional</span>'),t+=")"):t=this.name+" ("+JSON.stringify(this.obj)+")";"undefined"!=typeof this.description&&(t+=": "+this.description),this["enum"]&&(t+=' = <span class="propVals">[\''+this["enum"].join("' or '")+"']</span>"),this.descr&&(t+=': <span class="propDesc">'+this.descr+"</span>");var a,o="",p="array"===this.schema.type;switch(a=p?this.schema.items?this.schema.items.type:"":this.schema.type,this["default"]&&(o+=helpers.optionHtml("Default",this["default"])),a){case"string":this.minLength&&(o+=helpers.optionHtml("Min. Length",this.minLength)),this.maxLength&&(o+=helpers.optionHtml("Max. Length",this.maxLength)),this.pattern&&(o+=helpers.optionHtml("Reg. Exp.",this.pattern));break;case"integer":case"number":this.minimum&&(o+=helpers.optionHtml("Min. Value",this.minimum)),this.exclusiveMinimum&&(o+=helpers.optionHtml("Exclusive Min.","true")),this.maximum&&(o+=helpers.optionHtml("Max. Value",this.maximum)),this.exclusiveMaximum&&(o+=helpers.optionHtml("Exclusive Max.","true")),this.multipleOf&&(o+=helpers.optionHtml("Multiple Of",this.multipleOf))}if(p&&(this.minItems&&(o+=helpers.optionHtml("Min. Items",this.minItems)),this.maxItems&&(o+=helpers.optionHtml("Max. Items",this.maxItems)),this.uniqueItems&&(o+=helpers.optionHtml("Unique Items","true")),this.collectionFormat&&(o+=helpers.optionHtml("Coll. Format",this.collectionFormat))),this["enum"]){var l;l="number"===a||"integer"===a?this["enum"].join(", "):'"'+this["enum"].join('", "')+'"',o+=helpers.optionHtml("Enum",l)}return o.length>0&&(t='<span class="propWrap">'+t+'<table class="optionsWrapper"><tr><th colspan="2">'+this.name+"</th></tr>"+o+"</table></span>"),t};


},{"../helpers":4,"lodash-compat/array/indexOf":20,"lodash-compat/collection/forEach":22,"lodash-compat/collection/map":23,"lodash-compat/lang/isArray":85,"lodash-compat/lang/isPlainObject":89,"lodash-compat/lang/isString":90,"lodash-compat/lang/isUndefined":92,"lodash-compat/object/keys":93}],9:[function(require,module,exports){
...
},{"../helpers":4,"../http":5,"./model":8,"lodash-compat/lang/isUndefined":92}],10:[function(require,module,exports){
...
},{"../internal/baseCallback":29}],20:[function(require,module,exports){
...
},{"../internal/baseIndexOf":38,"../internal/binaryIndex":50}],21:[function(require,module,exports){
...
},{"../array/findIndex":19,"../internal/baseCallback":29,"../internal/baseEach":33,"../internal/baseFind":34,"../lang/isArray":85}],22:[function(require,module,exports){
...
},{"../internal/arrayEach":27,"../internal/baseEach":33,"../internal/bindCallback":52,"../lang/isArray":85}],23:[function(require,module,exports){
...
},{"../internal/arrayMap":28,"../internal/baseCallback":29,"../internal/baseMap":43,"../lang/isArray":85}],24:[function(require,module,exports){
...
},{"../lang/isNative":87}],25:[function(require,module,exports){
...
},{"../internal/baseSlice":48,"../internal/createWrapper":60,"../internal/replaceHolders":78}],26:[function(require,module,exports){
...
},{"../utility/identity":98,"./baseMatches":44,"./baseMatchesProperty":45,"./baseProperty":46,"./bindCallback":52,"./isBindable":69}],30:[function(require,module,exports){
...
},{"../lang/isArray":85,"../lang/isObject":88,"../object/keys":93,"./arrayCopy":26,"./arrayEach":27,"./baseCopy":31,"./baseForOwn":37,"./initCloneArray":66,"./initCloneByTag":67,"./initCloneObject":68,"./isHostObject":70}],31:[function(require,module,exports){
...
},{"../lang/isObject":88}],33:[function(require,module,exports){
...
},{"./baseForOwn":37,"./isLength":72,"./toObject":82}],34:[function(require,module,exports){
...
},{"./toObject":82}],36:[function(require,module,exports){
...
},{"../object/keysIn":94,"./baseFor":35}],37:[function(require,module,exports){
...
},{"../object/keys":93,"./baseFor":35}],38:[function(require,module,exports){
...
},{"../lang/isArray":85,"../lang/isTypedArray":91,"./equalArrays":61,"./equalByTag":62,"./equalObjects":63,"./isHostObject":70}],41:[function(require,module,exports){
...
},{"../object/keys":93,"./baseIsMatch":42,"./isStrictComparable":74}],45:[function(require,module,exports){
...
},{"./baseIsEqual":39,"./isStrictComparable":74}],46:[function(require,module,exports){
...
},{"../utility/identity":98,"./metaMap":76}],48:[function(require,module,exports){
...
},{"../utility/identity":98,"./binaryIndexBy":51}],51:[function(require,module,exports){
...
},{"../utility/identity":98}],53:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":87,"../utility/constant":97}],54:[function(require,module,exports){
...
},{"./createCtorWrapper":57}],57:[function(require,module,exports){
...
},{"../lang/isObject":88,"./baseCreate":32}],58:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":26,"./composeArgs":54,"./composeArgsRight":55,"./createCtorWrapper":57,"./reorder":77,"./replaceHolders":78}],59:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":57}],60:[function(require,module,exports){
...
},{"./baseSetData":47,"./createBindWrapper":56,"./createHybridWrapper":58,"./createPartialWrapper":59,"./getData":64,"./mergeData":75,"./setData":79}],61:[function(require,module,exports){
...
},{"../object/keys":93}],64:[function(require,module,exports){
...
},{"../utility/noop":99,"./metaMap":76}],65:[function(require,module,exports){
...
},{"./bufferClone":53}],68:[function(require,module,exports){
...
},{"../lang/isNative":87,"../support":96,"./baseSetData":47}],70:[function(require,module,exports){
...
},{"../lang/isObject":88}],75:[function(require,module,exports){
...
},{"./arrayCopy":26,"./composeArgs":54,"./composeArgsRight":55,"./replaceHolders":78}],76:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":87}],77:[function(require,module,exports){
...
},{"./arrayCopy":26,"./isIndex":71}],78:[function(require,module,exports){
...
},{"../date/now":24,"./baseSetData":47}],80:[function(require,module,exports){
...
},{"../lang/isArguments":84,"../support":96,"./baseForIn":36,"./isHostObject":70,"./isObjectLike":73}],81:[function(require,module,exports){
...
},{"../lang/isArguments":84,"../lang/isArray":85,"../lang/isString":90,"../object/keysIn":94,"../support":96,"./isIndex":71,"./isLength":72}],82:[function(require,module,exports){
...
},{"../lang/isObject":88,"../lang/isString":90,"../support":96}],83:[function(require,module,exports){
...
},{"../internal/baseClone":30,"../internal/bindCallback":52}],84:[function(require,module,exports){
...
},{"../internal/isLength":72,"../internal/isObjectLike":73,"../support":96}],85:[function(require,module,exports){
...
},{"../internal/isLength":72,"../internal/isObjectLike":73,"./isNative":87}],86:[function(require,module,exports){
(function (global){
...
},{"../internal/baseIsFunction":41,"./isNative":87}],87:[function(require,module,exports){
...
},{"../internal/isHostObject":70,"../internal/isObjectLike":73,"../string/escapeRegExp":95}],88:[function(require,module,exports){
...
},{"../internal/shimIsPlainObject":80,"../support":96,"./isArguments":84,"./isNative":87}],90:[function(require,module,exports){
...
},{"../internal/isObjectLike":73}],91:[function(require,module,exports){
...
},{"../internal/isLength":72,"../internal/isObjectLike":73}],92:[function(require,module,exports){
...
},{"../internal/isLength":72,"../internal/shimKeys":81,"../lang/isNative":87,"../lang/isObject":88,"../support":96}],94:[function(require,module,exports){
...
},{"../internal/arrayEach":27,"../internal/isIndex":71,"../internal/isLength":72,"../lang/isArguments":84,"../lang/isArray":85,"../lang/isFunction":86,"../lang/isObject":88,"../lang/isString":90,"../support":96}],95:[function(require,module,exports){
...
},{"../internal/baseToString":49}],96:[function(require,module,exports){
(function (global){
...
},{"./lang/isNative":87}],97:[function(require,module,exports){
