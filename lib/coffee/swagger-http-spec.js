...
(function() {
  ...
  describe('SwaggerHttp for version 1.2 spec', function() {
    ...
    describe("execute post operations", function() {
      ...
      it("verifies the http request object for a POST with an object input", function() {
        var opts, params;
        params = {
          body: {
            id: 100,
      ...
      it("verifies the http request object for a POST with an string input", function() {
        var opts, params;
        params = {
          body: JSON.stringify({
            id: 100,
