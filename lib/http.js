  ...
  if(this.binaryRequest(accept)) {
    r.on('request', function () {
      if(this.xhr) {
        ...
        if (typeof this.responseType === 'function') {
          this.responseType('blob');
          if (this.req) this.req._responseType = 'blob'; //TODO Temporary fix until new version of superagent is released. See https://github.com/visionmedia/superagent/commit/99db1d40bc525ec644bf68520287042171e105f6
        }
      }
    });
  }
