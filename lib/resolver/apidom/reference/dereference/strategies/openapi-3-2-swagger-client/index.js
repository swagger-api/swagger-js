...
var _openapi = _interopRequireDefault(require("@swagger-api/apidom-reference/dereference/strategies/openapi-3-2"));
var _apidomNsOpenapi = _interopRequireWildcard(require("@swagger-api/apidom-ns-openapi-3-2"));
var _root = _interopRequireDefault(require("./visitors/root.js"));
/* eslint-disable camelcase */

const visitAsync = _apidomCore.visit[Symbol.for('nodejs.util.promisify.custom')];
class OpenAPI3_2SwaggerClientDereferenceStrategy extends _openapi.default {
  allowMetaPatches;
  parameterMacro;
  modelPropertyMacro;
  mode;
...
var _default = exports.default = OpenAPI3_2SwaggerClientDereferenceStrategy;
