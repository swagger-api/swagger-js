...
SwaggerSpecConverter.prototype.operations = function(path, obj, swagger) {
  ...
  for(i = 0; i < obj.length; i++) {
    ...
    this.responseMessages(existingOperation.responseMessages);
...
if(parameter.name === 'sourceDictionaries') {
...
SwaggerSpecConverter.prototype.responseMessages = function(obj, swagger) {
  if(typeof obj !== 'object')
    return;
