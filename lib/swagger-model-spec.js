...
(function() {
  ...
  describe('Swagger models version 1.2 spec', function() {
    ...
    return describe("get model operations", function() {
      ...
      it("verifies the Pet sample JSON", function() {
        var pet, sample;
        pet = window.swagger.apis.pet.models["Pet"];
      ...
      return it("verifies the getAbsoluteBasePath method for relativeBasePath '/'", function() {
        window.SwaggerResource.prototype.api = {
          basePath: "http://localhost:8000/api-docs/"
        };
        return expect(window.SwaggerResource.prototype.getAbsoluteBasePath("/")).toBe("http://localhost:8000");
      });
    });
  });
