  ...
  describe('Api', function() {
    describe('constructor', function() {
      describe('defaults', function() {
        ...
        return it("disables the debugger by default", function() {
          return runs(function() {
    ...
    return describe('build', function() {
      ...
      it("fetches a list of resources", function() {
        return runs(function() {
  ...
  describe('Operation', function() {
    ...
    return describe("do", function() {
      ...
      it("gets back an array of definitions", function() {
        wordnik.word.getDefinitions["do"](args, function(response) {
      ...
      it("pulls request headers out of the args object", function() {
        ...
        window.request = wordnik.word.getDefinitions["do"](args, function(response) {
          return window.response = response;
        });
        waitsFor(function() {
          return typeof response !== "undefined" && response !== null;
  ...
  describe('Request', function() {
    return describe("constructor", function() {
      return beforeEach(function() {
        ...
        return window.request = wordnik.word.getDefinitions["do"](args, function(response) {
          return window.response = response;
        });
      });
    });
