(function() {
  ...
  SwaggerResource = (function() {
    ...
    SwaggerResource.prototype.url = function() {
      return this.api.basePath + this.path.replace('{format}', 'json');
    };

    SwaggerResource.prototype.name = function() {
      var parts;
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype["do"] = function(args, callback) {
      var body, headers;
      if (args == null) args = {};
      if (callback == null) {
      ...
      return new SwaggerRequest(this.httpMethod, this.urlify(args), headers, body, callback, this);
    };
  ...
  SwaggerRequest = (function() {
    ...
    function SwaggerRequest(type, url, headers, body, callback, operation) {
      var obj,
        _this = this;
      this.type = type;
      this.url = url;
