...
(function() {
  ...
  SwaggerModelProperty = (function() {
    function SwaggerModelProperty(name, obj) {
      ...
      this.isCollection = this.dataType && (this.dataType.toLowerCase() === 'array' || this.dataType.toLowerCase() === 'list' || this.dataType.toLowerCase() === 'set' || (obj.additionalProperties != null));
      ...
      if (obj.items != null) {
        ...
        this.dataTypeWithRef = this.dataType + '[' + this.refDataType + ']';
      }
      if (obj.additionalProperties != null) {
        this.dataType = "map";
        if (obj.additionalProperties.type != null) {
          this.refDataType = obj.additionalProperties.type;
        }
        if (obj.additionalProperties.$ref != null) {
          this.refDataType = obj.additionalProperties.$ref;
        }
        this.dataTypeWithRef = this.dataType + '[string->' + this.refDataType + ']';
      }
      if (this.dataTypeWithRef == null) {
        this.dataTypeWithRef = this.dataType;
      }
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype.isCollectionType = function(type) {
      if (type.indexOf('[') >= 0) {
        return type.substring(Math.max(type.indexOf('['), type.indexOf('>')) + 1, type.indexOf(']'));
      } else {
        return void 0;
      }
    };
    ...
    SwaggerOperation.prototype.getSignature = function(type, models) {
      ...
      if (isPrimitive) {
        ...
        if (collectionType != null) {
          return "<p class='stronger'>" + type + "</p>" + models[collectionType].getMockSignature();
        } else {
    ...
    SwaggerOperation.prototype.getSampleJSON = function(type, models) {
      var collectionType, isPrimitive, val;
      collectionType = this.isCollectionType(type);
      isPrimitive = ((collectionType != null) && models[collectionType]) || (models[type] != null) ? false : true;
      val = isPrimitive ? void 0 : (collectionType != null ? models[collectionType].createJSONSample() : models[type].createJSONSample());
      if (val) {
        if (collectionType != null) {
          if (type.indexOf("->") > -1) {
            val = {
  ...
  PasswordAuthorization = (function() {
    ...
    PasswordAuthorization.prototype.apply = function(obj) {
      return obj.headers["Authorization"] = "Basic " + PasswordAuthorization._btoa(this.username + ":" + this.password);
    };
