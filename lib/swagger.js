var SwaggerRequest = function(type, url, params, opts, successCallback, errorCallback, operation, execution) {
  ...
  // if (this.type == null)
  //   throw "SwaggerRequest type is required (get/post/put/delete/patch/options).";
  // if (this.url == null)
 ...
 */
var SwaggerHttp = function(options) {
  options = (options||{});
  this.useJQuery = options["useJQuery"]||false;
};
...
if(typeof exports !== 'undefined') {
  exports.SwaggerAuthorizations = SwaggerAuthorizations;
  exports.SwaggerHttp = SwaggerHttp;
  exports.JQueryHttpClient = JQueryHttpClient;
  exports.ShredHttpClient = ShredHttpClient;
...
/*
  ...
  window.ApiKeyAuthorization = ApiKeyAuthorization;
  window.PasswordAuthorization = PasswordAuthorization;
*/

  this.SwaggerHttp = SwaggerHttp;
  this.SwaggerRequest = SwaggerRequest;
  this.authorizations = new SwaggerAuthorizations();
  this.JQueryHttpClient = JQueryHttpClient;
  this.ShredHttpClient = ShredHttpClient;
};


(function() {
  var SwaggerApi, SwaggerAuthorizations, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource, log,
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype["do"] = function(args, opts, callback, error) {
      ...
      req = new window.SwaggerRequest(this.method, this.urlify(args), params, opts, callback, error, this);
      if (opts.mock != null) {
        return req;
      } else {
        return true;
