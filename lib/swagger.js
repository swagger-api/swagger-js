...
(function() {
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype["do"] = function(args, callback, error) {
      ...
      req = new SwaggerRequest(this.method, this.urlify(args), params, requestContentType, responseContentType, callback, error, this);
      if (args.mock != null) {
        return req;
      } else {
        return true;
  ...
  SwaggerAuthorizations = (function() {
    ...
    SwaggerAuthorizations.prototype.apply = function(obj) {
      ...
      console.log("checking auth " + JSON.stringify(this.authz));
      _ref = this.authz;
      _results = [];
      for (key in _ref) {
        value = _ref[key];
