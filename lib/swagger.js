...
(function () {
  ...
  var applyParameterMacro = function (model, parameter) {
    ...
    if(exports.parameterMacro)
      return exports.parameterMacro(model, parameter);
    else
  ...
  var applyModelPropertyMacro = function (operation, property) {
    // var e = (typeof window !== 'undefined' ? window : exports);
    if(exports.modelPropertyMacro)
      return exports.modelPropertyMacro(operation, property);
    else
  ...
  var SwaggerApi = function (url, options) {
    ...
    if (options.authorizations) {
      ...
      // var e = (typeof window !== 'undefined' ? window : exports);
      this.clientAuthorizations = exports.authorizations;
    }
  ...
  var SwaggerRequest = function (type, url, params, opts, successCallback, errorCallback, operation, execution) {
    ...
    if (!((this.headers != null) && (this.headers.mock != null))) {
      ...
      if (this.operation.resource && this.operation.resource.api && this.operation.resource.api.clientAuthorizations) {
        ...
        status = exports.authorizations.apply(obj, this.operation.authorizations);
      }
  ...
  exports.SampleModels = sampleModels;
  ...
  exports.CookieAuthorization = CookieAuthorization;
