...
(function() {
  var SwaggerApi, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource, e,
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.Shred = null;
  ...
  SwaggerResource = (function() {
    ...
    SwaggerResource.prototype.addOperations = function(resource_path, ops) {
      var consumes, o, op, responseMessages, _i, _len, _results;
      if (ops) {
        _results = [];
  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, notes, responseClass, responseMessages, resource, consumes, produces) {
      ...
      this.resource[this.nickname] = function(args, callback, error) {
        return _this["do"](args, requestType, responseType, callback, error);
      };
    }
    ...
    SwaggerOperation.prototype["do"] = function(args, requestContentType, responseContentType, callback, error) {
      var params;
      if (args == null) {
        args = {};
      }
      ...
      return new SwaggerRequest(this.httpMethod, this.urlify(args), params, requestContentType, responseContentType, callback, error, this);
    };
  ...
  SwaggerRequest = (function() {
    ...
    function SwaggerRequest(type, url, params, requestContentType, responseContentType, successCallback, errorCallback, operation) {
      var Content, Shred, body, contentType, dataType, headers, identity, myHeaders, obj, shred, toString,
        _this = this;
      this.type = type;
      this.url = url;
      this.params = params;
      ...
      if (this.requestContentType === "application/json" && (type.toLowerCase() === "post" || type.toLowerCase() === "put")) {
        contentType = this.requestContentType;
      }
      dataType = this.responseContentType;
      if (dataType) {
        if (dataType.indexOf('text/plain') !== -1) {
          dataType = 'text';
      ...
      contentType = this.requestContentType;
      if (type.toLowerCase() !== ("post" || "put" || "patch")) {
        dataType = null;
      }
      myHeaders = {};
      if (this.requestContentType) {
        myHeaders["accept"] = this.requestContentType;
      }
      if (this.responseContentType) {
        myHeaders["Content-Type"] = this.responseContentType;
      }
        ...
        obj = {
          ...
          on: {
            error: function(response) {
              return _this.errorCallback(response);
            },
            ...
            response: function(response) {
              return _this.successCallback(response.content.data);
            }
          }
        };
        Shred = require("./shred");
