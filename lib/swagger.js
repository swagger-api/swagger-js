...
(function() {
  var SwaggerApi, SwaggerHttp, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource, e,
  ...
  SwaggerResource = (function() {
    ...
    SwaggerResource.prototype.addOperations = function(resource_path, ops) {
      var consumes, method, o, op, responseMessages, _i, _len, _results;
      if (ops) {
        _results = [];
  ...
  SwaggerRequest = (function() {
    ...
    function SwaggerRequest(type, url, params, requestContentType, responseContentType, successCallback, errorCallback, operation) {
      var body, contentType, dataType, headers, myHeaders, obj,
        _this = this;
      this.type = type;
      this.url = url;
      this.params = params;
