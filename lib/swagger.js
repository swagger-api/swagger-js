...
var swaggerExports = module.exports = {};
...
(function () {
  ...
  var applyParameterMacro = function (model, parameter) {
    // var e = (typeof window !== 'undefined' ? window : swaggerExports);
    if(swaggerExports.parameterMacro)
      return swaggerExports.parameterMacro(model, parameter);
    else
  ...
  var applyModelPropertyMacro = function (operation, property) {
    // var e = (typeof window !== 'undefined' ? window : swaggerExports);
    if(swaggerExports.modelPropertyMacro)
      return swaggerExports.modelPropertyMacro(operation, property);
    else
  ...
  var SwaggerApi = function (url, options) {
    ...
    if (options.authorizations) {
      ...
      // var e = (typeof window !== 'undefined' ? window : swaggerExports);
      this.clientAuthorizations = swaggerExports.authorizations;
    }
  ...
  SwaggerApi.prototype.build = function (mock) {
    ...
    // var e = (typeof window !== 'undefined' ? window : swaggerExports);
    swaggerExports.authorizations.apply(obj);
    if (mock === true)
      return obj;
    ...
    for (resource_name in _ref) {
      ...
      for (operation_name in _ref1) {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          parameter = _ref2[_i];
          log('  ' + parameter.name + (parameter.eequired ? ' (required)' : '') + ' - ' + parameter.description);
        }
      }
    }
    return this;
  ...
  var SwaggerRequest = function (type, url, params, opts, successCallback, errorCallback, operation, execution) {
    ...
    if (!((this.headers != null) && (this.headers.mock != null))) {
      ...
      if (this.operation.resource && this.operation.resource.api && this.operation.resource.api.clientAuthorizations) {
        ...
        status = swaggerExports.authorizations.apply(obj, this.operation.authorizations);
      }
  ...
  swaggerExports.SampleModels = sampleModels;
  swaggerExports.SwaggerHttp = SwaggerHttp;
  swaggerExports.SwaggerRequest = SwaggerRequest;
  swaggerExports.SwaggerAuthorizations = SwaggerAuthorizations;
  swaggerExports.authorizations = new SwaggerAuthorizations();
  swaggerExports.ApiKeyAuthorization = ApiKeyAuthorization;
  swaggerExports.PasswordAuthorization = PasswordAuthorization;
  swaggerExports.CookieAuthorization = CookieAuthorization;
  swaggerExports.JQueryHttpClient = JQueryHttpClient;
  swaggerExports.ShredHttpClient = ShredHttpClient;
  swaggerExports.SwaggerOperation = SwaggerOperation;
  swaggerExports.SwaggerModel = SwaggerModel;
  swaggerExports.SwaggerModelProperty = SwaggerModelProperty;
  swaggerExports.SwaggerResource = SwaggerResource;
  swaggerExports.SwaggerApi = SwaggerApi;

  swaggerExports.log = log;
