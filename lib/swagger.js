(function() {
  ...
  Api = (function() {
    ...
    function Api(options) {
      ...
      if (options.callback != null) this.build(options.callback);
    }
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            if (endpoint.operations) {
              ...
              for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
                o = _ref2[_j];
                _this.operations.push(new Operation(o.nickname, endpoint.path, o.httpMethod, o.parameters, o.summary, _this));
              }
            }
          }
        }
  ...
  Operation = (function() {
    ...
    Operation.prototype["do"] = function(args, callback) {
      ...
      if (this.resource.api.api_key != null) {
        headers.api_key = this.resource.api.api_key;
      }
  ...
  Request = (function() {
    ...
    Request.prototype.asCurl = function() {
      return "curl --header \"api_key: " + this.headers.api_key + "\" " + this.url;
    };
