...
describe('OpenAPIJson3_2Parser', () => {
  ...
  describe('parse', () => {
    describe('given OpenApi 3.2.x JSON data', () => {
    ...
    describe('given OpenApi 3.2.x JSON data as buffer', () => {
      test('should return parse result', async () => {
        const url = path.join(__dirname, '__fixtures__', 'sample-api.json');
    ...
    describe('given data that is not an OpenApi 3.2.x JSON data', () => {
