...
describe('OpenAPIYaml3_2Parser', () => {
  describe('canParser', () => {
    ...
    describe('given file with unknown extension', () => {
      test('should return false', async () => {
        ...
        const parser = new OpenAPIYaml3_2Parser({ fileExtensions: ['.yaml', '.yml'] });
    ...
    describe('given file with supported extension', () => {
      describe('and file data is buffer and can be detected as OpenAPI 3.2.0', () => {
        test('should return true', async () => {
      ...
      describe('and file data is string and can be detected as OpenAPI 3.2.0', () => {
        test('should return true', async () => {
          const url = path.join(__dirname, '__fixtures__', 'sample-api.yaml');
          const file = new File({
            uri: '/path/to/open-api.yaml',
  ...
  describe('parse', () => {
    describe('given OpenApi 3.2.x YAML data', () => {
    ...
    describe('given OpenApi 3.2.x YAML data as buffer', () => {
      test('should return parse result', async () => {
        const url = path.join(__dirname, '__fixtures__', 'sample-api.yaml');
    ...
    describe('given data that is not an OpenApi 3.2.x YAML data', () => {
      ...
      describe('given sourceMap enabled', () => {
        test('should throw error', async () => {
          ...
          await expect(parseWithSourceMapThunk()).rejects.toThrow(
            new ParserError(
              "openapi-yaml-3-2-swagger-client parser plugin doesn't support sourceMaps option"
            )
          );
        });
      });
